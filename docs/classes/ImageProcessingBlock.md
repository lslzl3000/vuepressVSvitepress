[@dev/core](../README.md) / [Exports](../modules.md) / ImageProcessingBlock
...
- [constructor](ImageProcessingBlock.md#constructor)

### Properties

- [\_isUnique](ImageProcessingBlock.md#_isunique)
- [\_target](ImageProcessingBlock.md#_target)
- [comments](ImageProcessingBlock.md#comments)
- [convertInputToLinearSpace](ImageProcessingBlock.md#convertinputtolinearspace)
- [inputsAreExclusive](ImageProcessingBlock.md#inputsareexclusive)
- [uniqueId](ImageProcessingBlock.md#uniqueid)
- [visibleInInspector](ImageProcessingBlock.md#visibleininspector)
- [visibleOnFrame](ImageProcessingBlock.md#visibleonframe)

### Accessors

- [buildId](ImageProcessingBlock.md#buildid)
- [color](ImageProcessingBlock.md#color)
- [inputs](ImageProcessingBlock.md#inputs)
- [isFinalMerger](ImageProcessingBlock.md#isfinalmerger)
- [isInput](ImageProcessingBlock.md#isinput)
- [isUnique](ImageProcessingBlock.md#isunique)
- [name](ImageProcessingBlock.md#name)
- [output](ImageProcessingBlock.md#output)
- [outputs](ImageProcessingBlock.md#outputs)
- [target](ImageProcessingBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](ImageProcessingBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](ImageProcessingBlock.md#_buildblock)
- [\_declareOutput](ImageProcessingBlock.md#_declareoutput)
- [\_deserialize](ImageProcessingBlock.md#_deserialize)
- [\_dumpPropertiesCode](ImageProcessingBlock.md#_dumppropertiescode)
- [\_inputRename](ImageProcessingBlock.md#_inputrename)
- [\_linkConnectionTypes](ImageProcessingBlock.md#_linkconnectiontypes)
- [\_outputRename](ImageProcessingBlock.md#_outputrename)
- [\_writeFloat](ImageProcessingBlock.md#_writefloat)
- [\_writeVariable](ImageProcessingBlock.md#_writevariable)
- [autoConfigure](ImageProcessingBlock.md#autoconfigure)
- [bind](ImageProcessingBlock.md#bind)
- [build](ImageProcessingBlock.md#build)
- [clone](ImageProcessingBlock.md#clone)
- [connectTo](ImageProcessingBlock.md#connectto)
- [dispose](ImageProcessingBlock.md#dispose)
- [getClassName](ImageProcessingBlock.md#getclassname)
- [getFirstAvailableInput](ImageProcessingBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](ImageProcessingBlock.md#getfirstavailableoutput)
- [getInputByName](ImageProcessingBlock.md#getinputbyname)
- [getOutputByName](ImageProcessingBlock.md#getoutputbyname)
- [getSiblingOutput](ImageProcessingBlock.md#getsiblingoutput)
- [initialize](ImageProcessingBlock.md#initialize)
- [initializeDefines](ImageProcessingBlock.md#initializedefines)
- [isAnAncestorOf](ImageProcessingBlock.md#isanancestorof)
- [isReady](ImageProcessingBlock.md#isready)
- [prepareDefines](ImageProcessingBlock.md#preparedefines)
- [provideFallbacks](ImageProcessingBlock.md#providefallbacks)
- [registerInput](ImageProcessingBlock.md#registerinput)
- [registerOutput](ImageProcessingBlock.md#registeroutput)
- [replaceRepeatableContent](ImageProcessingBlock.md#replacerepeatablecontent)
- [serialize](ImageProcessingBlock.md#serialize)
- [updateUniformsAndSamples](ImageProcessingBlock.md#updateuniformsandsamples)
- [validateBlockName](ImageProcessingBlock.md#validateblockname)

## Constructors

### constructor

• **new ImageProcessingBlock**(`name`)
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/imageProcessingBlock.ts:26
...
• **convertInputToLinearSpace**: `boolean` = `true`

Defines if the input should be converted to linear space (default: true)

#### Defined in

packages/dev/core/src/Materials/Node/Blocks/Fragment/imageProcessingBlock.ts:39
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/imageProcessingBlock.ts:52
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/imageProcessingBlock.ts:59
...
▸ `Protected` **_buildBlock**(`state`): [`ImageProcessingBlock`](ImageProcessingBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/imageProcessingBlock.ts:107
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/imageProcessingBlock.ts:177
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/imageProcessingBlock.ts:161
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/imageProcessingBlock.ts:95
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`ImageProcessingBlock`](ImageProcessingBlock.md)
...
`undefined` \| [`ImageProcessingBlock`](ImageProcessingBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/imageProcessingBlock.ts:45
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/imageProcessingBlock.ts:67
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/imageProcessingBlock.ts:80
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/imageProcessingBlock.ts:89
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`ImageProcessingBlock`](ImageProcessingBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`ImageProcessingBlock`](ImageProcessingBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/imageProcessingBlock.ts:169
