[@dev/core](../README.md) / [Exports](../modules.md) / WebXRCamera
...
- [constructor](WebXRCamera.md#constructor)

### Properties

- [\_firstFrame](WebXRCamera.md#_firstframe)
- [\_globalPosition](WebXRCamera.md#_globalposition)
- [\_isDirty](WebXRCamera.md#_isdirty)
- [\_parentNode](WebXRCamera.md#_parentnode)
- [\_ranges](WebXRCamera.md#_ranges)
- [\_referenceQuaternion](WebXRCamera.md#_referencequaternion)
- [\_referencedPosition](WebXRCamera.md#_referencedposition)
- [\_rotate180](WebXRCamera.md#_rotate180)
- [\_trackingState](WebXRCamera.md#_trackingstate)
- [\_upVector](WebXRCamera.md#_upvector)
- [\_webvrViewMatrix](WebXRCamera.md#_webvrviewmatrix)
- [animations](WebXRCamera.md#animations)
- [applyGravity](WebXRCamera.md#applygravity)
- [cameraDirection](WebXRCamera.md#cameradirection)
- [cameraRigMode](WebXRCamera.md#camerarigmode)
- [cameraRotation](WebXRCamera.md#camerarotation)
- [checkCollisions](WebXRCamera.md#checkcollisions)
- [compensateOnFirstFrame](WebXRCamera.md#compensateonfirstframe)
- [customRenderTargets](WebXRCamera.md#customrendertargets)
- [ellipsoid](WebXRCamera.md#ellipsoid)
- [ellipsoidOffset](WebXRCamera.md#ellipsoidoffset)
- [fov](WebXRCamera.md#fov)
- [fovMode](WebXRCamera.md#fovmode)
- [id](WebXRCamera.md#id)
- [ignoreParentScaling](WebXRCamera.md#ignoreparentscaling)
- [inertia](WebXRCamera.md#inertia)
- [inputs](WebXRCamera.md#inputs)
- [inspectableCustomProperties](WebXRCamera.md#inspectablecustomproperties)
- [interaxialDistance](WebXRCamera.md#interaxialdistance)
- [inverseRotationSpeed](WebXRCamera.md#inverserotationspeed)
- [invertRotation](WebXRCamera.md#invertrotation)
- [isIntermediate](WebXRCamera.md#isintermediate)
- [isRigCamera](WebXRCamera.md#isrigcamera)
- [isStereoscopicSideBySide](WebXRCamera.md#isstereoscopicsidebyside)
- [layerMask](WebXRCamera.md#layermask)
- [lockedTarget](WebXRCamera.md#lockedtarget)
- [maxZ](WebXRCamera.md#maxz)
- [metadata](WebXRCamera.md#metadata)
- [minZ](WebXRCamera.md#minz)
- [name](WebXRCamera.md#name)
- [noRotationConstraint](WebXRCamera.md#norotationconstraint)
- [onAfterCameraTeleport](WebXRCamera.md#onaftercamerateleport)
- [onAfterCheckInputsObservable](WebXRCamera.md#onaftercheckinputsobservable)
- [onBeforeCameraTeleport](WebXRCamera.md#onbeforecamerateleport)
- [onCollide](WebXRCamera.md#oncollide)
- [onDisposeObservable](WebXRCamera.md#ondisposeobservable)
- [onProjectionMatrixChangedObservable](WebXRCamera.md#onprojectionmatrixchangedobservable)
- [onReady](WebXRCamera.md#onready)
- [onRestoreStateObservable](WebXRCamera.md#onrestorestateobservable)
- [onTrackingStateChanged](WebXRCamera.md#ontrackingstatechanged)
- [onViewMatrixChangedObservable](WebXRCamera.md#onviewmatrixchangedobservable)
- [outputRenderTarget](WebXRCamera.md#outputrendertarget)
- [projectionPlaneTilt](WebXRCamera.md#projectionplanetilt)
- [renderPassId](WebXRCamera.md#renderpassid)
- [reservedDataStore](WebXRCamera.md#reserveddatastore)
- [rigParent](WebXRCamera.md#rigparent)
- [rotation](WebXRCamera.md#rotation)
- [rotationQuaternion](WebXRCamera.md#rotationquaternion)
- [speed](WebXRCamera.md#speed)
- [state](WebXRCamera.md#state)
- [uniqueId](WebXRCamera.md#uniqueid)
- [updateUpVectorFromRotation](WebXRCamera.md#updateupvectorfromrotation)
- [viewport](WebXRCamera.md#viewport)
- [FOVMODE\_HORIZONTAL\_FIXED](WebXRCamera.md#fovmode_horizontal_fixed)
- [FOVMODE\_VERTICAL\_FIXED](WebXRCamera.md#fovmode_vertical_fixed)
- [ForceAttachControlToAlwaysPreventDefault](WebXRCamera.md#forceattachcontroltoalwayspreventdefault)
- [ORTHOGRAPHIC\_CAMERA](WebXRCamera.md#orthographic_camera)
- [PERSPECTIVE\_CAMERA](WebXRCamera.md#perspective_camera)
- [RIG\_MODE\_CUSTOM](WebXRCamera.md#rig_mode_custom)
- [RIG\_MODE\_NONE](WebXRCamera.md#rig_mode_none)
- [RIG\_MODE\_STEREOSCOPIC\_ANAGLYPH](WebXRCamera.md#rig_mode_stereoscopic_anaglyph)
- [RIG\_MODE\_STEREOSCOPIC\_INTERLACED](WebXRCamera.md#rig_mode_stereoscopic_interlaced)
- [RIG\_MODE\_STEREOSCOPIC\_OVERUNDER](WebXRCamera.md#rig_mode_stereoscopic_overunder)
- [RIG\_MODE\_STEREOSCOPIC\_SIDEBYSIDE\_CROSSEYED](WebXRCamera.md#rig_mode_stereoscopic_sidebyside_crosseyed)
- [RIG\_MODE\_STEREOSCOPIC\_SIDEBYSIDE\_PARALLEL](WebXRCamera.md#rig_mode_stereoscopic_sidebyside_parallel)
- [RIG\_MODE\_VR](WebXRCamera.md#rig_mode_vr)
- [RIG\_MODE\_WEBVR](WebXRCamera.md#rig_mode_webvr)
- [\_ScaleReadOnly](WebXRCamera.md#_scalereadonly)

### Accessors

- [absoluteRotation](WebXRCamera.md#absoluterotation)
- [angularSensibility](WebXRCamera.md#angularsensibility)
- [animationPropertiesOverride](WebXRCamera.md#animationpropertiesoverride)
- [behaviors](WebXRCamera.md#behaviors)
- [collisionMask](WebXRCamera.md#collisionmask)
- [doNotSerialize](WebXRCamera.md#donotserialize)
- [globalPosition](WebXRCamera.md#globalposition)
- [isLeftCamera](WebXRCamera.md#isleftcamera)
- [isRightCamera](WebXRCamera.md#isrightcamera)
- [keysDown](WebXRCamera.md#keysdown)
- [keysDownward](WebXRCamera.md#keysdownward)
- [keysLeft](WebXRCamera.md#keysleft)
- [keysRight](WebXRCamera.md#keysright)
- [keysRotateLeft](WebXRCamera.md#keysrotateleft)
- [keysRotateRight](WebXRCamera.md#keysrotateright)
- [keysUp](WebXRCamera.md#keysup)
- [keysUpward](WebXRCamera.md#keysupward)
- [leftCamera](WebXRCamera.md#leftcamera)
- [mode](WebXRCamera.md#mode)
- [onClonedObservable](WebXRCamera.md#onclonedobservable)
- [onDispose](WebXRCamera.md#ondispose)
- [onEnabledStateChangedObservable](WebXRCamera.md#onenabledstatechangedobservable)
- [orthoBottom](WebXRCamera.md#orthobottom)
- [orthoLeft](WebXRCamera.md#ortholeft)
- [orthoRight](WebXRCamera.md#orthoright)
- [orthoTop](WebXRCamera.md#orthotop)
- [parent](WebXRCamera.md#parent)
- [position](WebXRCamera.md#position)
- [realWorldHeight](WebXRCamera.md#realworldheight)
- [rigPostProcess](WebXRCamera.md#rigpostprocess)
- [rightCamera](WebXRCamera.md#rightcamera)
- [screenArea](WebXRCamera.md#screenarea)
- [target](WebXRCamera.md#target)
- [trackingState](WebXRCamera.md#trackingstate)
- [upVector](WebXRCamera.md#upvector)
- [worldMatrixFromCache](WebXRCamera.md#worldmatrixfromcache)

### Methods

- [\_computeViewMatrix](WebXRCamera.md#_computeviewmatrix)
- [\_getFirstPostProcess](WebXRCamera.md#_getfirstpostprocess)
- [\_setRigMode](WebXRCamera.md#_setrigmode)
- [\_setTrackingState](WebXRCamera.md#_settrackingstate)
- [\_updateCameraRotationMatrix](WebXRCamera.md#_updatecamerarotationmatrix)
- [\_updateFromXRSession](WebXRCamera.md#_updatefromxrsession)
- [\_updateNumberOfRigCameras](WebXRCamera.md#_updatenumberofrigcameras)
- [\_updateReferenceSpace](WebXRCamera.md#_updatereferencespace)
- [\_updateWebVRCameraRotationMatrix](WebXRCamera.md#_updatewebvrcamerarotationmatrix)
- [addBehavior](WebXRCamera.md#addbehavior)
- [applyVerticalCorrection](WebXRCamera.md#applyverticalcorrection)
- [attachControl](WebXRCamera.md#attachcontrol)
- [attachPostProcess](WebXRCamera.md#attachpostprocess)
- [beginAnimation](WebXRCamera.md#beginanimation)
- [clone](WebXRCamera.md#clone)
- [computeWorldMatrix](WebXRCamera.md#computeworldmatrix)
- [createAnimationRange](WebXRCamera.md#createanimationrange)
- [deleteAnimationRange](WebXRCamera.md#deleteanimationrange)
- [detachControl](WebXRCamera.md#detachcontrol)
- [detachPostProcess](WebXRCamera.md#detachpostprocess)
- [dispose](WebXRCamera.md#dispose)
- [freezeProjectionMatrix](WebXRCamera.md#freezeprojectionmatrix)
- [getActiveMeshes](WebXRCamera.md#getactivemeshes)
- [getAnimationByName](WebXRCamera.md#getanimationbyname)
- [getAnimationRange](WebXRCamera.md#getanimationrange)
- [getAnimationRanges](WebXRCamera.md#getanimationranges)
- [getBehaviorByName](WebXRCamera.md#getbehaviorbyname)
- [getChildMeshes](WebXRCamera.md#getchildmeshes)
- [getChildren](WebXRCamera.md#getchildren)
- [getClassName](WebXRCamera.md#getclassname)
- [getDescendants](WebXRCamera.md#getdescendants)
- [getDirection](WebXRCamera.md#getdirection)
- [getDirectionToRef](WebXRCamera.md#getdirectiontoref)
- [getEngine](WebXRCamera.md#getengine)
- [getForwardRay](WebXRCamera.md#getforwardray)
- [getForwardRayToRef](WebXRCamera.md#getforwardraytoref)
- [getFrontPosition](WebXRCamera.md#getfrontposition)
- [getHierarchyBoundingVectors](WebXRCamera.md#gethierarchyboundingvectors)
- [getLeftTarget](WebXRCamera.md#getlefttarget)
- [getProjectionMatrix](WebXRCamera.md#getprojectionmatrix)
- [getRightTarget](WebXRCamera.md#getrighttarget)
- [getScene](WebXRCamera.md#getscene)
- [getTarget](WebXRCamera.md#gettarget)
- [getTransformationMatrix](WebXRCamera.md#gettransformationmatrix)
- [getViewMatrix](WebXRCamera.md#getviewmatrix)
- [getWorldMatrix](WebXRCamera.md#getworldmatrix)
- [isActiveMesh](WebXRCamera.md#isactivemesh)
- [isCompletelyInFrustum](WebXRCamera.md#iscompletelyinfrustum)
- [isDescendantOf](WebXRCamera.md#isdescendantof)
- [isDisposed](WebXRCamera.md#isdisposed)
- [isEnabled](WebXRCamera.md#isenabled)
- [isInFrustum](WebXRCamera.md#isinfrustum)
- [isReady](WebXRCamera.md#isready)
- [markAsDirty](WebXRCamera.md#markasdirty)
- [removeBehavior](WebXRCamera.md#removebehavior)
- [restoreState](WebXRCamera.md#restorestate)
- [serialize](WebXRCamera.md#serialize)
- [serializeAnimationRanges](WebXRCamera.md#serializeanimationranges)
- [setEnabled](WebXRCamera.md#setenabled)
- [setTarget](WebXRCamera.md#settarget)
- [setTransformationFromNonVRCamera](WebXRCamera.md#settransformationfromnonvrcamera)
- [storeState](WebXRCamera.md#storestate)
- [toString](WebXRCamera.md#tostring)
- [unfreezeProjectionMatrix](WebXRCamera.md#unfreezeprojectionmatrix)
- [update](WebXRCamera.md#update)
- [AddNodeConstructor](WebXRCamera.md#addnodeconstructor)
- [Construct](WebXRCamera.md#construct)
- [GetConstructorFromName](WebXRCamera.md#getconstructorfromname)
- [Parse](WebXRCamera.md#parse)
- [ParseAnimationRanges](WebXRCamera.md#parseanimationranges)

## Constructors

### constructor

• **new WebXRCamera**(`name`, `scene`, `_xrSessionManager`)
...
| `scene` | [`Scene`](Scene.md) | the scene to add the camera to |
| `_xrSessionManager` | [`WebXRSessionManager`](WebXRSessionManager.md) | a constructed xr session manager |
...
packages/dev/core/src/XR/webXRCamera.ts:56
...
packages/dev/core/src/XR/webXRCamera.ts:18
...
• `Private` **\_referenceQuaternion**: [`Quaternion`](Quaternion.md)

#### Defined in

packages/dev/core/src/XR/webXRCamera.ts:19

___

### \_referencedPosition

• `Private` **\_referencedPosition**: [`Vector3`](Vector3.md)

#### Defined in

packages/dev/core/src/XR/webXRCamera.ts:20

___

### \_rotate180

• `Private` **\_rotate180**: [`Quaternion`](Quaternion.md)

#### Defined in

packages/dev/core/src/XR/webXRCamera.ts:162

___

### \_trackingState

• `Private` **\_trackingState**: [`WebXRTrackingState`](../enums/WebXRTrackingState.md) = `WebXRTrackingState.NOT_TRACKING`

#### Defined in

packages/dev/core/src/XR/webXRCamera.ts:21
...
• **compensateOnFirstFrame**: `boolean` = `true`
...
packages/dev/core/src/XR/webXRCamera.ts:42
...
packages/dev/core/src/XR/webXRCamera.ts:31
...
packages/dev/core/src/XR/webXRCamera.ts:26
...
• **onTrackingStateChanged**: [`Observable`](Observable.md)[`WebXRTrackingState`](../enums/WebXRTrackingState.md)
...
packages/dev/core/src/XR/webXRCamera.ts:37
...
▪ `Static` `Private` **\_ScaleReadOnly**: [`Vector3`](Vector3.md)

#### Defined in

packages/dev/core/src/XR/webXRCamera.ts:16
...
packages/dev/core/src/XR/webXRCamera.ts:108
...
• `get` **trackingState**(): [`WebXRTrackingState`](../enums/WebXRTrackingState.md)
...
packages/dev/core/src/XR/webXRCamera.ts:93
...
▸ `Private` **_setTrackingState**(`newState`): `void`

#### Parameters

| Name | Type |
| :------ | :------ |
| `newState` | [`WebXRTrackingState`](../enums/WebXRTrackingState.md) |
...
packages/dev/core/src/XR/webXRCamera.ts:97
...
▸ `Private` **_updateFromXRSession**(): `void`
...
packages/dev/core/src/XR/webXRCamera.ts:164

___

### \_updateNumberOfRigCameras

▸ `Private` **_updateNumberOfRigCameras**(`viewCount?`): `void`
...
packages/dev/core/src/XR/webXRCamera.ts:282

___

### \_updateReferenceSpace

▸ `Private` **_updateReferenceSpace**(): `void`
...
packages/dev/core/src/XR/webXRCamera.ts:302
...
packages/dev/core/src/XR/webXRCamera.ts:157
...
packages/dev/core/src/XR/webXRCamera.ts:153
...
▸ **setTransformationFromNonVRCamera**(`otherCamera?`, `resetToBaseReferenceSpace?`): `void`
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `otherCamera` | [`Camera`](Camera.md) | `undefined` | the non-vr camera to copy the transformation from |
| `resetToBaseReferenceSpace` | `boolean` | `true` | should XR reset to the base reference space |
...
packages/dev/core/src/XR/webXRCamera.ts:134
