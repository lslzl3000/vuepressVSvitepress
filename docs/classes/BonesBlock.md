[@dev/core](../README.md) / [Exports](../modules.md) / BonesBlock
...
- [constructor](BonesBlock.md#constructor)

### Properties

- [\_isUnique](BonesBlock.md#_isunique)
- [\_target](BonesBlock.md#_target)
- [comments](BonesBlock.md#comments)
- [inputsAreExclusive](BonesBlock.md#inputsareexclusive)
- [uniqueId](BonesBlock.md#uniqueid)
- [visibleInInspector](BonesBlock.md#visibleininspector)
- [visibleOnFrame](BonesBlock.md#visibleonframe)

### Accessors

- [buildId](BonesBlock.md#buildid)
- [inputs](BonesBlock.md#inputs)
- [isFinalMerger](BonesBlock.md#isfinalmerger)
- [isInput](BonesBlock.md#isinput)
- [isUnique](BonesBlock.md#isunique)
- [matricesIndices](BonesBlock.md#matricesindices)
- [matricesIndicesExtra](BonesBlock.md#matricesindicesextra)
- [matricesWeights](BonesBlock.md#matricesweights)
- [matricesWeightsExtra](BonesBlock.md#matricesweightsextra)
- [name](BonesBlock.md#name)
- [output](BonesBlock.md#output)
- [outputs](BonesBlock.md#outputs)
- [target](BonesBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](BonesBlock.md#willbegeneratedintovertexshaderfromfragmentshader)
- [world](BonesBlock.md#world)

### Methods

- [\_buildBlock](BonesBlock.md#_buildblock)
- [\_declareOutput](BonesBlock.md#_declareoutput)
- [\_dumpPropertiesCode](BonesBlock.md#_dumppropertiescode)
- [\_inputRename](BonesBlock.md#_inputrename)
- [\_linkConnectionTypes](BonesBlock.md#_linkconnectiontypes)
- [\_outputRename](BonesBlock.md#_outputrename)
- [\_writeFloat](BonesBlock.md#_writefloat)
- [\_writeVariable](BonesBlock.md#_writevariable)
- [autoConfigure](BonesBlock.md#autoconfigure)
- [bind](BonesBlock.md#bind)
- [build](BonesBlock.md#build)
- [clone](BonesBlock.md#clone)
- [connectTo](BonesBlock.md#connectto)
- [dispose](BonesBlock.md#dispose)
- [getClassName](BonesBlock.md#getclassname)
- [getFirstAvailableInput](BonesBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](BonesBlock.md#getfirstavailableoutput)
- [getInputByName](BonesBlock.md#getinputbyname)
- [getOutputByName](BonesBlock.md#getoutputbyname)
- [getSiblingOutput](BonesBlock.md#getsiblingoutput)
- [initialize](BonesBlock.md#initialize)
- [initializeDefines](BonesBlock.md#initializedefines)
- [isAnAncestorOf](BonesBlock.md#isanancestorof)
- [isReady](BonesBlock.md#isready)
- [prepareDefines](BonesBlock.md#preparedefines)
- [provideFallbacks](BonesBlock.md#providefallbacks)
- [registerInput](BonesBlock.md#registerinput)
- [registerOutput](BonesBlock.md#registeroutput)
- [replaceRepeatableContent](BonesBlock.md#replacerepeatablecontent)
- [serialize](BonesBlock.md#serialize)
- [updateUniformsAndSamples](BonesBlock.md#updateuniformsandsamples)
- [validateBlockName](BonesBlock.md#validateblockname)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/bonesBlock.ts:27
...
• `get` **matricesIndices**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/bonesBlock.ts:61

___

### matricesIndicesExtra

• `get` **matricesIndicesExtra**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/bonesBlock.ts:75

___

### matricesWeights

• `get` **matricesWeights**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/bonesBlock.ts:68

___

### matricesWeightsExtra

• `get` **matricesWeightsExtra**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/bonesBlock.ts:82
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/bonesBlock.ts:96
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/bonesBlock.ts:89

## Methods

### \_buildBlock

▸ `Protected` **_buildBlock**(`state`): [`BonesBlock`](BonesBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/bonesBlock.ts:147
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/bonesBlock.ts:100
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/bonesBlock.ts:136
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`BonesBlock`](BonesBlock.md)
...
`undefined` \| [`BonesBlock`](BonesBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/bonesBlock.ts:54
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/bonesBlock.ts:43
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/bonesBlock.ts:140
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/bonesBlock.ts:130

___

### registerInput

▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`BonesBlock`](BonesBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`BonesBlock`](BonesBlock.md)
