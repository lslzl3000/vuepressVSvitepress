[@dev/core](../README.md) / [Exports](../modules.md) / ReplaceColorBlock
...
- [constructor](ReplaceColorBlock.md#constructor)

### Properties

- [\_isUnique](ReplaceColorBlock.md#_isunique)
- [\_target](ReplaceColorBlock.md#_target)
- [comments](ReplaceColorBlock.md#comments)
- [inputsAreExclusive](ReplaceColorBlock.md#inputsareexclusive)
- [uniqueId](ReplaceColorBlock.md#uniqueid)
- [visibleInInspector](ReplaceColorBlock.md#visibleininspector)
- [visibleOnFrame](ReplaceColorBlock.md#visibleonframe)

### Accessors

- [buildId](ReplaceColorBlock.md#buildid)
- [distance](ReplaceColorBlock.md#distance)
- [inputs](ReplaceColorBlock.md#inputs)
- [isFinalMerger](ReplaceColorBlock.md#isfinalmerger)
- [isInput](ReplaceColorBlock.md#isinput)
- [isUnique](ReplaceColorBlock.md#isunique)
- [name](ReplaceColorBlock.md#name)
- [output](ReplaceColorBlock.md#output)
- [outputs](ReplaceColorBlock.md#outputs)
- [reference](ReplaceColorBlock.md#reference)
- [replacement](ReplaceColorBlock.md#replacement)
- [target](ReplaceColorBlock.md#target)
- [value](ReplaceColorBlock.md#value)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](ReplaceColorBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](ReplaceColorBlock.md#_buildblock)
- [\_declareOutput](ReplaceColorBlock.md#_declareoutput)
- [\_dumpPropertiesCode](ReplaceColorBlock.md#_dumppropertiescode)
- [\_inputRename](ReplaceColorBlock.md#_inputrename)
- [\_linkConnectionTypes](ReplaceColorBlock.md#_linkconnectiontypes)
- [\_outputRename](ReplaceColorBlock.md#_outputrename)
- [\_writeFloat](ReplaceColorBlock.md#_writefloat)
- [\_writeVariable](ReplaceColorBlock.md#_writevariable)
- [autoConfigure](ReplaceColorBlock.md#autoconfigure)
- [bind](ReplaceColorBlock.md#bind)
- [build](ReplaceColorBlock.md#build)
- [clone](ReplaceColorBlock.md#clone)
- [connectTo](ReplaceColorBlock.md#connectto)
- [dispose](ReplaceColorBlock.md#dispose)
- [getClassName](ReplaceColorBlock.md#getclassname)
- [getFirstAvailableInput](ReplaceColorBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](ReplaceColorBlock.md#getfirstavailableoutput)
- [getInputByName](ReplaceColorBlock.md#getinputbyname)
- [getOutputByName](ReplaceColorBlock.md#getoutputbyname)
- [getSiblingOutput](ReplaceColorBlock.md#getsiblingoutput)
- [initialize](ReplaceColorBlock.md#initialize)
- [initializeDefines](ReplaceColorBlock.md#initializedefines)
- [isAnAncestorOf](ReplaceColorBlock.md#isanancestorof)
- [isReady](ReplaceColorBlock.md#isready)
- [prepareDefines](ReplaceColorBlock.md#preparedefines)
- [provideFallbacks](ReplaceColorBlock.md#providefallbacks)
- [registerInput](ReplaceColorBlock.md#registerinput)
- [registerOutput](ReplaceColorBlock.md#registeroutput)
- [replaceRepeatableContent](ReplaceColorBlock.md#replacerepeatablecontent)
- [serialize](ReplaceColorBlock.md#serialize)
- [updateUniformsAndSamples](ReplaceColorBlock.md#updateuniformsandsamples)
- [validateBlockName](ReplaceColorBlock.md#validateblockname)

## Constructors

### constructor

• **new ReplaceColorBlock**(`name`)
...
packages/dev/core/src/Materials/Node/Blocks/replaceColorBlock.ts:15
...
• `get` **distance**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/replaceColorBlock.ts:61
...
packages/dev/core/src/Materials/Node/Blocks/replaceColorBlock.ts:75
...
• `get` **reference**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/replaceColorBlock.ts:54

___

### replacement

• `get` **replacement**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/replaceColorBlock.ts:68
...
packages/dev/core/src/Materials/Node/Blocks/replaceColorBlock.ts:47
...
▸ `Protected` **_buildBlock**(`state`): [`ReplaceColorBlock`](ReplaceColorBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/replaceColorBlock.ts:79
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`ReplaceColorBlock`](ReplaceColorBlock.md)
...
`undefined` \| [`ReplaceColorBlock`](ReplaceColorBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/replaceColorBlock.ts:40
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`ReplaceColorBlock`](ReplaceColorBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`ReplaceColorBlock`](ReplaceColorBlock.md)
