[@dev/core](../README.md) / [Exports](../modules.md) / GrainPostProcess
...
- [constructor](GrainPostProcess.md#constructor)

### Properties

- [\_indexParameters](GrainPostProcess.md#_indexparameters)
- [\_postProcessDefines](GrainPostProcess.md#_postprocessdefines)
- [\_scene](GrainPostProcess.md#_scene)
- [adaptScaleToCurrentViewport](GrainPostProcess.md#adaptscaletocurrentviewport)
- [alphaConstants](GrainPostProcess.md#alphaconstants)
- [alphaMode](GrainPostProcess.md#alphamode)
- [alwaysForcePOT](GrainPostProcess.md#alwaysforcepot)
- [animated](GrainPostProcess.md#animated)
- [animations](GrainPostProcess.md#animations)
- [autoClear](GrainPostProcess.md#autoclear)
- [clearColor](GrainPostProcess.md#clearcolor)
- [enablePixelPerfectMode](GrainPostProcess.md#enablepixelperfectmode)
- [externalTextureSamplerBinding](GrainPostProcess.md#externaltexturesamplerbinding)
- [forceFullscreenViewport](GrainPostProcess.md#forcefullscreenviewport)
- [height](GrainPostProcess.md#height)
- [inspectableCustomProperties](GrainPostProcess.md#inspectablecustomproperties)
- [intensity](GrainPostProcess.md#intensity)
- [name](GrainPostProcess.md#name)
- [nodeMaterialSource](GrainPostProcess.md#nodematerialsource)
- [onActivateObservable](GrainPostProcess.md#onactivateobservable)
- [onAfterRenderObservable](GrainPostProcess.md#onafterrenderobservable)
- [onApplyObservable](GrainPostProcess.md#onapplyobservable)
- [onBeforeRenderObservable](GrainPostProcess.md#onbeforerenderobservable)
- [onSizeChangedObservable](GrainPostProcess.md#onsizechangedobservable)
- [renderTargetSamplingMode](GrainPostProcess.md#rendertargetsamplingmode)
- [scaleMode](GrainPostProcess.md#scalemode)
- [uniqueId](GrainPostProcess.md#uniqueid)
- [width](GrainPostProcess.md#width)

### Accessors

- [aspectRatio](GrainPostProcess.md#aspectratio)
- [inputTexture](GrainPostProcess.md#inputtexture)
- [isSupported](GrainPostProcess.md#issupported)
- [onActivate](GrainPostProcess.md#onactivate)
- [onAfterRender](GrainPostProcess.md#onafterrender)
- [onApply](GrainPostProcess.md#onapply)
- [onBeforeRender](GrainPostProcess.md#onbeforerender)
- [onSizeChanged](GrainPostProcess.md#onsizechanged)
- [samples](GrainPostProcess.md#samples)
- [texelSize](GrainPostProcess.md#texelsize)

### Methods

- [activate](GrainPostProcess.md#activate)
- [apply](GrainPostProcess.md#apply)
- [clone](GrainPostProcess.md#clone)
- [dispose](GrainPostProcess.md#dispose)
- [getCamera](GrainPostProcess.md#getcamera)
- [getClassName](GrainPostProcess.md#getclassname)
- [getEffect](GrainPostProcess.md#geteffect)
- [getEffectName](GrainPostProcess.md#geteffectname)
- [getEngine](GrainPostProcess.md#getengine)
- [isReady](GrainPostProcess.md#isready)
- [isReusable](GrainPostProcess.md#isreusable)
- [markTextureDirty](GrainPostProcess.md#marktexturedirty)
- [restoreDefaultInputTexture](GrainPostProcess.md#restoredefaultinputtexture)
- [serialize](GrainPostProcess.md#serialize)
- [setPrePassRenderer](GrainPostProcess.md#setprepassrenderer)
- [shareOutputWith](GrainPostProcess.md#shareoutputwith)
- [updateEffect](GrainPostProcess.md#updateeffect)
- [useOwnOutput](GrainPostProcess.md#useownoutput)
- [Parse](GrainPostProcess.md#parse)

## Constructors

### constructor

• **new GrainPostProcess**(`name`, `options`, `camera`, `samplingMode?`, `engine?`, `reusable?`, `textureType?`, `blockCompilation?`)
...
https://github.com/babylon.js/core/src/PostProcesses/grainPostProcess.ts:49
...
https://github.com/babylon.js/core/src/PostProcesses/grainPostProcess.ts:28
...
https://github.com/babylon.js/core/src/PostProcesses/grainPostProcess.ts:23
...
https://github.com/babylon.js/core/src/PostProcesses/grainPostProcess.ts:34
