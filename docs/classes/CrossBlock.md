[@dev/core](../README.md) / [Exports](../modules.md) / CrossBlock
...
- [constructor](CrossBlock.md#constructor)

### Properties

- [\_isUnique](CrossBlock.md#_isunique)
- [\_target](CrossBlock.md#_target)
- [comments](CrossBlock.md#comments)
- [inputsAreExclusive](CrossBlock.md#inputsareexclusive)
- [uniqueId](CrossBlock.md#uniqueid)
- [visibleInInspector](CrossBlock.md#visibleininspector)
- [visibleOnFrame](CrossBlock.md#visibleonframe)

### Accessors

- [buildId](CrossBlock.md#buildid)
- [inputs](CrossBlock.md#inputs)
- [isFinalMerger](CrossBlock.md#isfinalmerger)
- [isInput](CrossBlock.md#isinput)
- [isUnique](CrossBlock.md#isunique)
- [left](CrossBlock.md#left)
- [name](CrossBlock.md#name)
- [output](CrossBlock.md#output)
- [outputs](CrossBlock.md#outputs)
- [right](CrossBlock.md#right)
- [target](CrossBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](CrossBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](CrossBlock.md#_buildblock)
- [\_declareOutput](CrossBlock.md#_declareoutput)
- [\_dumpPropertiesCode](CrossBlock.md#_dumppropertiescode)
- [\_inputRename](CrossBlock.md#_inputrename)
- [\_linkConnectionTypes](CrossBlock.md#_linkconnectiontypes)
- [\_outputRename](CrossBlock.md#_outputrename)
- [\_writeFloat](CrossBlock.md#_writefloat)
- [\_writeVariable](CrossBlock.md#_writevariable)
- [autoConfigure](CrossBlock.md#autoconfigure)
- [bind](CrossBlock.md#bind)
- [build](CrossBlock.md#build)
- [clone](CrossBlock.md#clone)
- [connectTo](CrossBlock.md#connectto)
- [dispose](CrossBlock.md#dispose)
- [getClassName](CrossBlock.md#getclassname)
- [getFirstAvailableInput](CrossBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](CrossBlock.md#getfirstavailableoutput)
- [getInputByName](CrossBlock.md#getinputbyname)
- [getOutputByName](CrossBlock.md#getoutputbyname)
- [getSiblingOutput](CrossBlock.md#getsiblingoutput)
- [initialize](CrossBlock.md#initialize)
- [initializeDefines](CrossBlock.md#initializedefines)
- [isAnAncestorOf](CrossBlock.md#isanancestorof)
- [isReady](CrossBlock.md#isready)
- [prepareDefines](CrossBlock.md#preparedefines)
- [provideFallbacks](CrossBlock.md#providefallbacks)
- [registerInput](CrossBlock.md#registerinput)
- [registerOutput](CrossBlock.md#registeroutput)
- [replaceRepeatableContent](CrossBlock.md#replacerepeatablecontent)
- [serialize](CrossBlock.md#serialize)
- [updateUniformsAndSamples](CrossBlock.md#updateuniformsandsamples)
- [validateBlockName](CrossBlock.md#validateblockname)
...
packages/dev/core/src/Materials/Node/Blocks/crossBlock.ts:15
...
packages/dev/core/src/Materials/Node/Blocks/crossBlock.ts:43
...
packages/dev/core/src/Materials/Node/Blocks/crossBlock.ts:57
...
packages/dev/core/src/Materials/Node/Blocks/crossBlock.ts:50
...
▸ `Protected` **_buildBlock**(`state`): [`CrossBlock`](CrossBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/crossBlock.ts:61
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`CrossBlock`](CrossBlock.md)
...
`undefined` \| [`CrossBlock`](CrossBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/crossBlock.ts:36
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`CrossBlock`](CrossBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`CrossBlock`](CrossBlock.md)
