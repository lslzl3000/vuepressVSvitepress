[@dev/core](../README.md) / [Exports](../modules.md) / MinBlock
...
- [constructor](MinBlock.md#constructor)

### Properties

- [\_isUnique](MinBlock.md#_isunique)
- [\_target](MinBlock.md#_target)
- [comments](MinBlock.md#comments)
- [inputsAreExclusive](MinBlock.md#inputsareexclusive)
- [uniqueId](MinBlock.md#uniqueid)
- [visibleInInspector](MinBlock.md#visibleininspector)
- [visibleOnFrame](MinBlock.md#visibleonframe)

### Accessors

- [buildId](MinBlock.md#buildid)
- [inputs](MinBlock.md#inputs)
- [isFinalMerger](MinBlock.md#isfinalmerger)
- [isInput](MinBlock.md#isinput)
- [isUnique](MinBlock.md#isunique)
- [left](MinBlock.md#left)
- [name](MinBlock.md#name)
- [output](MinBlock.md#output)
- [outputs](MinBlock.md#outputs)
- [right](MinBlock.md#right)
- [target](MinBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](MinBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](MinBlock.md#_buildblock)
- [\_declareOutput](MinBlock.md#_declareoutput)
- [\_dumpPropertiesCode](MinBlock.md#_dumppropertiescode)
- [\_inputRename](MinBlock.md#_inputrename)
- [\_linkConnectionTypes](MinBlock.md#_linkconnectiontypes)
- [\_outputRename](MinBlock.md#_outputrename)
- [\_writeFloat](MinBlock.md#_writefloat)
- [\_writeVariable](MinBlock.md#_writevariable)
- [autoConfigure](MinBlock.md#autoconfigure)
- [bind](MinBlock.md#bind)
- [build](MinBlock.md#build)
- [clone](MinBlock.md#clone)
- [connectTo](MinBlock.md#connectto)
- [dispose](MinBlock.md#dispose)
- [getClassName](MinBlock.md#getclassname)
- [getFirstAvailableInput](MinBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](MinBlock.md#getfirstavailableoutput)
- [getInputByName](MinBlock.md#getinputbyname)
- [getOutputByName](MinBlock.md#getoutputbyname)
- [getSiblingOutput](MinBlock.md#getsiblingoutput)
- [initialize](MinBlock.md#initialize)
- [initializeDefines](MinBlock.md#initializedefines)
- [isAnAncestorOf](MinBlock.md#isanancestorof)
- [isReady](MinBlock.md#isready)
- [prepareDefines](MinBlock.md#preparedefines)
- [provideFallbacks](MinBlock.md#providefallbacks)
- [registerInput](MinBlock.md#registerinput)
- [registerOutput](MinBlock.md#registeroutput)
- [replaceRepeatableContent](MinBlock.md#replacerepeatablecontent)
- [serialize](MinBlock.md#serialize)
- [updateUniformsAndSamples](MinBlock.md#updateuniformsandsamples)
- [validateBlockName](MinBlock.md#validateblockname)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/minBlock.ts:15
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/minBlock.ts:37
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/minBlock.ts:51
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/minBlock.ts:44
...
▸ `Protected` **_buildBlock**(`state`): [`MinBlock`](MinBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/minBlock.ts:55
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`MinBlock`](MinBlock.md)
...
`undefined` \| [`MinBlock`](MinBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/minBlock.ts:30
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`MinBlock`](MinBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`MinBlock`](MinBlock.md)
