[@dev/core](../README.md) / [Exports](../modules.md) / AnisotropyBlock
...
- [constructor](AnisotropyBlock.md#constructor)

### Properties

- [\_isUnique](AnisotropyBlock.md#_isunique)
- [\_target](AnisotropyBlock.md#_target)
- [comments](AnisotropyBlock.md#comments)
- [inputsAreExclusive](AnisotropyBlock.md#inputsareexclusive)
- [uniqueId](AnisotropyBlock.md#uniqueid)
- [visibleInInspector](AnisotropyBlock.md#visibleininspector)
- [visibleOnFrame](AnisotropyBlock.md#visibleonframe)

### Accessors

- [TBN](AnisotropyBlock.md#tbn)
- [anisotropy](AnisotropyBlock.md#anisotropy)
- [buildId](AnisotropyBlock.md#buildid)
- [direction](AnisotropyBlock.md#direction)
- [inputs](AnisotropyBlock.md#inputs)
- [intensity](AnisotropyBlock.md#intensity)
- [isFinalMerger](AnisotropyBlock.md#isfinalmerger)
- [isInput](AnisotropyBlock.md#isinput)
- [isUnique](AnisotropyBlock.md#isunique)
- [name](AnisotropyBlock.md#name)
- [outputs](AnisotropyBlock.md#outputs)
- [target](AnisotropyBlock.md#target)
- [uv](AnisotropyBlock.md#uv)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](AnisotropyBlock.md#willbegeneratedintovertexshaderfromfragmentshader)
- [worldTangent](AnisotropyBlock.md#worldtangent)

### Methods

- [\_buildBlock](AnisotropyBlock.md#_buildblock)
- [\_declareOutput](AnisotropyBlock.md#_declareoutput)
- [\_dumpPropertiesCode](AnisotropyBlock.md#_dumppropertiescode)
- [\_generateTBNSpace](AnisotropyBlock.md#_generatetbnspace)
- [\_inputRename](AnisotropyBlock.md#_inputrename)
- [\_linkConnectionTypes](AnisotropyBlock.md#_linkconnectiontypes)
- [\_outputRename](AnisotropyBlock.md#_outputrename)
- [\_writeFloat](AnisotropyBlock.md#_writefloat)
- [\_writeVariable](AnisotropyBlock.md#_writevariable)
- [autoConfigure](AnisotropyBlock.md#autoconfigure)
- [bind](AnisotropyBlock.md#bind)
- [build](AnisotropyBlock.md#build)
- [clone](AnisotropyBlock.md#clone)
- [connectTo](AnisotropyBlock.md#connectto)
- [dispose](AnisotropyBlock.md#dispose)
- [getClassName](AnisotropyBlock.md#getclassname)
- [getCode](AnisotropyBlock.md#getcode)
- [getFirstAvailableInput](AnisotropyBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](AnisotropyBlock.md#getfirstavailableoutput)
- [getInputByName](AnisotropyBlock.md#getinputbyname)
- [getOutputByName](AnisotropyBlock.md#getoutputbyname)
- [getSiblingOutput](AnisotropyBlock.md#getsiblingoutput)
- [initialize](AnisotropyBlock.md#initialize)
- [initializeDefines](AnisotropyBlock.md#initializedefines)
- [isAnAncestorOf](AnisotropyBlock.md#isanancestorof)
- [isReady](AnisotropyBlock.md#isready)
- [prepareDefines](AnisotropyBlock.md#preparedefines)
- [provideFallbacks](AnisotropyBlock.md#providefallbacks)
- [registerInput](AnisotropyBlock.md#registerinput)
- [registerOutput](AnisotropyBlock.md#registeroutput)
- [replaceRepeatableContent](AnisotropyBlock.md#replacerepeatablecontent)
- [serialize](AnisotropyBlock.md#serialize)
- [updateUniformsAndSamples](AnisotropyBlock.md#updateuniformsandsamples)
- [validateBlockName](AnisotropyBlock.md#validateblockname)

## Constructors

### constructor

• **new AnisotropyBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/anisotropyBlock.ts:32
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/anisotropyBlock.ts:106
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/anisotropyBlock.ts:113
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/anisotropyBlock.ts:84
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/anisotropyBlock.ts:77
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/anisotropyBlock.ts:91
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/anisotropyBlock.ts:98

## Methods

### \_buildBlock

▸ `Protected` **_buildBlock**(`state`): [`AnisotropyBlock`](AnisotropyBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/anisotropyBlock.ts:205
...
▸ `Private` **_generateTBNSpace**(`state`): `string`
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/anisotropyBlock.ts:117
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`AnisotropyBlock`](AnisotropyBlock.md)
...
`undefined` \| [`AnisotropyBlock`](AnisotropyBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/anisotropyBlock.ts:70

___

### getCode

▸ **getCode**(`state`, `generateTBNSpace?`): `string`
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `state` | `NodeMaterialBuildState` | `undefined` | current state of the node material building |
| `generateTBNSpace` | `boolean` | `false` | if true, the code needed to create the TBN coordinate space is generated |
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/anisotropyBlock.ts:173
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/anisotropyBlock.ts:61
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/anisotropyBlock.ts:198
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`AnisotropyBlock`](AnisotropyBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`AnisotropyBlock`](AnisotropyBlock.md)
