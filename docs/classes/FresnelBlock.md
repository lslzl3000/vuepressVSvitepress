[@dev/core](../README.md) / [Exports](../modules.md) / FresnelBlock
...
- [constructor](FresnelBlock.md#constructor)

### Properties

- [\_isUnique](FresnelBlock.md#_isunique)
- [\_target](FresnelBlock.md#_target)
- [comments](FresnelBlock.md#comments)
- [inputsAreExclusive](FresnelBlock.md#inputsareexclusive)
- [uniqueId](FresnelBlock.md#uniqueid)
- [visibleInInspector](FresnelBlock.md#visibleininspector)
- [visibleOnFrame](FresnelBlock.md#visibleonframe)

### Accessors

- [bias](FresnelBlock.md#bias)
- [buildId](FresnelBlock.md#buildid)
- [fresnel](FresnelBlock.md#fresnel)
- [inputs](FresnelBlock.md#inputs)
- [isFinalMerger](FresnelBlock.md#isfinalmerger)
- [isInput](FresnelBlock.md#isinput)
- [isUnique](FresnelBlock.md#isunique)
- [name](FresnelBlock.md#name)
- [outputs](FresnelBlock.md#outputs)
- [power](FresnelBlock.md#power)
- [target](FresnelBlock.md#target)
- [viewDirection](FresnelBlock.md#viewdirection)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](FresnelBlock.md#willbegeneratedintovertexshaderfromfragmentshader)
- [worldNormal](FresnelBlock.md#worldnormal)

### Methods

- [\_buildBlock](FresnelBlock.md#_buildblock)
- [\_declareOutput](FresnelBlock.md#_declareoutput)
- [\_dumpPropertiesCode](FresnelBlock.md#_dumppropertiescode)
- [\_inputRename](FresnelBlock.md#_inputrename)
- [\_linkConnectionTypes](FresnelBlock.md#_linkconnectiontypes)
- [\_outputRename](FresnelBlock.md#_outputrename)
- [\_writeFloat](FresnelBlock.md#_writefloat)
- [\_writeVariable](FresnelBlock.md#_writevariable)
- [autoConfigure](FresnelBlock.md#autoconfigure)
- [bind](FresnelBlock.md#bind)
- [build](FresnelBlock.md#build)
- [clone](FresnelBlock.md#clone)
- [connectTo](FresnelBlock.md#connectto)
- [dispose](FresnelBlock.md#dispose)
- [getClassName](FresnelBlock.md#getclassname)
- [getFirstAvailableInput](FresnelBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](FresnelBlock.md#getfirstavailableoutput)
- [getInputByName](FresnelBlock.md#getinputbyname)
- [getOutputByName](FresnelBlock.md#getoutputbyname)
- [getSiblingOutput](FresnelBlock.md#getsiblingoutput)
- [initialize](FresnelBlock.md#initialize)
- [initializeDefines](FresnelBlock.md#initializedefines)
- [isAnAncestorOf](FresnelBlock.md#isanancestorof)
- [isReady](FresnelBlock.md#isready)
- [prepareDefines](FresnelBlock.md#preparedefines)
- [provideFallbacks](FresnelBlock.md#providefallbacks)
- [registerInput](FresnelBlock.md#registerinput)
- [registerOutput](FresnelBlock.md#registeroutput)
- [replaceRepeatableContent](FresnelBlock.md#replacerepeatablecontent)
- [serialize](FresnelBlock.md#serialize)
- [updateUniformsAndSamples](FresnelBlock.md#updateuniformsandsamples)
- [validateBlockName](FresnelBlock.md#validateblockname)

## Constructors

### constructor

• **new FresnelBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/fresnelBlock.ts:21
...
• `get` **bias**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/fresnelBlock.ts:57
...
• `get` **fresnel**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/fresnelBlock.ts:71
...
• `get` **power**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/fresnelBlock.ts:64
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/fresnelBlock.ts:50
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/fresnelBlock.ts:43

## Methods

### \_buildBlock

▸ `Protected` **_buildBlock**(`state`): [`FresnelBlock`](FresnelBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/fresnelBlock.ts:95
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/fresnelBlock.ts:75
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`FresnelBlock`](FresnelBlock.md)
...
`undefined` \| [`FresnelBlock`](FresnelBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/fresnelBlock.ts:36
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`FresnelBlock`](FresnelBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`FresnelBlock`](FresnelBlock.md)
