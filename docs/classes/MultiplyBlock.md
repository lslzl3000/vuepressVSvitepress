[@dev/core](../README.md) / [Exports](../modules.md) / MultiplyBlock
...
- [constructor](MultiplyBlock.md#constructor)

### Properties

- [\_isUnique](MultiplyBlock.md#_isunique)
- [\_target](MultiplyBlock.md#_target)
- [comments](MultiplyBlock.md#comments)
- [inputsAreExclusive](MultiplyBlock.md#inputsareexclusive)
- [uniqueId](MultiplyBlock.md#uniqueid)
- [visibleInInspector](MultiplyBlock.md#visibleininspector)
- [visibleOnFrame](MultiplyBlock.md#visibleonframe)

### Accessors

- [buildId](MultiplyBlock.md#buildid)
- [inputs](MultiplyBlock.md#inputs)
- [isFinalMerger](MultiplyBlock.md#isfinalmerger)
- [isInput](MultiplyBlock.md#isinput)
- [isUnique](MultiplyBlock.md#isunique)
- [left](MultiplyBlock.md#left)
- [name](MultiplyBlock.md#name)
- [output](MultiplyBlock.md#output)
- [outputs](MultiplyBlock.md#outputs)
- [right](MultiplyBlock.md#right)
- [target](MultiplyBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](MultiplyBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](MultiplyBlock.md#_buildblock)
- [\_declareOutput](MultiplyBlock.md#_declareoutput)
- [\_dumpPropertiesCode](MultiplyBlock.md#_dumppropertiescode)
- [\_inputRename](MultiplyBlock.md#_inputrename)
- [\_linkConnectionTypes](MultiplyBlock.md#_linkconnectiontypes)
- [\_outputRename](MultiplyBlock.md#_outputrename)
- [\_writeFloat](MultiplyBlock.md#_writefloat)
- [\_writeVariable](MultiplyBlock.md#_writevariable)
- [autoConfigure](MultiplyBlock.md#autoconfigure)
- [bind](MultiplyBlock.md#bind)
- [build](MultiplyBlock.md#build)
- [clone](MultiplyBlock.md#clone)
- [connectTo](MultiplyBlock.md#connectto)
- [dispose](MultiplyBlock.md#dispose)
- [getClassName](MultiplyBlock.md#getclassname)
- [getFirstAvailableInput](MultiplyBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](MultiplyBlock.md#getfirstavailableoutput)
- [getInputByName](MultiplyBlock.md#getinputbyname)
- [getOutputByName](MultiplyBlock.md#getoutputbyname)
- [getSiblingOutput](MultiplyBlock.md#getsiblingoutput)
- [initialize](MultiplyBlock.md#initialize)
- [initializeDefines](MultiplyBlock.md#initializedefines)
- [isAnAncestorOf](MultiplyBlock.md#isanancestorof)
- [isReady](MultiplyBlock.md#isready)
- [prepareDefines](MultiplyBlock.md#preparedefines)
- [provideFallbacks](MultiplyBlock.md#providefallbacks)
- [registerInput](MultiplyBlock.md#registerinput)
- [registerOutput](MultiplyBlock.md#registeroutput)
- [replaceRepeatableContent](MultiplyBlock.md#replacerepeatablecontent)
- [serialize](MultiplyBlock.md#serialize)
- [updateUniformsAndSamples](MultiplyBlock.md#updateuniformsandsamples)
- [validateBlockName](MultiplyBlock.md#validateblockname)

## Constructors

### constructor

• **new MultiplyBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/multiplyBlock.ts:15
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/multiplyBlock.ts:37
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/multiplyBlock.ts:51
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/multiplyBlock.ts:44
...
▸ `Protected` **_buildBlock**(`state`): [`MultiplyBlock`](MultiplyBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/multiplyBlock.ts:55
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`MultiplyBlock`](MultiplyBlock.md)
...
`undefined` \| [`MultiplyBlock`](MultiplyBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/multiplyBlock.ts:30
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`MultiplyBlock`](MultiplyBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`MultiplyBlock`](MultiplyBlock.md)
