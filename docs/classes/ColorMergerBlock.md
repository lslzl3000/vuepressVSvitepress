[@dev/core](../README.md) / [Exports](../modules.md) / ColorMergerBlock
...
- [constructor](ColorMergerBlock.md#constructor)

### Properties

- [\_isUnique](ColorMergerBlock.md#_isunique)
- [\_target](ColorMergerBlock.md#_target)
- [aSwizzle](ColorMergerBlock.md#aswizzle)
- [bSwizzle](ColorMergerBlock.md#bswizzle)
- [comments](ColorMergerBlock.md#comments)
- [gSwizzle](ColorMergerBlock.md#gswizzle)
- [inputsAreExclusive](ColorMergerBlock.md#inputsareexclusive)
- [rSwizzle](ColorMergerBlock.md#rswizzle)
- [uniqueId](ColorMergerBlock.md#uniqueid)
- [visibleInInspector](ColorMergerBlock.md#visibleininspector)
- [visibleOnFrame](ColorMergerBlock.md#visibleonframe)

### Accessors

- [a](ColorMergerBlock.md#a)
- [b](ColorMergerBlock.md#b)
- [buildId](ColorMergerBlock.md#buildid)
- [g](ColorMergerBlock.md#g)
- [inputs](ColorMergerBlock.md#inputs)
- [isFinalMerger](ColorMergerBlock.md#isfinalmerger)
- [isInput](ColorMergerBlock.md#isinput)
- [isUnique](ColorMergerBlock.md#isunique)
- [name](ColorMergerBlock.md#name)
- [outputs](ColorMergerBlock.md#outputs)
- [r](ColorMergerBlock.md#r)
- [rgb](ColorMergerBlock.md#rgb)
- [rgbIn](ColorMergerBlock.md#rgbin)
- [rgbOut](ColorMergerBlock.md#rgbout)
- [rgba](ColorMergerBlock.md#rgba)
- [target](ColorMergerBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](ColorMergerBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](ColorMergerBlock.md#_buildblock)
- [\_buildSwizzle](ColorMergerBlock.md#_buildswizzle)
- [\_declareOutput](ColorMergerBlock.md#_declareoutput)
- [\_deserialize](ColorMergerBlock.md#_deserialize)
- [\_dumpPropertiesCode](ColorMergerBlock.md#_dumppropertiescode)
- [\_inputRename](ColorMergerBlock.md#_inputrename)
- [\_linkConnectionTypes](ColorMergerBlock.md#_linkconnectiontypes)
- [\_outputRename](ColorMergerBlock.md#_outputrename)
- [\_writeFloat](ColorMergerBlock.md#_writefloat)
- [\_writeVariable](ColorMergerBlock.md#_writevariable)
- [autoConfigure](ColorMergerBlock.md#autoconfigure)
- [bind](ColorMergerBlock.md#bind)
- [build](ColorMergerBlock.md#build)
- [clone](ColorMergerBlock.md#clone)
- [connectTo](ColorMergerBlock.md#connectto)
- [dispose](ColorMergerBlock.md#dispose)
- [getClassName](ColorMergerBlock.md#getclassname)
- [getFirstAvailableInput](ColorMergerBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](ColorMergerBlock.md#getfirstavailableoutput)
- [getInputByName](ColorMergerBlock.md#getinputbyname)
- [getOutputByName](ColorMergerBlock.md#getoutputbyname)
- [getSiblingOutput](ColorMergerBlock.md#getsiblingoutput)
- [initialize](ColorMergerBlock.md#initialize)
- [initializeDefines](ColorMergerBlock.md#initializedefines)
- [isAnAncestorOf](ColorMergerBlock.md#isanancestorof)
- [isReady](ColorMergerBlock.md#isready)
- [prepareDefines](ColorMergerBlock.md#preparedefines)
- [provideFallbacks](ColorMergerBlock.md#providefallbacks)
- [registerInput](ColorMergerBlock.md#registerinput)
- [registerOutput](ColorMergerBlock.md#registeroutput)
- [replaceRepeatableContent](ColorMergerBlock.md#replacerepeatablecontent)
- [serialize](ColorMergerBlock.md#serialize)
- [updateUniformsAndSamples](ColorMergerBlock.md#updateuniformsandsamples)
- [validateBlockName](ColorMergerBlock.md#validateblockname)

## Constructors

### constructor

• **new ColorMergerBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorMergerBlock.ts:34
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorMergerBlock.ts:28
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorMergerBlock.ts:24
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorMergerBlock.ts:20
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorMergerBlock.ts:16
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorMergerBlock.ts:86
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorMergerBlock.ts:79
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorMergerBlock.ts:72
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorMergerBlock.ts:65
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorMergerBlock.ts:108

___

### rgbIn

• `get` **rgbIn**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorMergerBlock.ts:58

___

### rgbOut

• `get` **rgbOut**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorMergerBlock.ts:100
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorMergerBlock.ts:93
...
▸ `Protected` **_buildBlock**(`state`): [`ColorMergerBlock`](ColorMergerBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorMergerBlock.ts:124
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorMergerBlock.ts:119
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorMergerBlock.ts:178
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorMergerBlock.ts:187
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorMergerBlock.ts:112
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`ColorMergerBlock`](ColorMergerBlock.md)
...
`undefined` \| [`ColorMergerBlock`](ColorMergerBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorMergerBlock.ts:51
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`ColorMergerBlock`](ColorMergerBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`ColorMergerBlock`](ColorMergerBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorMergerBlock.ts:167
