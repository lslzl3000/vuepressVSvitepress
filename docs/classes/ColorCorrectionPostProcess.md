[@dev/core](../README.md) / [Exports](../modules.md) / ColorCorrectionPostProcess
...
- [constructor](ColorCorrectionPostProcess.md#constructor)

### Properties

- [\_colorTableTexture](ColorCorrectionPostProcess.md#_colortabletexture)
- [\_indexParameters](ColorCorrectionPostProcess.md#_indexparameters)
- [\_postProcessDefines](ColorCorrectionPostProcess.md#_postprocessdefines)
- [\_scene](ColorCorrectionPostProcess.md#_scene)
- [adaptScaleToCurrentViewport](ColorCorrectionPostProcess.md#adaptscaletocurrentviewport)
- [alphaConstants](ColorCorrectionPostProcess.md#alphaconstants)
- [alphaMode](ColorCorrectionPostProcess.md#alphamode)
- [alwaysForcePOT](ColorCorrectionPostProcess.md#alwaysforcepot)
- [animations](ColorCorrectionPostProcess.md#animations)
- [autoClear](ColorCorrectionPostProcess.md#autoclear)
- [clearColor](ColorCorrectionPostProcess.md#clearcolor)
- [colorTableUrl](ColorCorrectionPostProcess.md#colortableurl)
- [enablePixelPerfectMode](ColorCorrectionPostProcess.md#enablepixelperfectmode)
- [externalTextureSamplerBinding](ColorCorrectionPostProcess.md#externaltexturesamplerbinding)
- [forceFullscreenViewport](ColorCorrectionPostProcess.md#forcefullscreenviewport)
- [height](ColorCorrectionPostProcess.md#height)
- [inspectableCustomProperties](ColorCorrectionPostProcess.md#inspectablecustomproperties)
- [name](ColorCorrectionPostProcess.md#name)
- [nodeMaterialSource](ColorCorrectionPostProcess.md#nodematerialsource)
- [onActivateObservable](ColorCorrectionPostProcess.md#onactivateobservable)
- [onAfterRenderObservable](ColorCorrectionPostProcess.md#onafterrenderobservable)
- [onApplyObservable](ColorCorrectionPostProcess.md#onapplyobservable)
- [onBeforeRenderObservable](ColorCorrectionPostProcess.md#onbeforerenderobservable)
- [onSizeChangedObservable](ColorCorrectionPostProcess.md#onsizechangedobservable)
- [renderTargetSamplingMode](ColorCorrectionPostProcess.md#rendertargetsamplingmode)
- [scaleMode](ColorCorrectionPostProcess.md#scalemode)
- [uniqueId](ColorCorrectionPostProcess.md#uniqueid)
- [width](ColorCorrectionPostProcess.md#width)

### Accessors

- [aspectRatio](ColorCorrectionPostProcess.md#aspectratio)
- [inputTexture](ColorCorrectionPostProcess.md#inputtexture)
- [isSupported](ColorCorrectionPostProcess.md#issupported)
- [onActivate](ColorCorrectionPostProcess.md#onactivate)
- [onAfterRender](ColorCorrectionPostProcess.md#onafterrender)
- [onApply](ColorCorrectionPostProcess.md#onapply)
- [onBeforeRender](ColorCorrectionPostProcess.md#onbeforerender)
- [onSizeChanged](ColorCorrectionPostProcess.md#onsizechanged)
- [samples](ColorCorrectionPostProcess.md#samples)
- [texelSize](ColorCorrectionPostProcess.md#texelsize)

### Methods

- [activate](ColorCorrectionPostProcess.md#activate)
- [apply](ColorCorrectionPostProcess.md#apply)
- [clone](ColorCorrectionPostProcess.md#clone)
- [dispose](ColorCorrectionPostProcess.md#dispose)
- [getCamera](ColorCorrectionPostProcess.md#getcamera)
- [getClassName](ColorCorrectionPostProcess.md#getclassname)
- [getEffect](ColorCorrectionPostProcess.md#geteffect)
- [getEffectName](ColorCorrectionPostProcess.md#geteffectname)
- [getEngine](ColorCorrectionPostProcess.md#getengine)
- [isReady](ColorCorrectionPostProcess.md#isready)
- [isReusable](ColorCorrectionPostProcess.md#isreusable)
- [markTextureDirty](ColorCorrectionPostProcess.md#marktexturedirty)
- [restoreDefaultInputTexture](ColorCorrectionPostProcess.md#restoredefaultinputtexture)
- [serialize](ColorCorrectionPostProcess.md#serialize)
- [setPrePassRenderer](ColorCorrectionPostProcess.md#setprepassrenderer)
- [shareOutputWith](ColorCorrectionPostProcess.md#shareoutputwith)
- [updateEffect](ColorCorrectionPostProcess.md#updateeffect)
- [useOwnOutput](ColorCorrectionPostProcess.md#useownoutput)
- [Parse](ColorCorrectionPostProcess.md#parse)

## Constructors

### constructor

• **new ColorCorrectionPostProcess**(`name`, `colorTableUrl`, `options`, `camera`, `samplingMode?`, `engine?`, `reusable?`)
...
| `options` | `number` \| [`PostProcessOptions`](../modules.md#postprocessoptions) |
...
packages/dev/core/src/PostProcesses/colorCorrectionPostProcess.ts:47

## Properties

### \_colorTableTexture

• `Private` **\_colorTableTexture**: [`Texture`](Texture.md)

#### Defined in

packages/dev/core/src/PostProcesses/colorCorrectionPostProcess.ts:31
...
packages/dev/core/src/PostProcesses/colorCorrectionPostProcess.ts:37
...
"ColorCorrectionPostProcess" string
...
packages/dev/core/src/PostProcesses/colorCorrectionPostProcess.ts:43
