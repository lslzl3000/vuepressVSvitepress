[@dev/core](../README.md) / [Exports](../modules.md) / BloomMergePostProcess
...
- [constructor](BloomMergePostProcess.md#constructor)

### Properties

- [\_indexParameters](BloomMergePostProcess.md#_indexparameters)
- [\_postProcessDefines](BloomMergePostProcess.md#_postprocessdefines)
- [\_scene](BloomMergePostProcess.md#_scene)
- [adaptScaleToCurrentViewport](BloomMergePostProcess.md#adaptscaletocurrentviewport)
- [alphaConstants](BloomMergePostProcess.md#alphaconstants)
- [alphaMode](BloomMergePostProcess.md#alphamode)
- [alwaysForcePOT](BloomMergePostProcess.md#alwaysforcepot)
- [animations](BloomMergePostProcess.md#animations)
- [autoClear](BloomMergePostProcess.md#autoclear)
- [clearColor](BloomMergePostProcess.md#clearcolor)
- [enablePixelPerfectMode](BloomMergePostProcess.md#enablepixelperfectmode)
- [externalTextureSamplerBinding](BloomMergePostProcess.md#externaltexturesamplerbinding)
- [forceFullscreenViewport](BloomMergePostProcess.md#forcefullscreenviewport)
- [height](BloomMergePostProcess.md#height)
- [inspectableCustomProperties](BloomMergePostProcess.md#inspectablecustomproperties)
- [name](BloomMergePostProcess.md#name)
- [nodeMaterialSource](BloomMergePostProcess.md#nodematerialsource)
- [onActivateObservable](BloomMergePostProcess.md#onactivateobservable)
- [onAfterRenderObservable](BloomMergePostProcess.md#onafterrenderobservable)
- [onApplyObservable](BloomMergePostProcess.md#onapplyobservable)
- [onBeforeRenderObservable](BloomMergePostProcess.md#onbeforerenderobservable)
- [onSizeChangedObservable](BloomMergePostProcess.md#onsizechangedobservable)
- [renderTargetSamplingMode](BloomMergePostProcess.md#rendertargetsamplingmode)
- [scaleMode](BloomMergePostProcess.md#scalemode)
- [uniqueId](BloomMergePostProcess.md#uniqueid)
- [weight](BloomMergePostProcess.md#weight)
- [width](BloomMergePostProcess.md#width)

### Accessors

- [aspectRatio](BloomMergePostProcess.md#aspectratio)
- [inputTexture](BloomMergePostProcess.md#inputtexture)
- [isSupported](BloomMergePostProcess.md#issupported)
- [onActivate](BloomMergePostProcess.md#onactivate)
- [onAfterRender](BloomMergePostProcess.md#onafterrender)
- [onApply](BloomMergePostProcess.md#onapply)
- [onBeforeRender](BloomMergePostProcess.md#onbeforerender)
- [onSizeChanged](BloomMergePostProcess.md#onsizechanged)
- [samples](BloomMergePostProcess.md#samples)
- [texelSize](BloomMergePostProcess.md#texelsize)

### Methods

- [activate](BloomMergePostProcess.md#activate)
- [apply](BloomMergePostProcess.md#apply)
- [clone](BloomMergePostProcess.md#clone)
- [dispose](BloomMergePostProcess.md#dispose)
- [getCamera](BloomMergePostProcess.md#getcamera)
- [getClassName](BloomMergePostProcess.md#getclassname)
- [getEffect](BloomMergePostProcess.md#geteffect)
- [getEffectName](BloomMergePostProcess.md#geteffectname)
- [getEngine](BloomMergePostProcess.md#getengine)
- [isReady](BloomMergePostProcess.md#isready)
- [isReusable](BloomMergePostProcess.md#isreusable)
- [markTextureDirty](BloomMergePostProcess.md#marktexturedirty)
- [restoreDefaultInputTexture](BloomMergePostProcess.md#restoredefaultinputtexture)
- [serialize](BloomMergePostProcess.md#serialize)
- [setPrePassRenderer](BloomMergePostProcess.md#setprepassrenderer)
- [shareOutputWith](BloomMergePostProcess.md#shareoutputwith)
- [updateEffect](BloomMergePostProcess.md#updateeffect)
- [useOwnOutput](BloomMergePostProcess.md#useownoutput)
- [Parse](BloomMergePostProcess.md#parse)

## Constructors

### constructor

• **new BloomMergePostProcess**(`name`, `originalFromInput`, `blurred`, `weight`, `options`, `camera`, `samplingMode?`, `engine?`, `reusable?`, `textureType?`, `blockCompilation?`)
...
| `blurred` | [`PostProcess`](PostProcess.md) | `undefined` | Blurred highlights post process which's output will be used. |
| `weight` | `number` | `undefined` | Weight of the bloom to be added to the original input. |
...
https://github.com/babylon.js/core/src/PostProcesses/bloomMergePostProcess.ts:43
...
https://github.com/babylon.js/core/src/PostProcesses/bloomMergePostProcess.ts:19
...
https://github.com/babylon.js/core/src/PostProcesses/bloomMergePostProcess.ts:25
