[@dev/core](../README.md) / [Exports](../modules.md) / ViewDirectionBlock
...
- [constructor](ViewDirectionBlock.md#constructor)

### Properties

- [\_isUnique](ViewDirectionBlock.md#_isunique)
- [\_target](ViewDirectionBlock.md#_target)
- [comments](ViewDirectionBlock.md#comments)
- [inputsAreExclusive](ViewDirectionBlock.md#inputsareexclusive)
- [uniqueId](ViewDirectionBlock.md#uniqueid)
- [visibleInInspector](ViewDirectionBlock.md#visibleininspector)
- [visibleOnFrame](ViewDirectionBlock.md#visibleonframe)

### Accessors

- [buildId](ViewDirectionBlock.md#buildid)
- [cameraPosition](ViewDirectionBlock.md#cameraposition)
- [inputs](ViewDirectionBlock.md#inputs)
- [isFinalMerger](ViewDirectionBlock.md#isfinalmerger)
- [isInput](ViewDirectionBlock.md#isinput)
- [isUnique](ViewDirectionBlock.md#isunique)
- [name](ViewDirectionBlock.md#name)
- [output](ViewDirectionBlock.md#output)
- [outputs](ViewDirectionBlock.md#outputs)
- [target](ViewDirectionBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](ViewDirectionBlock.md#willbegeneratedintovertexshaderfromfragmentshader)
- [worldPosition](ViewDirectionBlock.md#worldposition)

### Methods

- [\_buildBlock](ViewDirectionBlock.md#_buildblock)
- [\_declareOutput](ViewDirectionBlock.md#_declareoutput)
- [\_dumpPropertiesCode](ViewDirectionBlock.md#_dumppropertiescode)
- [\_inputRename](ViewDirectionBlock.md#_inputrename)
- [\_linkConnectionTypes](ViewDirectionBlock.md#_linkconnectiontypes)
- [\_outputRename](ViewDirectionBlock.md#_outputrename)
- [\_writeFloat](ViewDirectionBlock.md#_writefloat)
- [\_writeVariable](ViewDirectionBlock.md#_writevariable)
- [autoConfigure](ViewDirectionBlock.md#autoconfigure)
- [bind](ViewDirectionBlock.md#bind)
- [build](ViewDirectionBlock.md#build)
- [clone](ViewDirectionBlock.md#clone)
- [connectTo](ViewDirectionBlock.md#connectto)
- [dispose](ViewDirectionBlock.md#dispose)
- [getClassName](ViewDirectionBlock.md#getclassname)
- [getFirstAvailableInput](ViewDirectionBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](ViewDirectionBlock.md#getfirstavailableoutput)
- [getInputByName](ViewDirectionBlock.md#getinputbyname)
- [getOutputByName](ViewDirectionBlock.md#getoutputbyname)
- [getSiblingOutput](ViewDirectionBlock.md#getsiblingoutput)
- [initialize](ViewDirectionBlock.md#initialize)
- [initializeDefines](ViewDirectionBlock.md#initializedefines)
- [isAnAncestorOf](ViewDirectionBlock.md#isanancestorof)
- [isReady](ViewDirectionBlock.md#isready)
- [prepareDefines](ViewDirectionBlock.md#preparedefines)
- [provideFallbacks](ViewDirectionBlock.md#providefallbacks)
- [registerInput](ViewDirectionBlock.md#registerinput)
- [registerOutput](ViewDirectionBlock.md#registeroutput)
- [replaceRepeatableContent](ViewDirectionBlock.md#replacerepeatablecontent)
- [serialize](ViewDirectionBlock.md#serialize)
- [updateUniformsAndSamples](ViewDirectionBlock.md#updateuniformsandsamples)
- [validateBlockName](ViewDirectionBlock.md#validateblockname)

## Constructors

### constructor

• **new ViewDirectionBlock**(`name`)
...
packages/dev/core/src/Materials/Node/Blocks/viewDirectionBlock.ts:18
...
packages/dev/core/src/Materials/Node/Blocks/viewDirectionBlock.ts:45
...
packages/dev/core/src/Materials/Node/Blocks/viewDirectionBlock.ts:52
...
packages/dev/core/src/Materials/Node/Blocks/viewDirectionBlock.ts:38

## Methods

### \_buildBlock

▸ `Protected` **_buildBlock**(`state`): [`ViewDirectionBlock`](ViewDirectionBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/viewDirectionBlock.ts:68
...
packages/dev/core/src/Materials/Node/Blocks/viewDirectionBlock.ts:56
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`ViewDirectionBlock`](ViewDirectionBlock.md)
...
`undefined` \| [`ViewDirectionBlock`](ViewDirectionBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/viewDirectionBlock.ts:31
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`ViewDirectionBlock`](ViewDirectionBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`ViewDirectionBlock`](ViewDirectionBlock.md)
