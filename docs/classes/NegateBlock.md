[@dev/core](../README.md) / [Exports](../modules.md) / NegateBlock
...
- [constructor](NegateBlock.md#constructor)

### Properties

- [\_isUnique](NegateBlock.md#_isunique)
- [\_target](NegateBlock.md#_target)
- [comments](NegateBlock.md#comments)
- [inputsAreExclusive](NegateBlock.md#inputsareexclusive)
- [uniqueId](NegateBlock.md#uniqueid)
- [visibleInInspector](NegateBlock.md#visibleininspector)
- [visibleOnFrame](NegateBlock.md#visibleonframe)

### Accessors

- [buildId](NegateBlock.md#buildid)
- [inputs](NegateBlock.md#inputs)
- [isFinalMerger](NegateBlock.md#isfinalmerger)
- [isInput](NegateBlock.md#isinput)
- [isUnique](NegateBlock.md#isunique)
- [name](NegateBlock.md#name)
- [output](NegateBlock.md#output)
- [outputs](NegateBlock.md#outputs)
- [target](NegateBlock.md#target)
- [value](NegateBlock.md#value)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](NegateBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](NegateBlock.md#_buildblock)
- [\_declareOutput](NegateBlock.md#_declareoutput)
- [\_dumpPropertiesCode](NegateBlock.md#_dumppropertiescode)
- [\_inputRename](NegateBlock.md#_inputrename)
- [\_linkConnectionTypes](NegateBlock.md#_linkconnectiontypes)
- [\_outputRename](NegateBlock.md#_outputrename)
- [\_writeFloat](NegateBlock.md#_writefloat)
- [\_writeVariable](NegateBlock.md#_writevariable)
- [autoConfigure](NegateBlock.md#autoconfigure)
- [bind](NegateBlock.md#bind)
- [build](NegateBlock.md#build)
- [clone](NegateBlock.md#clone)
- [connectTo](NegateBlock.md#connectto)
- [dispose](NegateBlock.md#dispose)
- [getClassName](NegateBlock.md#getclassname)
- [getFirstAvailableInput](NegateBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](NegateBlock.md#getfirstavailableoutput)
- [getInputByName](NegateBlock.md#getinputbyname)
- [getOutputByName](NegateBlock.md#getoutputbyname)
- [getSiblingOutput](NegateBlock.md#getsiblingoutput)
- [initialize](NegateBlock.md#initialize)
- [initializeDefines](NegateBlock.md#initializedefines)
- [isAnAncestorOf](NegateBlock.md#isanancestorof)
- [isReady](NegateBlock.md#isready)
- [prepareDefines](NegateBlock.md#preparedefines)
- [provideFallbacks](NegateBlock.md#providefallbacks)
- [registerInput](NegateBlock.md#registerinput)
- [registerOutput](NegateBlock.md#registeroutput)
- [replaceRepeatableContent](NegateBlock.md#replacerepeatablecontent)
- [serialize](NegateBlock.md#serialize)
- [updateUniformsAndSamples](NegateBlock.md#updateuniformsandsamples)
- [validateBlockName](NegateBlock.md#validateblockname)

## Constructors

### constructor

• **new NegateBlock**(`name`)
...
packages/dev/core/src/Materials/Node/Blocks/negateBlock.ts:15
...
packages/dev/core/src/Materials/Node/Blocks/negateBlock.ts:42
...
packages/dev/core/src/Materials/Node/Blocks/negateBlock.ts:35
...
▸ `Protected` **_buildBlock**(`state`): [`NegateBlock`](NegateBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/negateBlock.ts:46
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`NegateBlock`](NegateBlock.md)
...
`undefined` \| [`NegateBlock`](NegateBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/negateBlock.ts:28
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`NegateBlock`](NegateBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`NegateBlock`](NegateBlock.md)
