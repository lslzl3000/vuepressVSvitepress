[@dev/core](../README.md) / [Exports](../modules.md) / MorphTargetsBlock
...
- [constructor](MorphTargetsBlock.md#constructor)

### Properties

- [\_isUnique](MorphTargetsBlock.md#_isunique)
- [\_repeatableContentAnchor](MorphTargetsBlock.md#_repeatablecontentanchor)
- [\_target](MorphTargetsBlock.md#_target)
- [comments](MorphTargetsBlock.md#comments)
- [inputsAreExclusive](MorphTargetsBlock.md#inputsareexclusive)
- [uniqueId](MorphTargetsBlock.md#uniqueid)
- [visibleInInspector](MorphTargetsBlock.md#visibleininspector)
- [visibleOnFrame](MorphTargetsBlock.md#visibleonframe)

### Accessors

- [buildId](MorphTargetsBlock.md#buildid)
- [inputs](MorphTargetsBlock.md#inputs)
- [isFinalMerger](MorphTargetsBlock.md#isfinalmerger)
- [isInput](MorphTargetsBlock.md#isinput)
- [isUnique](MorphTargetsBlock.md#isunique)
- [name](MorphTargetsBlock.md#name)
- [normal](MorphTargetsBlock.md#normal)
- [normalOutput](MorphTargetsBlock.md#normaloutput)
- [outputs](MorphTargetsBlock.md#outputs)
- [position](MorphTargetsBlock.md#position)
- [positionOutput](MorphTargetsBlock.md#positionoutput)
- [tangent](MorphTargetsBlock.md#tangent)
- [tangentOutput](MorphTargetsBlock.md#tangentoutput)
- [target](MorphTargetsBlock.md#target)
- [uv](MorphTargetsBlock.md#uv)
- [uvOutput](MorphTargetsBlock.md#uvoutput)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](MorphTargetsBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](MorphTargetsBlock.md#_buildblock)
- [\_declareOutput](MorphTargetsBlock.md#_declareoutput)
- [\_dumpPropertiesCode](MorphTargetsBlock.md#_dumppropertiescode)
- [\_inputRename](MorphTargetsBlock.md#_inputrename)
- [\_linkConnectionTypes](MorphTargetsBlock.md#_linkconnectiontypes)
- [\_outputRename](MorphTargetsBlock.md#_outputrename)
- [\_writeFloat](MorphTargetsBlock.md#_writefloat)
- [\_writeVariable](MorphTargetsBlock.md#_writevariable)
- [autoConfigure](MorphTargetsBlock.md#autoconfigure)
- [bind](MorphTargetsBlock.md#bind)
- [build](MorphTargetsBlock.md#build)
- [clone](MorphTargetsBlock.md#clone)
- [connectTo](MorphTargetsBlock.md#connectto)
- [dispose](MorphTargetsBlock.md#dispose)
- [getClassName](MorphTargetsBlock.md#getclassname)
- [getFirstAvailableInput](MorphTargetsBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](MorphTargetsBlock.md#getfirstavailableoutput)
- [getInputByName](MorphTargetsBlock.md#getinputbyname)
- [getOutputByName](MorphTargetsBlock.md#getoutputbyname)
- [getSiblingOutput](MorphTargetsBlock.md#getsiblingoutput)
- [initialize](MorphTargetsBlock.md#initialize)
- [initializeDefines](MorphTargetsBlock.md#initializedefines)
- [isAnAncestorOf](MorphTargetsBlock.md#isanancestorof)
- [isReady](MorphTargetsBlock.md#isready)
- [prepareDefines](MorphTargetsBlock.md#preparedefines)
- [provideFallbacks](MorphTargetsBlock.md#providefallbacks)
- [registerInput](MorphTargetsBlock.md#registerinput)
- [registerOutput](MorphTargetsBlock.md#registeroutput)
- [replaceRepeatableContent](MorphTargetsBlock.md#replacerepeatablecontent)
- [serialize](MorphTargetsBlock.md#serialize)
- [updateUniformsAndSamples](MorphTargetsBlock.md#updateuniformsandsamples)
- [validateBlockName](MorphTargetsBlock.md#validateblockname)

## Constructors

### constructor

• **new MorphTargetsBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/morphTargetsBlock.ts:28
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/morphTargetsBlock.ts:22
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/morphTargetsBlock.ts:60
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/morphTargetsBlock.ts:88
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/morphTargetsBlock.ts:53
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/morphTargetsBlock.ts:81
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/morphTargetsBlock.ts:67
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/morphTargetsBlock.ts:95
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/morphTargetsBlock.ts:74
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/morphTargetsBlock.ts:102
...
▸ `Protected` **_buildBlock**(`state`): [`MorphTargetsBlock`](MorphTargetsBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/morphTargetsBlock.ts:270
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/morphTargetsBlock.ts:110
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/morphTargetsBlock.ts:165
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`MorphTargetsBlock`](MorphTargetsBlock.md)
...
`undefined` \| [`MorphTargetsBlock`](MorphTargetsBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/morphTargetsBlock.ts:46
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/morphTargetsBlock.ts:106
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/morphTargetsBlock.ts:149
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`MorphTargetsBlock`](MorphTargetsBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`MorphTargetsBlock`](MorphTargetsBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/morphTargetsBlock.ts:175
