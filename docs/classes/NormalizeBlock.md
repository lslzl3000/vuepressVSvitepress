[@dev/core](../README.md) / [Exports](../modules.md) / NormalizeBlock
...
- [constructor](NormalizeBlock.md#constructor)

### Properties

- [\_isUnique](NormalizeBlock.md#_isunique)
- [\_target](NormalizeBlock.md#_target)
- [comments](NormalizeBlock.md#comments)
- [inputsAreExclusive](NormalizeBlock.md#inputsareexclusive)
- [uniqueId](NormalizeBlock.md#uniqueid)
- [visibleInInspector](NormalizeBlock.md#visibleininspector)
- [visibleOnFrame](NormalizeBlock.md#visibleonframe)

### Accessors

- [buildId](NormalizeBlock.md#buildid)
- [input](NormalizeBlock.md#input)
- [inputs](NormalizeBlock.md#inputs)
- [isFinalMerger](NormalizeBlock.md#isfinalmerger)
- [isInput](NormalizeBlock.md#isinput)
- [isUnique](NormalizeBlock.md#isunique)
- [name](NormalizeBlock.md#name)
- [output](NormalizeBlock.md#output)
- [outputs](NormalizeBlock.md#outputs)
- [target](NormalizeBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](NormalizeBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](NormalizeBlock.md#_buildblock)
- [\_declareOutput](NormalizeBlock.md#_declareoutput)
- [\_dumpPropertiesCode](NormalizeBlock.md#_dumppropertiescode)
- [\_inputRename](NormalizeBlock.md#_inputrename)
- [\_linkConnectionTypes](NormalizeBlock.md#_linkconnectiontypes)
- [\_outputRename](NormalizeBlock.md#_outputrename)
- [\_writeFloat](NormalizeBlock.md#_writefloat)
- [\_writeVariable](NormalizeBlock.md#_writevariable)
- [autoConfigure](NormalizeBlock.md#autoconfigure)
- [bind](NormalizeBlock.md#bind)
- [build](NormalizeBlock.md#build)
- [clone](NormalizeBlock.md#clone)
- [connectTo](NormalizeBlock.md#connectto)
- [dispose](NormalizeBlock.md#dispose)
- [getClassName](NormalizeBlock.md#getclassname)
- [getFirstAvailableInput](NormalizeBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](NormalizeBlock.md#getfirstavailableoutput)
- [getInputByName](NormalizeBlock.md#getinputbyname)
- [getOutputByName](NormalizeBlock.md#getoutputbyname)
- [getSiblingOutput](NormalizeBlock.md#getsiblingoutput)
- [initialize](NormalizeBlock.md#initialize)
- [initializeDefines](NormalizeBlock.md#initializedefines)
- [isAnAncestorOf](NormalizeBlock.md#isanancestorof)
- [isReady](NormalizeBlock.md#isready)
- [prepareDefines](NormalizeBlock.md#preparedefines)
- [provideFallbacks](NormalizeBlock.md#providefallbacks)
- [registerInput](NormalizeBlock.md#registerinput)
- [registerOutput](NormalizeBlock.md#registeroutput)
- [replaceRepeatableContent](NormalizeBlock.md#replacerepeatablecontent)
- [serialize](NormalizeBlock.md#serialize)
- [updateUniformsAndSamples](NormalizeBlock.md#updateuniformsandsamples)
- [validateBlockName](NormalizeBlock.md#validateblockname)

## Constructors

### constructor

• **new NormalizeBlock**(`name`)
...
packages/dev/core/src/Materials/Node/Blocks/normalizeBlock.ts:15
...
packages/dev/core/src/Materials/Node/Blocks/normalizeBlock.ts:38
...
packages/dev/core/src/Materials/Node/Blocks/normalizeBlock.ts:45
...
▸ `Protected` **_buildBlock**(`state`): [`NormalizeBlock`](NormalizeBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/normalizeBlock.ts:49
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`NormalizeBlock`](NormalizeBlock.md)
...
`undefined` \| [`NormalizeBlock`](NormalizeBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/normalizeBlock.ts:31
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`NormalizeBlock`](NormalizeBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`NormalizeBlock`](NormalizeBlock.md)
