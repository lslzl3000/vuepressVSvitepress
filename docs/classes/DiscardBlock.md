[@dev/core](../README.md) / [Exports](../modules.md) / DiscardBlock
...
- [constructor](DiscardBlock.md#constructor)

### Properties

- [\_isUnique](DiscardBlock.md#_isunique)
- [\_target](DiscardBlock.md#_target)
- [comments](DiscardBlock.md#comments)
- [inputsAreExclusive](DiscardBlock.md#inputsareexclusive)
- [uniqueId](DiscardBlock.md#uniqueid)
- [visibleInInspector](DiscardBlock.md#visibleininspector)
- [visibleOnFrame](DiscardBlock.md#visibleonframe)

### Accessors

- [buildId](DiscardBlock.md#buildid)
- [cutoff](DiscardBlock.md#cutoff)
- [inputs](DiscardBlock.md#inputs)
- [isFinalMerger](DiscardBlock.md#isfinalmerger)
- [isInput](DiscardBlock.md#isinput)
- [isUnique](DiscardBlock.md#isunique)
- [name](DiscardBlock.md#name)
- [outputs](DiscardBlock.md#outputs)
- [target](DiscardBlock.md#target)
- [value](DiscardBlock.md#value)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](DiscardBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](DiscardBlock.md#_buildblock)
- [\_declareOutput](DiscardBlock.md#_declareoutput)
- [\_dumpPropertiesCode](DiscardBlock.md#_dumppropertiescode)
- [\_inputRename](DiscardBlock.md#_inputrename)
- [\_linkConnectionTypes](DiscardBlock.md#_linkconnectiontypes)
- [\_outputRename](DiscardBlock.md#_outputrename)
- [\_writeFloat](DiscardBlock.md#_writefloat)
- [\_writeVariable](DiscardBlock.md#_writevariable)
- [autoConfigure](DiscardBlock.md#autoconfigure)
- [bind](DiscardBlock.md#bind)
- [build](DiscardBlock.md#build)
- [clone](DiscardBlock.md#clone)
- [connectTo](DiscardBlock.md#connectto)
- [dispose](DiscardBlock.md#dispose)
- [getClassName](DiscardBlock.md#getclassname)
- [getFirstAvailableInput](DiscardBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](DiscardBlock.md#getfirstavailableoutput)
- [getInputByName](DiscardBlock.md#getinputbyname)
- [getOutputByName](DiscardBlock.md#getoutputbyname)
- [getSiblingOutput](DiscardBlock.md#getsiblingoutput)
- [initialize](DiscardBlock.md#initialize)
- [initializeDefines](DiscardBlock.md#initializedefines)
- [isAnAncestorOf](DiscardBlock.md#isanancestorof)
- [isReady](DiscardBlock.md#isready)
- [prepareDefines](DiscardBlock.md#preparedefines)
- [provideFallbacks](DiscardBlock.md#providefallbacks)
- [registerInput](DiscardBlock.md#registerinput)
- [registerOutput](DiscardBlock.md#registeroutput)
- [replaceRepeatableContent](DiscardBlock.md#replacerepeatablecontent)
- [serialize](DiscardBlock.md#serialize)
- [updateUniformsAndSamples](DiscardBlock.md#updateuniformsandsamples)
- [validateBlockName](DiscardBlock.md#validateblockname)

## Constructors

### constructor

• **new DiscardBlock**(`name`)
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/discardBlock.ts:15
...
• `get` **cutoff**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/discardBlock.ts:40
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/discardBlock.ts:33
...
▸ `Protected` **_buildBlock**(`state`): `undefined` \| [`DiscardBlock`](DiscardBlock.md)
...
`undefined` \| [`DiscardBlock`](DiscardBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/discardBlock.ts:44
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`DiscardBlock`](DiscardBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/discardBlock.ts:26
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`DiscardBlock`](DiscardBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`DiscardBlock`](DiscardBlock.md)
