[@dev/core](../README.md) / [Exports](../modules.md) / Rotate2dBlock
...
- [constructor](Rotate2dBlock.md#constructor)

### Properties

- [\_isUnique](Rotate2dBlock.md#_isunique)
- [\_target](Rotate2dBlock.md#_target)
- [comments](Rotate2dBlock.md#comments)
- [inputsAreExclusive](Rotate2dBlock.md#inputsareexclusive)
- [uniqueId](Rotate2dBlock.md#uniqueid)
- [visibleInInspector](Rotate2dBlock.md#visibleininspector)
- [visibleOnFrame](Rotate2dBlock.md#visibleonframe)

### Accessors

- [angle](Rotate2dBlock.md#angle)
- [buildId](Rotate2dBlock.md#buildid)
- [input](Rotate2dBlock.md#input)
- [inputs](Rotate2dBlock.md#inputs)
- [isFinalMerger](Rotate2dBlock.md#isfinalmerger)
- [isInput](Rotate2dBlock.md#isinput)
- [isUnique](Rotate2dBlock.md#isunique)
- [name](Rotate2dBlock.md#name)
- [output](Rotate2dBlock.md#output)
- [outputs](Rotate2dBlock.md#outputs)
- [target](Rotate2dBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](Rotate2dBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](Rotate2dBlock.md#_buildblock)
- [\_declareOutput](Rotate2dBlock.md#_declareoutput)
- [\_dumpPropertiesCode](Rotate2dBlock.md#_dumppropertiescode)
- [\_inputRename](Rotate2dBlock.md#_inputrename)
- [\_linkConnectionTypes](Rotate2dBlock.md#_linkconnectiontypes)
- [\_outputRename](Rotate2dBlock.md#_outputrename)
- [\_writeFloat](Rotate2dBlock.md#_writefloat)
- [\_writeVariable](Rotate2dBlock.md#_writevariable)
- [autoConfigure](Rotate2dBlock.md#autoconfigure)
- [bind](Rotate2dBlock.md#bind)
- [build](Rotate2dBlock.md#build)
- [clone](Rotate2dBlock.md#clone)
- [connectTo](Rotate2dBlock.md#connectto)
- [dispose](Rotate2dBlock.md#dispose)
- [getClassName](Rotate2dBlock.md#getclassname)
- [getFirstAvailableInput](Rotate2dBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](Rotate2dBlock.md#getfirstavailableoutput)
- [getInputByName](Rotate2dBlock.md#getinputbyname)
- [getOutputByName](Rotate2dBlock.md#getoutputbyname)
- [getSiblingOutput](Rotate2dBlock.md#getsiblingoutput)
- [initialize](Rotate2dBlock.md#initialize)
- [initializeDefines](Rotate2dBlock.md#initializedefines)
- [isAnAncestorOf](Rotate2dBlock.md#isanancestorof)
- [isReady](Rotate2dBlock.md#isready)
- [prepareDefines](Rotate2dBlock.md#preparedefines)
- [provideFallbacks](Rotate2dBlock.md#providefallbacks)
- [registerInput](Rotate2dBlock.md#registerinput)
- [registerOutput](Rotate2dBlock.md#registeroutput)
- [replaceRepeatableContent](Rotate2dBlock.md#replacerepeatablecontent)
- [serialize](Rotate2dBlock.md#serialize)
- [updateUniformsAndSamples](Rotate2dBlock.md#updateuniformsandsamples)
- [validateBlockName](Rotate2dBlock.md#validateblockname)

## Constructors

### constructor

• **new Rotate2dBlock**(`name`)
...
packages/dev/core/src/Materials/Node/Blocks/rotate2dBlock.ts:17
...
• `get` **angle**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/rotate2dBlock.ts:43
...
packages/dev/core/src/Materials/Node/Blocks/rotate2dBlock.ts:36
...
packages/dev/core/src/Materials/Node/Blocks/rotate2dBlock.ts:50
...
▸ `Protected` **_buildBlock**(`state`): [`Rotate2dBlock`](Rotate2dBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/rotate2dBlock.ts:62
...
packages/dev/core/src/Materials/Node/Blocks/rotate2dBlock.ts:54
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`Rotate2dBlock`](Rotate2dBlock.md)
...
`undefined` \| [`Rotate2dBlock`](Rotate2dBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/rotate2dBlock.ts:29
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`Rotate2dBlock`](Rotate2dBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`Rotate2dBlock`](Rotate2dBlock.md)
