[@dev/core](../README.md) / [Exports](../modules.md) / VectorSplitterBlock
...
- [constructor](VectorSplitterBlock.md#constructor)

### Properties

- [\_isUnique](VectorSplitterBlock.md#_isunique)
- [\_target](VectorSplitterBlock.md#_target)
- [comments](VectorSplitterBlock.md#comments)
- [inputsAreExclusive](VectorSplitterBlock.md#inputsareexclusive)
- [uniqueId](VectorSplitterBlock.md#uniqueid)
- [visibleInInspector](VectorSplitterBlock.md#visibleininspector)
- [visibleOnFrame](VectorSplitterBlock.md#visibleonframe)

### Accessors

- [buildId](VectorSplitterBlock.md#buildid)
- [inputs](VectorSplitterBlock.md#inputs)
- [isFinalMerger](VectorSplitterBlock.md#isfinalmerger)
- [isInput](VectorSplitterBlock.md#isinput)
- [isUnique](VectorSplitterBlock.md#isunique)
- [name](VectorSplitterBlock.md#name)
- [outputs](VectorSplitterBlock.md#outputs)
- [target](VectorSplitterBlock.md#target)
- [w](VectorSplitterBlock.md#w)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](VectorSplitterBlock.md#willbegeneratedintovertexshaderfromfragmentshader)
- [x](VectorSplitterBlock.md#x)
- [xyIn](VectorSplitterBlock.md#xyin)
- [xyOut](VectorSplitterBlock.md#xyout)
- [xyzIn](VectorSplitterBlock.md#xyzin)
- [xyzOut](VectorSplitterBlock.md#xyzout)
- [xyzw](VectorSplitterBlock.md#xyzw)
- [y](VectorSplitterBlock.md#y)
- [z](VectorSplitterBlock.md#z)
- [zw](VectorSplitterBlock.md#zw)

### Methods

- [\_buildBlock](VectorSplitterBlock.md#_buildblock)
- [\_declareOutput](VectorSplitterBlock.md#_declareoutput)
- [\_dumpPropertiesCode](VectorSplitterBlock.md#_dumppropertiescode)
- [\_inputRename](VectorSplitterBlock.md#_inputrename)
- [\_linkConnectionTypes](VectorSplitterBlock.md#_linkconnectiontypes)
- [\_outputRename](VectorSplitterBlock.md#_outputrename)
- [\_writeFloat](VectorSplitterBlock.md#_writefloat)
- [\_writeVariable](VectorSplitterBlock.md#_writevariable)
- [autoConfigure](VectorSplitterBlock.md#autoconfigure)
- [bind](VectorSplitterBlock.md#bind)
- [build](VectorSplitterBlock.md#build)
- [clone](VectorSplitterBlock.md#clone)
- [connectTo](VectorSplitterBlock.md#connectto)
- [dispose](VectorSplitterBlock.md#dispose)
- [getClassName](VectorSplitterBlock.md#getclassname)
- [getFirstAvailableInput](VectorSplitterBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](VectorSplitterBlock.md#getfirstavailableoutput)
- [getInputByName](VectorSplitterBlock.md#getinputbyname)
- [getOutputByName](VectorSplitterBlock.md#getoutputbyname)
- [getSiblingOutput](VectorSplitterBlock.md#getsiblingoutput)
- [initialize](VectorSplitterBlock.md#initialize)
- [initializeDefines](VectorSplitterBlock.md#initializedefines)
- [isAnAncestorOf](VectorSplitterBlock.md#isanancestorof)
- [isReady](VectorSplitterBlock.md#isready)
- [prepareDefines](VectorSplitterBlock.md#preparedefines)
- [provideFallbacks](VectorSplitterBlock.md#providefallbacks)
- [registerInput](VectorSplitterBlock.md#registerinput)
- [registerOutput](VectorSplitterBlock.md#registeroutput)
- [replaceRepeatableContent](VectorSplitterBlock.md#replacerepeatablecontent)
- [serialize](VectorSplitterBlock.md#serialize)
- [updateUniformsAndSamples](VectorSplitterBlock.md#updateuniformsandsamples)
- [validateBlockName](VectorSplitterBlock.md#validateblockname)

## Constructors

### constructor

• **new VectorSplitterBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/vectorSplitterBlock.ts:16
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/vectorSplitterBlock.ts:108
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/vectorSplitterBlock.ts:87
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/vectorSplitterBlock.ts:59
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/vectorSplitterBlock.ts:73
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/vectorSplitterBlock.ts:52
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/vectorSplitterBlock.ts:66
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/vectorSplitterBlock.ts:45
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/vectorSplitterBlock.ts:94
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/vectorSplitterBlock.ts:101

___

### zw

• `get` **zw**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/vectorSplitterBlock.ts:80

## Methods

### \_buildBlock

▸ `Protected` **_buildBlock**(`state`): [`VectorSplitterBlock`](VectorSplitterBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/vectorSplitterBlock.ts:134
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/vectorSplitterBlock.ts:112
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/vectorSplitterBlock.ts:123
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`VectorSplitterBlock`](VectorSplitterBlock.md)
...
`undefined` \| [`VectorSplitterBlock`](VectorSplitterBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/vectorSplitterBlock.ts:38
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`VectorSplitterBlock`](VectorSplitterBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`VectorSplitterBlock`](VectorSplitterBlock.md)
