[@dev/core](../README.md) / [Exports](../modules.md) / CircleOfConfusionPostProcess
...
- [constructor](CircleOfConfusionPostProcess.md#constructor)

### Properties

- [\_depthTexture](CircleOfConfusionPostProcess.md#_depthtexture)
- [\_indexParameters](CircleOfConfusionPostProcess.md#_indexparameters)
- [\_postProcessDefines](CircleOfConfusionPostProcess.md#_postprocessdefines)
- [\_scene](CircleOfConfusionPostProcess.md#_scene)
- [adaptScaleToCurrentViewport](CircleOfConfusionPostProcess.md#adaptscaletocurrentviewport)
- [alphaConstants](CircleOfConfusionPostProcess.md#alphaconstants)
- [alphaMode](CircleOfConfusionPostProcess.md#alphamode)
- [alwaysForcePOT](CircleOfConfusionPostProcess.md#alwaysforcepot)
- [animations](CircleOfConfusionPostProcess.md#animations)
- [autoClear](CircleOfConfusionPostProcess.md#autoclear)
- [clearColor](CircleOfConfusionPostProcess.md#clearcolor)
- [enablePixelPerfectMode](CircleOfConfusionPostProcess.md#enablepixelperfectmode)
- [externalTextureSamplerBinding](CircleOfConfusionPostProcess.md#externaltexturesamplerbinding)
- [fStop](CircleOfConfusionPostProcess.md#fstop)
- [focalLength](CircleOfConfusionPostProcess.md#focallength)
- [focusDistance](CircleOfConfusionPostProcess.md#focusdistance)
- [forceFullscreenViewport](CircleOfConfusionPostProcess.md#forcefullscreenviewport)
- [height](CircleOfConfusionPostProcess.md#height)
- [inspectableCustomProperties](CircleOfConfusionPostProcess.md#inspectablecustomproperties)
- [lensSize](CircleOfConfusionPostProcess.md#lenssize)
- [name](CircleOfConfusionPostProcess.md#name)
- [nodeMaterialSource](CircleOfConfusionPostProcess.md#nodematerialsource)
- [onActivateObservable](CircleOfConfusionPostProcess.md#onactivateobservable)
- [onAfterRenderObservable](CircleOfConfusionPostProcess.md#onafterrenderobservable)
- [onApplyObservable](CircleOfConfusionPostProcess.md#onapplyobservable)
- [onBeforeRenderObservable](CircleOfConfusionPostProcess.md#onbeforerenderobservable)
- [onSizeChangedObservable](CircleOfConfusionPostProcess.md#onsizechangedobservable)
- [renderTargetSamplingMode](CircleOfConfusionPostProcess.md#rendertargetsamplingmode)
- [scaleMode](CircleOfConfusionPostProcess.md#scalemode)
- [uniqueId](CircleOfConfusionPostProcess.md#uniqueid)
- [width](CircleOfConfusionPostProcess.md#width)

### Accessors

- [aspectRatio](CircleOfConfusionPostProcess.md#aspectratio)
- [depthTexture](CircleOfConfusionPostProcess.md#depthtexture)
- [inputTexture](CircleOfConfusionPostProcess.md#inputtexture)
- [isSupported](CircleOfConfusionPostProcess.md#issupported)
- [onActivate](CircleOfConfusionPostProcess.md#onactivate)
- [onAfterRender](CircleOfConfusionPostProcess.md#onafterrender)
- [onApply](CircleOfConfusionPostProcess.md#onapply)
- [onBeforeRender](CircleOfConfusionPostProcess.md#onbeforerender)
- [onSizeChanged](CircleOfConfusionPostProcess.md#onsizechanged)
- [samples](CircleOfConfusionPostProcess.md#samples)
- [texelSize](CircleOfConfusionPostProcess.md#texelsize)

### Methods

- [activate](CircleOfConfusionPostProcess.md#activate)
- [apply](CircleOfConfusionPostProcess.md#apply)
- [clone](CircleOfConfusionPostProcess.md#clone)
- [dispose](CircleOfConfusionPostProcess.md#dispose)
- [getCamera](CircleOfConfusionPostProcess.md#getcamera)
- [getClassName](CircleOfConfusionPostProcess.md#getclassname)
- [getEffect](CircleOfConfusionPostProcess.md#geteffect)
- [getEffectName](CircleOfConfusionPostProcess.md#geteffectname)
- [getEngine](CircleOfConfusionPostProcess.md#getengine)
- [isReady](CircleOfConfusionPostProcess.md#isready)
- [isReusable](CircleOfConfusionPostProcess.md#isreusable)
- [markTextureDirty](CircleOfConfusionPostProcess.md#marktexturedirty)
- [restoreDefaultInputTexture](CircleOfConfusionPostProcess.md#restoredefaultinputtexture)
- [serialize](CircleOfConfusionPostProcess.md#serialize)
- [setPrePassRenderer](CircleOfConfusionPostProcess.md#setprepassrenderer)
- [shareOutputWith](CircleOfConfusionPostProcess.md#shareoutputwith)
- [updateEffect](CircleOfConfusionPostProcess.md#updateeffect)
- [useOwnOutput](CircleOfConfusionPostProcess.md#useownoutput)
- [Parse](CircleOfConfusionPostProcess.md#parse)

## Constructors

### constructor

• **new CircleOfConfusionPostProcess**(`name`, `depthTexture`, `options`, `camera`, `samplingMode?`, `engine?`, `reusable?`, `textureType?`, `blockCompilation?`)
...
packages/dev/core/src/PostProcesses/circleOfConfusionPostProcess.ts:61

## Properties

### \_depthTexture

• `Private` **\_depthTexture**: [`Nullable`](../modules.md#nullable)[`RenderTargetTexture`](RenderTargetTexture.md) = `null`

#### Defined in

packages/dev/core/src/PostProcesses/circleOfConfusionPostProcess.ts:48
...
packages/dev/core/src/PostProcesses/circleOfConfusionPostProcess.ts:28
...
packages/dev/core/src/PostProcesses/circleOfConfusionPostProcess.ts:38
...
packages/dev/core/src/PostProcesses/circleOfConfusionPostProcess.ts:33
...
packages/dev/core/src/PostProcesses/circleOfConfusionPostProcess.ts:23
...
packages/dev/core/src/PostProcesses/circleOfConfusionPostProcess.ts:109
...
"CircleOfConfusionPostProcess" string
...
packages/dev/core/src/PostProcesses/circleOfConfusionPostProcess.ts:44
