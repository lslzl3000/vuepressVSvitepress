[@dev/core](../README.md) / [Exports](../modules.md) / AnaglyphPostProcess
...
- [constructor](AnaglyphPostProcess.md#constructor)

### Properties

- [\_indexParameters](AnaglyphPostProcess.md#_indexparameters)
- [\_passedProcess](AnaglyphPostProcess.md#_passedprocess)
- [\_postProcessDefines](AnaglyphPostProcess.md#_postprocessdefines)
- [\_scene](AnaglyphPostProcess.md#_scene)
- [adaptScaleToCurrentViewport](AnaglyphPostProcess.md#adaptscaletocurrentviewport)
- [alphaConstants](AnaglyphPostProcess.md#alphaconstants)
- [alphaMode](AnaglyphPostProcess.md#alphamode)
- [alwaysForcePOT](AnaglyphPostProcess.md#alwaysforcepot)
- [animations](AnaglyphPostProcess.md#animations)
- [autoClear](AnaglyphPostProcess.md#autoclear)
- [clearColor](AnaglyphPostProcess.md#clearcolor)
- [enablePixelPerfectMode](AnaglyphPostProcess.md#enablepixelperfectmode)
- [externalTextureSamplerBinding](AnaglyphPostProcess.md#externaltexturesamplerbinding)
- [forceFullscreenViewport](AnaglyphPostProcess.md#forcefullscreenviewport)
- [height](AnaglyphPostProcess.md#height)
- [inspectableCustomProperties](AnaglyphPostProcess.md#inspectablecustomproperties)
- [name](AnaglyphPostProcess.md#name)
- [nodeMaterialSource](AnaglyphPostProcess.md#nodematerialsource)
- [onActivateObservable](AnaglyphPostProcess.md#onactivateobservable)
- [onAfterRenderObservable](AnaglyphPostProcess.md#onafterrenderobservable)
- [onApplyObservable](AnaglyphPostProcess.md#onapplyobservable)
- [onBeforeRenderObservable](AnaglyphPostProcess.md#onbeforerenderobservable)
- [onSizeChangedObservable](AnaglyphPostProcess.md#onsizechangedobservable)
- [renderTargetSamplingMode](AnaglyphPostProcess.md#rendertargetsamplingmode)
- [scaleMode](AnaglyphPostProcess.md#scalemode)
- [uniqueId](AnaglyphPostProcess.md#uniqueid)
- [width](AnaglyphPostProcess.md#width)

### Accessors

- [aspectRatio](AnaglyphPostProcess.md#aspectratio)
- [inputTexture](AnaglyphPostProcess.md#inputtexture)
- [isSupported](AnaglyphPostProcess.md#issupported)
- [onActivate](AnaglyphPostProcess.md#onactivate)
- [onAfterRender](AnaglyphPostProcess.md#onafterrender)
- [onApply](AnaglyphPostProcess.md#onapply)
- [onBeforeRender](AnaglyphPostProcess.md#onbeforerender)
- [onSizeChanged](AnaglyphPostProcess.md#onsizechanged)
- [samples](AnaglyphPostProcess.md#samples)
- [texelSize](AnaglyphPostProcess.md#texelsize)

### Methods

- [activate](AnaglyphPostProcess.md#activate)
- [apply](AnaglyphPostProcess.md#apply)
- [clone](AnaglyphPostProcess.md#clone)
- [dispose](AnaglyphPostProcess.md#dispose)
- [getCamera](AnaglyphPostProcess.md#getcamera)
- [getClassName](AnaglyphPostProcess.md#getclassname)
- [getEffect](AnaglyphPostProcess.md#geteffect)
- [getEffectName](AnaglyphPostProcess.md#geteffectname)
- [getEngine](AnaglyphPostProcess.md#getengine)
- [isReady](AnaglyphPostProcess.md#isready)
- [isReusable](AnaglyphPostProcess.md#isreusable)
- [markTextureDirty](AnaglyphPostProcess.md#marktexturedirty)
- [restoreDefaultInputTexture](AnaglyphPostProcess.md#restoredefaultinputtexture)
- [serialize](AnaglyphPostProcess.md#serialize)
- [setPrePassRenderer](AnaglyphPostProcess.md#setprepassrenderer)
- [shareOutputWith](AnaglyphPostProcess.md#shareoutputwith)
- [updateEffect](AnaglyphPostProcess.md#updateeffect)
- [useOwnOutput](AnaglyphPostProcess.md#useownoutput)
- [Parse](AnaglyphPostProcess.md#parse)

## Constructors

### constructor

• **new AnaglyphPostProcess**(`name`, `options`, `rigCameras`, `samplingMode?`, `engine?`, `reusable?`)
...
| :------ | :------ | :------ |
| `name` | `string` | defines postprocess name |
| `options` | `number` \| [`PostProcessOptions`](../modules.md#postprocessoptions) | defines creation options or target ratio scale |
| `rigCameras` | [`Camera`](Camera.md)[] | defines cameras using this postprocess |
| `samplingMode?` | `number` | defines required sampling mode (BABYLON.Texture.NEAREST_SAMPLINGMODE by default) |
| `engine?` | [`Engine`](Engine.md) | defines hosting engine |
| `reusable?` | `boolean` | defines if the postprocess will be reused multiple times per frame |
...
https://github.com/babylon.js/core/src/PostProcesses/anaglyphPostProcess.ts:34
...
https://github.com/babylon.js/core/src/PostProcesses/anaglyphPostProcess.ts:15
...
https://github.com/babylon.js/core/src/PostProcesses/anaglyphPostProcess.ts:21
