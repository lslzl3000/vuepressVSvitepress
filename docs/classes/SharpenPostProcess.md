[@dev/core](../README.md) / [Exports](../modules.md) / SharpenPostProcess
...
- [constructor](SharpenPostProcess.md#constructor)

### Properties

- [\_indexParameters](SharpenPostProcess.md#_indexparameters)
- [\_postProcessDefines](SharpenPostProcess.md#_postprocessdefines)
- [\_scene](SharpenPostProcess.md#_scene)
- [adaptScaleToCurrentViewport](SharpenPostProcess.md#adaptscaletocurrentviewport)
- [alphaConstants](SharpenPostProcess.md#alphaconstants)
- [alphaMode](SharpenPostProcess.md#alphamode)
- [alwaysForcePOT](SharpenPostProcess.md#alwaysforcepot)
- [animations](SharpenPostProcess.md#animations)
- [autoClear](SharpenPostProcess.md#autoclear)
- [clearColor](SharpenPostProcess.md#clearcolor)
- [colorAmount](SharpenPostProcess.md#coloramount)
- [edgeAmount](SharpenPostProcess.md#edgeamount)
- [enablePixelPerfectMode](SharpenPostProcess.md#enablepixelperfectmode)
- [externalTextureSamplerBinding](SharpenPostProcess.md#externaltexturesamplerbinding)
- [forceFullscreenViewport](SharpenPostProcess.md#forcefullscreenviewport)
- [height](SharpenPostProcess.md#height)
- [inspectableCustomProperties](SharpenPostProcess.md#inspectablecustomproperties)
- [name](SharpenPostProcess.md#name)
- [nodeMaterialSource](SharpenPostProcess.md#nodematerialsource)
- [onActivateObservable](SharpenPostProcess.md#onactivateobservable)
- [onAfterRenderObservable](SharpenPostProcess.md#onafterrenderobservable)
- [onApplyObservable](SharpenPostProcess.md#onapplyobservable)
- [onBeforeRenderObservable](SharpenPostProcess.md#onbeforerenderobservable)
- [onSizeChangedObservable](SharpenPostProcess.md#onsizechangedobservable)
- [renderTargetSamplingMode](SharpenPostProcess.md#rendertargetsamplingmode)
- [scaleMode](SharpenPostProcess.md#scalemode)
- [uniqueId](SharpenPostProcess.md#uniqueid)
- [width](SharpenPostProcess.md#width)

### Accessors

- [aspectRatio](SharpenPostProcess.md#aspectratio)
- [inputTexture](SharpenPostProcess.md#inputtexture)
- [isSupported](SharpenPostProcess.md#issupported)
- [onActivate](SharpenPostProcess.md#onactivate)
- [onAfterRender](SharpenPostProcess.md#onafterrender)
- [onApply](SharpenPostProcess.md#onapply)
- [onBeforeRender](SharpenPostProcess.md#onbeforerender)
- [onSizeChanged](SharpenPostProcess.md#onsizechanged)
- [samples](SharpenPostProcess.md#samples)
- [texelSize](SharpenPostProcess.md#texelsize)

### Methods

- [activate](SharpenPostProcess.md#activate)
- [apply](SharpenPostProcess.md#apply)
- [clone](SharpenPostProcess.md#clone)
- [dispose](SharpenPostProcess.md#dispose)
- [getCamera](SharpenPostProcess.md#getcamera)
- [getClassName](SharpenPostProcess.md#getclassname)
- [getEffect](SharpenPostProcess.md#geteffect)
- [getEffectName](SharpenPostProcess.md#geteffectname)
- [getEngine](SharpenPostProcess.md#getengine)
- [isReady](SharpenPostProcess.md#isready)
- [isReusable](SharpenPostProcess.md#isreusable)
- [markTextureDirty](SharpenPostProcess.md#marktexturedirty)
- [restoreDefaultInputTexture](SharpenPostProcess.md#restoredefaultinputtexture)
- [serialize](SharpenPostProcess.md#serialize)
- [setPrePassRenderer](SharpenPostProcess.md#setprepassrenderer)
- [shareOutputWith](SharpenPostProcess.md#shareoutputwith)
- [updateEffect](SharpenPostProcess.md#updateeffect)
- [useOwnOutput](SharpenPostProcess.md#useownoutput)
- [Parse](SharpenPostProcess.md#parse)

## Constructors

### constructor

• **new SharpenPostProcess**(`name`, `options`, `camera`, `samplingMode?`, `engine?`, `reusable?`, `textureType?`, `blockCompilation?`)
...
packages/dev/core/src/PostProcesses/sharpenPostProcess.ts:50
...
packages/dev/core/src/PostProcesses/sharpenPostProcess.ts:24
...
packages/dev/core/src/PostProcesses/sharpenPostProcess.ts:29
...
packages/dev/core/src/PostProcesses/sharpenPostProcess.ts:35
