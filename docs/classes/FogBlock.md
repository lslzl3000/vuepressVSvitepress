[@dev/core](../README.md) / [Exports](../modules.md) / FogBlock
...
- [constructor](FogBlock.md#constructor)

### Properties

- [\_fogDistanceName](FogBlock.md#_fogdistancename)
- [\_fogParameters](FogBlock.md#_fogparameters)
- [\_isUnique](FogBlock.md#_isunique)
- [\_target](FogBlock.md#_target)
- [comments](FogBlock.md#comments)
- [inputsAreExclusive](FogBlock.md#inputsareexclusive)
- [uniqueId](FogBlock.md#uniqueid)
- [visibleInInspector](FogBlock.md#visibleininspector)
- [visibleOnFrame](FogBlock.md#visibleonframe)

### Accessors

- [buildId](FogBlock.md#buildid)
- [fogColor](FogBlock.md#fogcolor)
- [input](FogBlock.md#input)
- [inputs](FogBlock.md#inputs)
- [isFinalMerger](FogBlock.md#isfinalmerger)
- [isInput](FogBlock.md#isinput)
- [isUnique](FogBlock.md#isunique)
- [name](FogBlock.md#name)
- [output](FogBlock.md#output)
- [outputs](FogBlock.md#outputs)
- [target](FogBlock.md#target)
- [view](FogBlock.md#view)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](FogBlock.md#willbegeneratedintovertexshaderfromfragmentshader)
- [worldPosition](FogBlock.md#worldposition)

### Methods

- [\_buildBlock](FogBlock.md#_buildblock)
- [\_declareOutput](FogBlock.md#_declareoutput)
- [\_dumpPropertiesCode](FogBlock.md#_dumppropertiescode)
- [\_inputRename](FogBlock.md#_inputrename)
- [\_linkConnectionTypes](FogBlock.md#_linkconnectiontypes)
- [\_outputRename](FogBlock.md#_outputrename)
- [\_writeFloat](FogBlock.md#_writefloat)
- [\_writeVariable](FogBlock.md#_writevariable)
- [autoConfigure](FogBlock.md#autoconfigure)
- [bind](FogBlock.md#bind)
- [build](FogBlock.md#build)
- [clone](FogBlock.md#clone)
- [connectTo](FogBlock.md#connectto)
- [dispose](FogBlock.md#dispose)
- [getClassName](FogBlock.md#getclassname)
- [getFirstAvailableInput](FogBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](FogBlock.md#getfirstavailableoutput)
- [getInputByName](FogBlock.md#getinputbyname)
- [getOutputByName](FogBlock.md#getoutputbyname)
- [getSiblingOutput](FogBlock.md#getsiblingoutput)
- [initialize](FogBlock.md#initialize)
- [initializeDefines](FogBlock.md#initializedefines)
- [isAnAncestorOf](FogBlock.md#isanancestorof)
- [isReady](FogBlock.md#isready)
- [prepareDefines](FogBlock.md#preparedefines)
- [provideFallbacks](FogBlock.md#providefallbacks)
- [registerInput](FogBlock.md#registerinput)
- [registerOutput](FogBlock.md#registeroutput)
- [replaceRepeatableContent](FogBlock.md#replacerepeatablecontent)
- [serialize](FogBlock.md#serialize)
- [updateUniformsAndSamples](FogBlock.md#updateuniformsandsamples)
- [validateBlockName](FogBlock.md#validateblockname)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/fogBlock.ts:28
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/fogBlock.ts:21
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/fogBlock.ts:22
...
• `get` **fogColor**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/fogBlock.ts:77
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/fogBlock.ts:70
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/fogBlock.ts:84
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/fogBlock.ts:63
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/fogBlock.ts:56

## Methods

### \_buildBlock

▸ `Protected` **_buildBlock**(`state`): [`FogBlock`](FogBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/fogBlock.ts:123
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/fogBlock.ts:88
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/fogBlock.ts:114
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`FogBlock`](FogBlock.md)
...
`undefined` \| [`FogBlock`](FogBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/fogBlock.ts:49
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/fogBlock.ts:109
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`FogBlock`](FogBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`FogBlock`](FogBlock.md)
