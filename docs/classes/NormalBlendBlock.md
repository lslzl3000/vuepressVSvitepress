[@dev/core](../README.md) / [Exports](../modules.md) / NormalBlendBlock
...
- [constructor](NormalBlendBlock.md#constructor)

### Properties

- [\_isUnique](NormalBlendBlock.md#_isunique)
- [\_target](NormalBlendBlock.md#_target)
- [comments](NormalBlendBlock.md#comments)
- [inputsAreExclusive](NormalBlendBlock.md#inputsareexclusive)
- [uniqueId](NormalBlendBlock.md#uniqueid)
- [visibleInInspector](NormalBlendBlock.md#visibleininspector)
- [visibleOnFrame](NormalBlendBlock.md#visibleonframe)

### Accessors

- [buildId](NormalBlendBlock.md#buildid)
- [inputs](NormalBlendBlock.md#inputs)
- [isFinalMerger](NormalBlendBlock.md#isfinalmerger)
- [isInput](NormalBlendBlock.md#isinput)
- [isUnique](NormalBlendBlock.md#isunique)
- [name](NormalBlendBlock.md#name)
- [normalMap0](NormalBlendBlock.md#normalmap0)
- [normalMap1](NormalBlendBlock.md#normalmap1)
- [output](NormalBlendBlock.md#output)
- [outputs](NormalBlendBlock.md#outputs)
- [target](NormalBlendBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](NormalBlendBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](NormalBlendBlock.md#_buildblock)
- [\_declareOutput](NormalBlendBlock.md#_declareoutput)
- [\_dumpPropertiesCode](NormalBlendBlock.md#_dumppropertiescode)
- [\_inputRename](NormalBlendBlock.md#_inputrename)
- [\_linkConnectionTypes](NormalBlendBlock.md#_linkconnectiontypes)
- [\_outputRename](NormalBlendBlock.md#_outputrename)
- [\_writeFloat](NormalBlendBlock.md#_writefloat)
- [\_writeVariable](NormalBlendBlock.md#_writevariable)
- [autoConfigure](NormalBlendBlock.md#autoconfigure)
- [bind](NormalBlendBlock.md#bind)
- [build](NormalBlendBlock.md#build)
- [clone](NormalBlendBlock.md#clone)
- [connectTo](NormalBlendBlock.md#connectto)
- [dispose](NormalBlendBlock.md#dispose)
- [getClassName](NormalBlendBlock.md#getclassname)
- [getFirstAvailableInput](NormalBlendBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](NormalBlendBlock.md#getfirstavailableoutput)
- [getInputByName](NormalBlendBlock.md#getinputbyname)
- [getOutputByName](NormalBlendBlock.md#getoutputbyname)
- [getSiblingOutput](NormalBlendBlock.md#getsiblingoutput)
- [initialize](NormalBlendBlock.md#initialize)
- [initializeDefines](NormalBlendBlock.md#initializedefines)
- [isAnAncestorOf](NormalBlendBlock.md#isanancestorof)
- [isReady](NormalBlendBlock.md#isready)
- [prepareDefines](NormalBlendBlock.md#preparedefines)
- [provideFallbacks](NormalBlendBlock.md#providefallbacks)
- [registerInput](NormalBlendBlock.md#registerinput)
- [registerOutput](NormalBlendBlock.md#registeroutput)
- [replaceRepeatableContent](NormalBlendBlock.md#replacerepeatablecontent)
- [serialize](NormalBlendBlock.md#serialize)
- [updateUniformsAndSamples](NormalBlendBlock.md#updateuniformsandsamples)
- [validateBlockName](NormalBlendBlock.md#validateblockname)

## Constructors

### constructor

• **new NormalBlendBlock**(`name`)
...
packages/dev/core/src/Materials/Node/Blocks/normalBlendBlock.ts:15
...
• `get` **normalMap0**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/normalBlendBlock.ts:42

___

### normalMap1

• `get` **normalMap1**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/normalBlendBlock.ts:49
...
packages/dev/core/src/Materials/Node/Blocks/normalBlendBlock.ts:56
...
▸ `Protected` **_buildBlock**(`state`): [`NormalBlendBlock`](NormalBlendBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/normalBlendBlock.ts:60
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`NormalBlendBlock`](NormalBlendBlock.md)
...
`undefined` \| [`NormalBlendBlock`](NormalBlendBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/normalBlendBlock.ts:35
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`NormalBlendBlock`](NormalBlendBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`NormalBlendBlock`](NormalBlendBlock.md)
