[@dev/core](../README.md) / [Exports](../modules.md) / StepBlock
...
- [constructor](StepBlock.md#constructor)

### Properties

- [\_isUnique](StepBlock.md#_isunique)
- [\_target](StepBlock.md#_target)
- [comments](StepBlock.md#comments)
- [inputsAreExclusive](StepBlock.md#inputsareexclusive)
- [uniqueId](StepBlock.md#uniqueid)
- [visibleInInspector](StepBlock.md#visibleininspector)
- [visibleOnFrame](StepBlock.md#visibleonframe)

### Accessors

- [buildId](StepBlock.md#buildid)
- [edge](StepBlock.md#edge)
- [inputs](StepBlock.md#inputs)
- [isFinalMerger](StepBlock.md#isfinalmerger)
- [isInput](StepBlock.md#isinput)
- [isUnique](StepBlock.md#isunique)
- [name](StepBlock.md#name)
- [output](StepBlock.md#output)
- [outputs](StepBlock.md#outputs)
- [target](StepBlock.md#target)
- [value](StepBlock.md#value)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](StepBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](StepBlock.md#_buildblock)
- [\_declareOutput](StepBlock.md#_declareoutput)
- [\_dumpPropertiesCode](StepBlock.md#_dumppropertiescode)
- [\_inputRename](StepBlock.md#_inputrename)
- [\_linkConnectionTypes](StepBlock.md#_linkconnectiontypes)
- [\_outputRename](StepBlock.md#_outputrename)
- [\_writeFloat](StepBlock.md#_writefloat)
- [\_writeVariable](StepBlock.md#_writevariable)
- [autoConfigure](StepBlock.md#autoconfigure)
- [bind](StepBlock.md#bind)
- [build](StepBlock.md#build)
- [clone](StepBlock.md#clone)
- [connectTo](StepBlock.md#connectto)
- [dispose](StepBlock.md#dispose)
- [getClassName](StepBlock.md#getclassname)
- [getFirstAvailableInput](StepBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](StepBlock.md#getfirstavailableoutput)
- [getInputByName](StepBlock.md#getinputbyname)
- [getOutputByName](StepBlock.md#getoutputbyname)
- [getSiblingOutput](StepBlock.md#getsiblingoutput)
- [initialize](StepBlock.md#initialize)
- [initializeDefines](StepBlock.md#initializedefines)
- [isAnAncestorOf](StepBlock.md#isanancestorof)
- [isReady](StepBlock.md#isready)
- [prepareDefines](StepBlock.md#preparedefines)
- [provideFallbacks](StepBlock.md#providefallbacks)
- [registerInput](StepBlock.md#registerinput)
- [registerOutput](StepBlock.md#registeroutput)
- [replaceRepeatableContent](StepBlock.md#replacerepeatablecontent)
- [serialize](StepBlock.md#serialize)
- [updateUniformsAndSamples](StepBlock.md#updateuniformsandsamples)
- [validateBlockName](StepBlock.md#validateblockname)
...
packages/dev/core/src/Materials/Node/Blocks/stepBlock.ts:15
...
packages/dev/core/src/Materials/Node/Blocks/stepBlock.ts:41
...
packages/dev/core/src/Materials/Node/Blocks/stepBlock.ts:48
...
packages/dev/core/src/Materials/Node/Blocks/stepBlock.ts:34
...
▸ `Protected` **_buildBlock**(`state`): [`StepBlock`](StepBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/stepBlock.ts:52
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`StepBlock`](StepBlock.md)
...
`undefined` \| [`StepBlock`](StepBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/stepBlock.ts:27
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`StepBlock`](StepBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`StepBlock`](StepBlock.md)
