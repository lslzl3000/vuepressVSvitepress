[@dev/core](../README.md) / [Exports](../modules.md) / AddBlock
...
- [constructor](AddBlock.md#constructor)

### Properties

- [\_isUnique](AddBlock.md#_isunique)
- [\_target](AddBlock.md#_target)
- [comments](AddBlock.md#comments)
- [inputsAreExclusive](AddBlock.md#inputsareexclusive)
- [uniqueId](AddBlock.md#uniqueid)
- [visibleInInspector](AddBlock.md#visibleininspector)
- [visibleOnFrame](AddBlock.md#visibleonframe)

### Accessors

- [buildId](AddBlock.md#buildid)
- [inputs](AddBlock.md#inputs)
- [isFinalMerger](AddBlock.md#isfinalmerger)
- [isInput](AddBlock.md#isinput)
- [isUnique](AddBlock.md#isunique)
- [left](AddBlock.md#left)
- [name](AddBlock.md#name)
- [output](AddBlock.md#output)
- [outputs](AddBlock.md#outputs)
- [right](AddBlock.md#right)
- [target](AddBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](AddBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](AddBlock.md#_buildblock)
- [\_declareOutput](AddBlock.md#_declareoutput)
- [\_dumpPropertiesCode](AddBlock.md#_dumppropertiescode)
- [\_inputRename](AddBlock.md#_inputrename)
- [\_linkConnectionTypes](AddBlock.md#_linkconnectiontypes)
- [\_outputRename](AddBlock.md#_outputrename)
- [\_writeFloat](AddBlock.md#_writefloat)
- [\_writeVariable](AddBlock.md#_writevariable)
- [autoConfigure](AddBlock.md#autoconfigure)
- [bind](AddBlock.md#bind)
- [build](AddBlock.md#build)
- [clone](AddBlock.md#clone)
- [connectTo](AddBlock.md#connectto)
- [dispose](AddBlock.md#dispose)
- [getClassName](AddBlock.md#getclassname)
- [getFirstAvailableInput](AddBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](AddBlock.md#getfirstavailableoutput)
- [getInputByName](AddBlock.md#getinputbyname)
- [getOutputByName](AddBlock.md#getoutputbyname)
- [getSiblingOutput](AddBlock.md#getsiblingoutput)
- [initialize](AddBlock.md#initialize)
- [initializeDefines](AddBlock.md#initializedefines)
- [isAnAncestorOf](AddBlock.md#isanancestorof)
- [isReady](AddBlock.md#isready)
- [prepareDefines](AddBlock.md#preparedefines)
- [provideFallbacks](AddBlock.md#providefallbacks)
- [registerInput](AddBlock.md#registerinput)
- [registerOutput](AddBlock.md#registeroutput)
- [replaceRepeatableContent](AddBlock.md#replacerepeatablecontent)
- [serialize](AddBlock.md#serialize)
- [updateUniformsAndSamples](AddBlock.md#updateuniformsandsamples)
- [validateBlockName](AddBlock.md#validateblockname)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/addBlock.ts:15
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/addBlock.ts:37
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/addBlock.ts:51
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/addBlock.ts:44
...
▸ `Protected` **_buildBlock**(`state`): [`AddBlock`](AddBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/addBlock.ts:55
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`AddBlock`](AddBlock.md)
...
`undefined` \| [`AddBlock`](AddBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/addBlock.ts:30
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`AddBlock`](AddBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`AddBlock`](AddBlock.md)
