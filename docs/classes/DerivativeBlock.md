[@dev/core](../README.md) / [Exports](../modules.md) / DerivativeBlock
...
- [constructor](DerivativeBlock.md#constructor)

### Properties

- [\_isUnique](DerivativeBlock.md#_isunique)
- [\_target](DerivativeBlock.md#_target)
- [comments](DerivativeBlock.md#comments)
- [inputsAreExclusive](DerivativeBlock.md#inputsareexclusive)
- [uniqueId](DerivativeBlock.md#uniqueid)
- [visibleInInspector](DerivativeBlock.md#visibleininspector)
- [visibleOnFrame](DerivativeBlock.md#visibleonframe)

### Accessors

- [buildId](DerivativeBlock.md#buildid)
- [dx](DerivativeBlock.md#dx)
- [dy](DerivativeBlock.md#dy)
- [input](DerivativeBlock.md#input)
- [inputs](DerivativeBlock.md#inputs)
- [isFinalMerger](DerivativeBlock.md#isfinalmerger)
- [isInput](DerivativeBlock.md#isinput)
- [isUnique](DerivativeBlock.md#isunique)
- [name](DerivativeBlock.md#name)
- [outputs](DerivativeBlock.md#outputs)
- [target](DerivativeBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](DerivativeBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](DerivativeBlock.md#_buildblock)
- [\_declareOutput](DerivativeBlock.md#_declareoutput)
- [\_dumpPropertiesCode](DerivativeBlock.md#_dumppropertiescode)
- [\_inputRename](DerivativeBlock.md#_inputrename)
- [\_linkConnectionTypes](DerivativeBlock.md#_linkconnectiontypes)
- [\_outputRename](DerivativeBlock.md#_outputrename)
- [\_writeFloat](DerivativeBlock.md#_writefloat)
- [\_writeVariable](DerivativeBlock.md#_writevariable)
- [autoConfigure](DerivativeBlock.md#autoconfigure)
- [bind](DerivativeBlock.md#bind)
- [build](DerivativeBlock.md#build)
- [clone](DerivativeBlock.md#clone)
- [connectTo](DerivativeBlock.md#connectto)
- [dispose](DerivativeBlock.md#dispose)
- [getClassName](DerivativeBlock.md#getclassname)
- [getFirstAvailableInput](DerivativeBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](DerivativeBlock.md#getfirstavailableoutput)
- [getInputByName](DerivativeBlock.md#getinputbyname)
- [getOutputByName](DerivativeBlock.md#getoutputbyname)
- [getSiblingOutput](DerivativeBlock.md#getsiblingoutput)
- [initialize](DerivativeBlock.md#initialize)
- [initializeDefines](DerivativeBlock.md#initializedefines)
- [isAnAncestorOf](DerivativeBlock.md#isanancestorof)
- [isReady](DerivativeBlock.md#isready)
- [prepareDefines](DerivativeBlock.md#preparedefines)
- [provideFallbacks](DerivativeBlock.md#providefallbacks)
- [registerInput](DerivativeBlock.md#registerinput)
- [registerOutput](DerivativeBlock.md#registeroutput)
- [replaceRepeatableContent](DerivativeBlock.md#replacerepeatablecontent)
- [serialize](DerivativeBlock.md#serialize)
- [updateUniformsAndSamples](DerivativeBlock.md#updateuniformsandsamples)
- [validateBlockName](DerivativeBlock.md#validateblockname)

## Constructors

### constructor

• **new DerivativeBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/derivativeBlock.ts:16
...
• `get` **dx**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/derivativeBlock.ts:45

___

### dy

• `get` **dy**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/derivativeBlock.ts:52
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/derivativeBlock.ts:38
...
▸ `Protected` **_buildBlock**(`state`): [`DerivativeBlock`](DerivativeBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/derivativeBlock.ts:56
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`DerivativeBlock`](DerivativeBlock.md)
...
`undefined` \| [`DerivativeBlock`](DerivativeBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/derivativeBlock.ts:31
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`DerivativeBlock`](DerivativeBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`DerivativeBlock`](DerivativeBlock.md)
