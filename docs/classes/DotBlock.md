[@dev/core](../README.md) / [Exports](../modules.md) / DotBlock
...
- [constructor](DotBlock.md#constructor)

### Properties

- [\_isUnique](DotBlock.md#_isunique)
- [\_target](DotBlock.md#_target)
- [comments](DotBlock.md#comments)
- [inputsAreExclusive](DotBlock.md#inputsareexclusive)
- [uniqueId](DotBlock.md#uniqueid)
- [visibleInInspector](DotBlock.md#visibleininspector)
- [visibleOnFrame](DotBlock.md#visibleonframe)

### Accessors

- [buildId](DotBlock.md#buildid)
- [inputs](DotBlock.md#inputs)
- [isFinalMerger](DotBlock.md#isfinalmerger)
- [isInput](DotBlock.md#isinput)
- [isUnique](DotBlock.md#isunique)
- [left](DotBlock.md#left)
- [name](DotBlock.md#name)
- [output](DotBlock.md#output)
- [outputs](DotBlock.md#outputs)
- [right](DotBlock.md#right)
- [target](DotBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](DotBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](DotBlock.md#_buildblock)
- [\_declareOutput](DotBlock.md#_declareoutput)
- [\_dumpPropertiesCode](DotBlock.md#_dumppropertiescode)
- [\_inputRename](DotBlock.md#_inputrename)
- [\_linkConnectionTypes](DotBlock.md#_linkconnectiontypes)
- [\_outputRename](DotBlock.md#_outputrename)
- [\_writeFloat](DotBlock.md#_writefloat)
- [\_writeVariable](DotBlock.md#_writevariable)
- [autoConfigure](DotBlock.md#autoconfigure)
- [bind](DotBlock.md#bind)
- [build](DotBlock.md#build)
- [clone](DotBlock.md#clone)
- [connectTo](DotBlock.md#connectto)
- [dispose](DotBlock.md#dispose)
- [getClassName](DotBlock.md#getclassname)
- [getFirstAvailableInput](DotBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](DotBlock.md#getfirstavailableoutput)
- [getInputByName](DotBlock.md#getinputbyname)
- [getOutputByName](DotBlock.md#getoutputbyname)
- [getSiblingOutput](DotBlock.md#getsiblingoutput)
- [initialize](DotBlock.md#initialize)
- [initializeDefines](DotBlock.md#initializedefines)
- [isAnAncestorOf](DotBlock.md#isanancestorof)
- [isReady](DotBlock.md#isready)
- [prepareDefines](DotBlock.md#preparedefines)
- [provideFallbacks](DotBlock.md#providefallbacks)
- [registerInput](DotBlock.md#registerinput)
- [registerOutput](DotBlock.md#registeroutput)
- [replaceRepeatableContent](DotBlock.md#replacerepeatablecontent)
- [serialize](DotBlock.md#serialize)
- [updateUniformsAndSamples](DotBlock.md#updateuniformsandsamples)
- [validateBlockName](DotBlock.md#validateblockname)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/dotBlock.ts:15
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/dotBlock.ts:40
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/dotBlock.ts:54
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/dotBlock.ts:47
...
▸ `Protected` **_buildBlock**(`state`): [`DotBlock`](DotBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/dotBlock.ts:58
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`DotBlock`](DotBlock.md)
...
`undefined` \| [`DotBlock`](DotBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/dotBlock.ts:33
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`DotBlock`](DotBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`DotBlock`](DotBlock.md)
