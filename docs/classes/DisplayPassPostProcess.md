[@dev/core](../README.md) / [Exports](../modules.md) / DisplayPassPostProcess
...
- [constructor](DisplayPassPostProcess.md#constructor)

### Properties

- [\_indexParameters](DisplayPassPostProcess.md#_indexparameters)
- [\_postProcessDefines](DisplayPassPostProcess.md#_postprocessdefines)
- [\_scene](DisplayPassPostProcess.md#_scene)
- [adaptScaleToCurrentViewport](DisplayPassPostProcess.md#adaptscaletocurrentviewport)
- [alphaConstants](DisplayPassPostProcess.md#alphaconstants)
- [alphaMode](DisplayPassPostProcess.md#alphamode)
- [alwaysForcePOT](DisplayPassPostProcess.md#alwaysforcepot)
- [animations](DisplayPassPostProcess.md#animations)
- [autoClear](DisplayPassPostProcess.md#autoclear)
- [clearColor](DisplayPassPostProcess.md#clearcolor)
- [enablePixelPerfectMode](DisplayPassPostProcess.md#enablepixelperfectmode)
- [externalTextureSamplerBinding](DisplayPassPostProcess.md#externaltexturesamplerbinding)
- [forceFullscreenViewport](DisplayPassPostProcess.md#forcefullscreenviewport)
- [height](DisplayPassPostProcess.md#height)
- [inspectableCustomProperties](DisplayPassPostProcess.md#inspectablecustomproperties)
- [name](DisplayPassPostProcess.md#name)
- [nodeMaterialSource](DisplayPassPostProcess.md#nodematerialsource)
- [onActivateObservable](DisplayPassPostProcess.md#onactivateobservable)
- [onAfterRenderObservable](DisplayPassPostProcess.md#onafterrenderobservable)
- [onApplyObservable](DisplayPassPostProcess.md#onapplyobservable)
- [onBeforeRenderObservable](DisplayPassPostProcess.md#onbeforerenderobservable)
- [onSizeChangedObservable](DisplayPassPostProcess.md#onsizechangedobservable)
- [renderTargetSamplingMode](DisplayPassPostProcess.md#rendertargetsamplingmode)
- [scaleMode](DisplayPassPostProcess.md#scalemode)
- [uniqueId](DisplayPassPostProcess.md#uniqueid)
- [width](DisplayPassPostProcess.md#width)

### Accessors

- [aspectRatio](DisplayPassPostProcess.md#aspectratio)
- [inputTexture](DisplayPassPostProcess.md#inputtexture)
- [isSupported](DisplayPassPostProcess.md#issupported)
- [onActivate](DisplayPassPostProcess.md#onactivate)
- [onAfterRender](DisplayPassPostProcess.md#onafterrender)
- [onApply](DisplayPassPostProcess.md#onapply)
- [onBeforeRender](DisplayPassPostProcess.md#onbeforerender)
- [onSizeChanged](DisplayPassPostProcess.md#onsizechanged)
- [samples](DisplayPassPostProcess.md#samples)
- [texelSize](DisplayPassPostProcess.md#texelsize)

### Methods

- [activate](DisplayPassPostProcess.md#activate)
- [apply](DisplayPassPostProcess.md#apply)
- [clone](DisplayPassPostProcess.md#clone)
- [dispose](DisplayPassPostProcess.md#dispose)
- [getCamera](DisplayPassPostProcess.md#getcamera)
- [getClassName](DisplayPassPostProcess.md#getclassname)
- [getEffect](DisplayPassPostProcess.md#geteffect)
- [getEffectName](DisplayPassPostProcess.md#geteffectname)
- [getEngine](DisplayPassPostProcess.md#getengine)
- [isReady](DisplayPassPostProcess.md#isready)
- [isReusable](DisplayPassPostProcess.md#isreusable)
- [markTextureDirty](DisplayPassPostProcess.md#marktexturedirty)
- [restoreDefaultInputTexture](DisplayPassPostProcess.md#restoredefaultinputtexture)
- [serialize](DisplayPassPostProcess.md#serialize)
- [setPrePassRenderer](DisplayPassPostProcess.md#setprepassrenderer)
- [shareOutputWith](DisplayPassPostProcess.md#shareoutputwith)
- [updateEffect](DisplayPassPostProcess.md#updateeffect)
- [useOwnOutput](DisplayPassPostProcess.md#useownoutput)
- [Parse](DisplayPassPostProcess.md#parse)

## Constructors

### constructor

• **new DisplayPassPostProcess**(`name`, `options`, `camera`, `samplingMode?`, `engine?`, `reusable?`)
...
| `camera` | [`Nullable`](../modules.md#nullable)[`Camera`](Camera.md) | The camera to apply the render pass to. |
...
https://github.com/babylon.js/core/src/PostProcesses/displayPassPostProcess.ts:34
...
https://github.com/babylon.js/core/src/PostProcesses/displayPassPostProcess.ts:21
