[@dev/core](../README.md) / [Exports](../modules.md) / ReciprocalBlock
...
- [constructor](ReciprocalBlock.md#constructor)

### Properties

- [\_isUnique](ReciprocalBlock.md#_isunique)
- [\_target](ReciprocalBlock.md#_target)
- [comments](ReciprocalBlock.md#comments)
- [inputsAreExclusive](ReciprocalBlock.md#inputsareexclusive)
- [uniqueId](ReciprocalBlock.md#uniqueid)
- [visibleInInspector](ReciprocalBlock.md#visibleininspector)
- [visibleOnFrame](ReciprocalBlock.md#visibleonframe)

### Accessors

- [buildId](ReciprocalBlock.md#buildid)
- [input](ReciprocalBlock.md#input)
- [inputs](ReciprocalBlock.md#inputs)
- [isFinalMerger](ReciprocalBlock.md#isfinalmerger)
- [isInput](ReciprocalBlock.md#isinput)
- [isUnique](ReciprocalBlock.md#isunique)
- [name](ReciprocalBlock.md#name)
- [output](ReciprocalBlock.md#output)
- [outputs](ReciprocalBlock.md#outputs)
- [target](ReciprocalBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](ReciprocalBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](ReciprocalBlock.md#_buildblock)
- [\_declareOutput](ReciprocalBlock.md#_declareoutput)
- [\_dumpPropertiesCode](ReciprocalBlock.md#_dumppropertiescode)
- [\_inputRename](ReciprocalBlock.md#_inputrename)
- [\_linkConnectionTypes](ReciprocalBlock.md#_linkconnectiontypes)
- [\_outputRename](ReciprocalBlock.md#_outputrename)
- [\_writeFloat](ReciprocalBlock.md#_writefloat)
- [\_writeVariable](ReciprocalBlock.md#_writevariable)
- [autoConfigure](ReciprocalBlock.md#autoconfigure)
- [bind](ReciprocalBlock.md#bind)
- [build](ReciprocalBlock.md#build)
- [clone](ReciprocalBlock.md#clone)
- [connectTo](ReciprocalBlock.md#connectto)
- [dispose](ReciprocalBlock.md#dispose)
- [getClassName](ReciprocalBlock.md#getclassname)
- [getFirstAvailableInput](ReciprocalBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](ReciprocalBlock.md#getfirstavailableoutput)
- [getInputByName](ReciprocalBlock.md#getinputbyname)
- [getOutputByName](ReciprocalBlock.md#getoutputbyname)
- [getSiblingOutput](ReciprocalBlock.md#getsiblingoutput)
- [initialize](ReciprocalBlock.md#initialize)
- [initializeDefines](ReciprocalBlock.md#initializedefines)
- [isAnAncestorOf](ReciprocalBlock.md#isanancestorof)
- [isReady](ReciprocalBlock.md#isready)
- [prepareDefines](ReciprocalBlock.md#preparedefines)
- [provideFallbacks](ReciprocalBlock.md#providefallbacks)
- [registerInput](ReciprocalBlock.md#registerinput)
- [registerOutput](ReciprocalBlock.md#registeroutput)
- [replaceRepeatableContent](ReciprocalBlock.md#replacerepeatablecontent)
- [serialize](ReciprocalBlock.md#serialize)
- [updateUniformsAndSamples](ReciprocalBlock.md#updateuniformsandsamples)
- [validateBlockName](ReciprocalBlock.md#validateblockname)

## Constructors

### constructor

• **new ReciprocalBlock**(`name`)
...
packages/dev/core/src/Materials/Node/Blocks/reciprocalBlock.ts:15
...
packages/dev/core/src/Materials/Node/Blocks/reciprocalBlock.ts:36
...
packages/dev/core/src/Materials/Node/Blocks/reciprocalBlock.ts:43
...
▸ `Protected` **_buildBlock**(`state`): [`ReciprocalBlock`](ReciprocalBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/reciprocalBlock.ts:47
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`ReciprocalBlock`](ReciprocalBlock.md)
...
`undefined` \| [`ReciprocalBlock`](ReciprocalBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/reciprocalBlock.ts:29
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`ReciprocalBlock`](ReciprocalBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`ReciprocalBlock`](ReciprocalBlock.md)
