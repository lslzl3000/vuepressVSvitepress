[@dev/core](../README.md) / [Exports](../modules.md) / VertexOutputBlock
...
- [constructor](VertexOutputBlock.md#constructor)

### Properties

- [\_isUnique](VertexOutputBlock.md#_isunique)
- [\_target](VertexOutputBlock.md#_target)
- [comments](VertexOutputBlock.md#comments)
- [inputsAreExclusive](VertexOutputBlock.md#inputsareexclusive)
- [uniqueId](VertexOutputBlock.md#uniqueid)
- [visibleInInspector](VertexOutputBlock.md#visibleininspector)
- [visibleOnFrame](VertexOutputBlock.md#visibleonframe)

### Accessors

- [buildId](VertexOutputBlock.md#buildid)
- [inputs](VertexOutputBlock.md#inputs)
- [isFinalMerger](VertexOutputBlock.md#isfinalmerger)
- [isInput](VertexOutputBlock.md#isinput)
- [isUnique](VertexOutputBlock.md#isunique)
- [name](VertexOutputBlock.md#name)
- [outputs](VertexOutputBlock.md#outputs)
- [target](VertexOutputBlock.md#target)
- [vector](VertexOutputBlock.md#vector)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](VertexOutputBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](VertexOutputBlock.md#_buildblock)
- [\_declareOutput](VertexOutputBlock.md#_declareoutput)
- [\_dumpPropertiesCode](VertexOutputBlock.md#_dumppropertiescode)
- [\_inputRename](VertexOutputBlock.md#_inputrename)
- [\_isLogarithmicDepthEnabled](VertexOutputBlock.md#_islogarithmicdepthenabled)
- [\_linkConnectionTypes](VertexOutputBlock.md#_linkconnectiontypes)
- [\_outputRename](VertexOutputBlock.md#_outputrename)
- [\_writeFloat](VertexOutputBlock.md#_writefloat)
- [\_writeVariable](VertexOutputBlock.md#_writevariable)
- [autoConfigure](VertexOutputBlock.md#autoconfigure)
- [bind](VertexOutputBlock.md#bind)
- [build](VertexOutputBlock.md#build)
- [clone](VertexOutputBlock.md#clone)
- [connectTo](VertexOutputBlock.md#connectto)
- [dispose](VertexOutputBlock.md#dispose)
- [getClassName](VertexOutputBlock.md#getclassname)
- [getFirstAvailableInput](VertexOutputBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](VertexOutputBlock.md#getfirstavailableoutput)
- [getInputByName](VertexOutputBlock.md#getinputbyname)
- [getOutputByName](VertexOutputBlock.md#getoutputbyname)
- [getSiblingOutput](VertexOutputBlock.md#getsiblingoutput)
- [initialize](VertexOutputBlock.md#initialize)
- [initializeDefines](VertexOutputBlock.md#initializedefines)
- [isAnAncestorOf](VertexOutputBlock.md#isanancestorof)
- [isReady](VertexOutputBlock.md#isready)
- [prepareDefines](VertexOutputBlock.md#preparedefines)
- [provideFallbacks](VertexOutputBlock.md#providefallbacks)
- [registerInput](VertexOutputBlock.md#registerinput)
- [registerOutput](VertexOutputBlock.md#registeroutput)
- [replaceRepeatableContent](VertexOutputBlock.md#replacerepeatablecontent)
- [serialize](VertexOutputBlock.md#serialize)
- [updateUniformsAndSamples](VertexOutputBlock.md#updateuniformsandsamples)
- [validateBlockName](VertexOutputBlock.md#validateblockname)

## Constructors

### constructor

• **new VertexOutputBlock**(`name`)
...
packages/dev/core/src/Materials/Node/Blocks/Vertex/vertexOutputBlock.ts:19
...
packages/dev/core/src/Materials/Node/Blocks/Vertex/vertexOutputBlock.ts:36
...
▸ `Protected` **_buildBlock**(`state`): [`VertexOutputBlock`](VertexOutputBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/Vertex/vertexOutputBlock.ts:49
...
▸ `Private` **_isLogarithmicDepthEnabled**(`nodeList`): `boolean`

#### Parameters

| Name | Type |
| :------ | :------ |
| `nodeList` | readonly [`NodeMaterialBlock`](NodeMaterialBlock.md)[] |
...
packages/dev/core/src/Materials/Node/Blocks/Vertex/vertexOutputBlock.ts:40
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`VertexOutputBlock`](VertexOutputBlock.md)
...
`undefined` \| [`VertexOutputBlock`](VertexOutputBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/Vertex/vertexOutputBlock.ts:29
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`VertexOutputBlock`](VertexOutputBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`VertexOutputBlock`](VertexOutputBlock.md)
