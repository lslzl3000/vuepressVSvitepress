[@dev/core](../README.md) / [Exports](../modules.md) / ScaleBlock
...
- [constructor](ScaleBlock.md#constructor)

### Properties

- [\_isUnique](ScaleBlock.md#_isunique)
- [\_target](ScaleBlock.md#_target)
- [comments](ScaleBlock.md#comments)
- [inputsAreExclusive](ScaleBlock.md#inputsareexclusive)
- [uniqueId](ScaleBlock.md#uniqueid)
- [visibleInInspector](ScaleBlock.md#visibleininspector)
- [visibleOnFrame](ScaleBlock.md#visibleonframe)

### Accessors

- [buildId](ScaleBlock.md#buildid)
- [factor](ScaleBlock.md#factor)
- [input](ScaleBlock.md#input)
- [inputs](ScaleBlock.md#inputs)
- [isFinalMerger](ScaleBlock.md#isfinalmerger)
- [isInput](ScaleBlock.md#isinput)
- [isUnique](ScaleBlock.md#isunique)
- [name](ScaleBlock.md#name)
- [output](ScaleBlock.md#output)
- [outputs](ScaleBlock.md#outputs)
- [target](ScaleBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](ScaleBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](ScaleBlock.md#_buildblock)
- [\_declareOutput](ScaleBlock.md#_declareoutput)
- [\_dumpPropertiesCode](ScaleBlock.md#_dumppropertiescode)
- [\_inputRename](ScaleBlock.md#_inputrename)
- [\_linkConnectionTypes](ScaleBlock.md#_linkconnectiontypes)
- [\_outputRename](ScaleBlock.md#_outputrename)
- [\_writeFloat](ScaleBlock.md#_writefloat)
- [\_writeVariable](ScaleBlock.md#_writevariable)
- [autoConfigure](ScaleBlock.md#autoconfigure)
- [bind](ScaleBlock.md#bind)
- [build](ScaleBlock.md#build)
- [clone](ScaleBlock.md#clone)
- [connectTo](ScaleBlock.md#connectto)
- [dispose](ScaleBlock.md#dispose)
- [getClassName](ScaleBlock.md#getclassname)
- [getFirstAvailableInput](ScaleBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](ScaleBlock.md#getfirstavailableoutput)
- [getInputByName](ScaleBlock.md#getinputbyname)
- [getOutputByName](ScaleBlock.md#getoutputbyname)
- [getSiblingOutput](ScaleBlock.md#getsiblingoutput)
- [initialize](ScaleBlock.md#initialize)
- [initializeDefines](ScaleBlock.md#initializedefines)
- [isAnAncestorOf](ScaleBlock.md#isanancestorof)
- [isReady](ScaleBlock.md#isready)
- [prepareDefines](ScaleBlock.md#preparedefines)
- [provideFallbacks](ScaleBlock.md#providefallbacks)
- [registerInput](ScaleBlock.md#registerinput)
- [registerOutput](ScaleBlock.md#registeroutput)
- [replaceRepeatableContent](ScaleBlock.md#replacerepeatablecontent)
- [serialize](ScaleBlock.md#serialize)
- [updateUniformsAndSamples](ScaleBlock.md#updateuniformsandsamples)
- [validateBlockName](ScaleBlock.md#validateblockname)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/scaleBlock.ts:15
...
• `get` **factor**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/scaleBlock.ts:43
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/scaleBlock.ts:36
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/scaleBlock.ts:50
...
▸ `Protected` **_buildBlock**(`state`): [`ScaleBlock`](ScaleBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/scaleBlock.ts:54
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`ScaleBlock`](ScaleBlock.md)
...
`undefined` \| [`ScaleBlock`](ScaleBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/scaleBlock.ts:29
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`ScaleBlock`](ScaleBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`ScaleBlock`](ScaleBlock.md)
