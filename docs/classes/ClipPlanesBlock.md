[@dev/core](../README.md) / [Exports](../modules.md) / ClipPlanesBlock

# Class: ClipPlanesBlock
...
- [constructor](ClipPlanesBlock.md#constructor)

### Properties

- [\_isUnique](ClipPlanesBlock.md#_isunique)
- [\_target](ClipPlanesBlock.md#_target)
- [comments](ClipPlanesBlock.md#comments)
- [inputsAreExclusive](ClipPlanesBlock.md#inputsareexclusive)
- [uniqueId](ClipPlanesBlock.md#uniqueid)
- [visibleInInspector](ClipPlanesBlock.md#visibleininspector)
- [visibleOnFrame](ClipPlanesBlock.md#visibleonframe)

### Accessors

- [buildId](ClipPlanesBlock.md#buildid)
- [inputs](ClipPlanesBlock.md#inputs)
- [isFinalMerger](ClipPlanesBlock.md#isfinalmerger)
- [isInput](ClipPlanesBlock.md#isinput)
- [isUnique](ClipPlanesBlock.md#isunique)
- [name](ClipPlanesBlock.md#name)
- [outputs](ClipPlanesBlock.md#outputs)
- [target](ClipPlanesBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](ClipPlanesBlock.md#willbegeneratedintovertexshaderfromfragmentshader)
- [worldPosition](ClipPlanesBlock.md#worldposition)

### Methods

- [\_buildBlock](ClipPlanesBlock.md#_buildblock)
- [\_declareOutput](ClipPlanesBlock.md#_declareoutput)
- [\_dumpPropertiesCode](ClipPlanesBlock.md#_dumppropertiescode)
- [\_inputRename](ClipPlanesBlock.md#_inputrename)
- [\_linkConnectionTypes](ClipPlanesBlock.md#_linkconnectiontypes)
- [\_outputRename](ClipPlanesBlock.md#_outputrename)
- [\_writeFloat](ClipPlanesBlock.md#_writefloat)
- [\_writeVariable](ClipPlanesBlock.md#_writevariable)
- [autoConfigure](ClipPlanesBlock.md#autoconfigure)
- [bind](ClipPlanesBlock.md#bind)
- [build](ClipPlanesBlock.md#build)
- [clone](ClipPlanesBlock.md#clone)
- [connectTo](ClipPlanesBlock.md#connectto)
- [dispose](ClipPlanesBlock.md#dispose)
- [getClassName](ClipPlanesBlock.md#getclassname)
- [getFirstAvailableInput](ClipPlanesBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](ClipPlanesBlock.md#getfirstavailableoutput)
- [getInputByName](ClipPlanesBlock.md#getinputbyname)
- [getOutputByName](ClipPlanesBlock.md#getoutputbyname)
- [getSiblingOutput](ClipPlanesBlock.md#getsiblingoutput)
- [initialize](ClipPlanesBlock.md#initialize)
- [initializeDefines](ClipPlanesBlock.md#initializedefines)
- [isAnAncestorOf](ClipPlanesBlock.md#isanancestorof)
- [isReady](ClipPlanesBlock.md#isready)
- [prepareDefines](ClipPlanesBlock.md#preparedefines)
- [provideFallbacks](ClipPlanesBlock.md#providefallbacks)
- [registerInput](ClipPlanesBlock.md#registerinput)
- [registerOutput](ClipPlanesBlock.md#registeroutput)
- [replaceRepeatableContent](ClipPlanesBlock.md#replacerepeatablecontent)
- [serialize](ClipPlanesBlock.md#serialize)
- [updateUniformsAndSamples](ClipPlanesBlock.md#updateuniformsandsamples)
- [validateBlockName](ClipPlanesBlock.md#validateblockname)

## Constructors

### constructor

• **new ClipPlanesBlock**(`name`)
...
packages/dev/core/src/Materials/Node/Blocks/Dual/clipPlanesBlock.ts:20
...
packages/dev/core/src/Materials/Node/Blocks/Dual/clipPlanesBlock.ts:60
...
packages/dev/core/src/Materials/Node/Blocks/Dual/clipPlanesBlock.ts:64
...
packages/dev/core/src/Materials/Node/Blocks/Dual/clipPlanesBlock.ts:56

## Methods

### \_buildBlock

▸ `Protected` **_buildBlock**(`state`): `undefined` \| [`ClipPlanesBlock`](ClipPlanesBlock.md)
...
`undefined` \| [`ClipPlanesBlock`](ClipPlanesBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/Dual/clipPlanesBlock.ts:94
...
packages/dev/core/src/Materials/Node/Blocks/Dual/clipPlanesBlock.ts:84
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`ClipPlanesBlock`](ClipPlanesBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/Dual/clipPlanesBlock.ts:30
...
packages/dev/core/src/Materials/Node/Blocks/Dual/clipPlanesBlock.ts:38
...
packages/dev/core/src/Materials/Node/Blocks/Dual/clipPlanesBlock.ts:66
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`ClipPlanesBlock`](ClipPlanesBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`ClipPlanesBlock`](ClipPlanesBlock.md)
