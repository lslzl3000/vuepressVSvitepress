[@dev/core](../README.md) / [Exports](../modules.md) / ReflectBlock
...
- [constructor](ReflectBlock.md#constructor)

### Properties

- [\_isUnique](ReflectBlock.md#_isunique)
- [\_target](ReflectBlock.md#_target)
- [comments](ReflectBlock.md#comments)
- [inputsAreExclusive](ReflectBlock.md#inputsareexclusive)
- [uniqueId](ReflectBlock.md#uniqueid)
- [visibleInInspector](ReflectBlock.md#visibleininspector)
- [visibleOnFrame](ReflectBlock.md#visibleonframe)

### Accessors

- [buildId](ReflectBlock.md#buildid)
- [incident](ReflectBlock.md#incident)
- [inputs](ReflectBlock.md#inputs)
- [isFinalMerger](ReflectBlock.md#isfinalmerger)
- [isInput](ReflectBlock.md#isinput)
- [isUnique](ReflectBlock.md#isunique)
- [name](ReflectBlock.md#name)
- [normal](ReflectBlock.md#normal)
- [output](ReflectBlock.md#output)
- [outputs](ReflectBlock.md#outputs)
- [target](ReflectBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](ReflectBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](ReflectBlock.md#_buildblock)
- [\_declareOutput](ReflectBlock.md#_declareoutput)
- [\_dumpPropertiesCode](ReflectBlock.md#_dumppropertiescode)
- [\_inputRename](ReflectBlock.md#_inputrename)
- [\_linkConnectionTypes](ReflectBlock.md#_linkconnectiontypes)
- [\_outputRename](ReflectBlock.md#_outputrename)
- [\_writeFloat](ReflectBlock.md#_writefloat)
- [\_writeVariable](ReflectBlock.md#_writevariable)
- [autoConfigure](ReflectBlock.md#autoconfigure)
- [bind](ReflectBlock.md#bind)
- [build](ReflectBlock.md#build)
- [clone](ReflectBlock.md#clone)
- [connectTo](ReflectBlock.md#connectto)
- [dispose](ReflectBlock.md#dispose)
- [getClassName](ReflectBlock.md#getclassname)
- [getFirstAvailableInput](ReflectBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](ReflectBlock.md#getfirstavailableoutput)
- [getInputByName](ReflectBlock.md#getinputbyname)
- [getOutputByName](ReflectBlock.md#getoutputbyname)
- [getSiblingOutput](ReflectBlock.md#getsiblingoutput)
- [initialize](ReflectBlock.md#initialize)
- [initializeDefines](ReflectBlock.md#initializedefines)
- [isAnAncestorOf](ReflectBlock.md#isanancestorof)
- [isReady](ReflectBlock.md#isready)
- [prepareDefines](ReflectBlock.md#preparedefines)
- [provideFallbacks](ReflectBlock.md#providefallbacks)
- [registerInput](ReflectBlock.md#registerinput)
- [registerOutput](ReflectBlock.md#registeroutput)
- [replaceRepeatableContent](ReflectBlock.md#replacerepeatablecontent)
- [serialize](ReflectBlock.md#serialize)
- [updateUniformsAndSamples](ReflectBlock.md#updateuniformsandsamples)
- [validateBlockName](ReflectBlock.md#validateblockname)

## Constructors

### constructor

• **new ReflectBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/reflectBlock.ts:15
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/reflectBlock.ts:41
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/reflectBlock.ts:48
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/reflectBlock.ts:55
...
▸ `Protected` **_buildBlock**(`state`): [`ReflectBlock`](ReflectBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/reflectBlock.ts:59
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`ReflectBlock`](ReflectBlock.md)
...
`undefined` \| [`ReflectBlock`](ReflectBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/reflectBlock.ts:34
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`ReflectBlock`](ReflectBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`ReflectBlock`](ReflectBlock.md)
