[@dev/core](../README.md) / [Exports](../modules.md) / FxaaPostProcess
...
https://doc.babylonjs.com/how_to/how_to_use_postprocesses#fxaa
...
- [constructor](FxaaPostProcess.md#constructor)

### Properties

- [\_indexParameters](FxaaPostProcess.md#_indexparameters)
- [\_postProcessDefines](FxaaPostProcess.md#_postprocessdefines)
- [\_scene](FxaaPostProcess.md#_scene)
- [adaptScaleToCurrentViewport](FxaaPostProcess.md#adaptscaletocurrentviewport)
- [alphaConstants](FxaaPostProcess.md#alphaconstants)
- [alphaMode](FxaaPostProcess.md#alphamode)
- [alwaysForcePOT](FxaaPostProcess.md#alwaysforcepot)
- [animations](FxaaPostProcess.md#animations)
- [autoClear](FxaaPostProcess.md#autoclear)
- [clearColor](FxaaPostProcess.md#clearcolor)
- [enablePixelPerfectMode](FxaaPostProcess.md#enablepixelperfectmode)
- [externalTextureSamplerBinding](FxaaPostProcess.md#externaltexturesamplerbinding)
- [forceFullscreenViewport](FxaaPostProcess.md#forcefullscreenviewport)
- [height](FxaaPostProcess.md#height)
- [inspectableCustomProperties](FxaaPostProcess.md#inspectablecustomproperties)
- [name](FxaaPostProcess.md#name)
- [nodeMaterialSource](FxaaPostProcess.md#nodematerialsource)
- [onActivateObservable](FxaaPostProcess.md#onactivateobservable)
- [onAfterRenderObservable](FxaaPostProcess.md#onafterrenderobservable)
- [onApplyObservable](FxaaPostProcess.md#onapplyobservable)
- [onBeforeRenderObservable](FxaaPostProcess.md#onbeforerenderobservable)
- [onSizeChangedObservable](FxaaPostProcess.md#onsizechangedobservable)
- [renderTargetSamplingMode](FxaaPostProcess.md#rendertargetsamplingmode)
- [scaleMode](FxaaPostProcess.md#scalemode)
- [uniqueId](FxaaPostProcess.md#uniqueid)
- [width](FxaaPostProcess.md#width)

### Accessors

- [aspectRatio](FxaaPostProcess.md#aspectratio)
- [inputTexture](FxaaPostProcess.md#inputtexture)
- [isSupported](FxaaPostProcess.md#issupported)
- [onActivate](FxaaPostProcess.md#onactivate)
- [onAfterRender](FxaaPostProcess.md#onafterrender)
- [onApply](FxaaPostProcess.md#onapply)
- [onBeforeRender](FxaaPostProcess.md#onbeforerender)
- [onSizeChanged](FxaaPostProcess.md#onsizechanged)
- [samples](FxaaPostProcess.md#samples)
- [texelSize](FxaaPostProcess.md#texelsize)

### Methods

- [\_getDefines](FxaaPostProcess.md#_getdefines)
- [activate](FxaaPostProcess.md#activate)
- [apply](FxaaPostProcess.md#apply)
- [clone](FxaaPostProcess.md#clone)
- [dispose](FxaaPostProcess.md#dispose)
- [getCamera](FxaaPostProcess.md#getcamera)
- [getClassName](FxaaPostProcess.md#getclassname)
- [getEffect](FxaaPostProcess.md#geteffect)
- [getEffectName](FxaaPostProcess.md#geteffectname)
- [getEngine](FxaaPostProcess.md#getengine)
- [isReady](FxaaPostProcess.md#isready)
- [isReusable](FxaaPostProcess.md#isreusable)
- [markTextureDirty](FxaaPostProcess.md#marktexturedirty)
- [restoreDefaultInputTexture](FxaaPostProcess.md#restoredefaultinputtexture)
- [serialize](FxaaPostProcess.md#serialize)
- [setPrePassRenderer](FxaaPostProcess.md#setprepassrenderer)
- [shareOutputWith](FxaaPostProcess.md#shareoutputwith)
- [updateEffect](FxaaPostProcess.md#updateeffect)
- [useOwnOutput](FxaaPostProcess.md#useownoutput)
- [Parse](FxaaPostProcess.md#parse)

## Constructors

### constructor

• **new FxaaPostProcess**(`name`, `options`, `camera?`, `samplingMode?`, `engine?`, `reusable?`, `textureType?`)
...
packages/dev/core/src/PostProcesses/fxaaPostProcess.ts:29
...
▸ `Private` **_getDefines**(): [`Nullable`](../modules.md#nullable)`string`
...
packages/dev/core/src/PostProcesses/fxaaPostProcess.ts:49
...
packages/dev/core/src/PostProcesses/fxaaPostProcess.ts:25
