[@dev/core](../README.md) / [Exports](../modules.md) / ColorSplitterBlock

# Class: ColorSplitterBlock
...
- [constructor](ColorSplitterBlock.md#constructor)

### Properties

- [\_isUnique](ColorSplitterBlock.md#_isunique)
- [\_target](ColorSplitterBlock.md#_target)
- [comments](ColorSplitterBlock.md#comments)
- [inputsAreExclusive](ColorSplitterBlock.md#inputsareexclusive)
- [uniqueId](ColorSplitterBlock.md#uniqueid)
- [visibleInInspector](ColorSplitterBlock.md#visibleininspector)
- [visibleOnFrame](ColorSplitterBlock.md#visibleonframe)

### Accessors

- [a](ColorSplitterBlock.md#a)
- [b](ColorSplitterBlock.md#b)
- [buildId](ColorSplitterBlock.md#buildid)
- [g](ColorSplitterBlock.md#g)
- [inputs](ColorSplitterBlock.md#inputs)
- [isFinalMerger](ColorSplitterBlock.md#isfinalmerger)
- [isInput](ColorSplitterBlock.md#isinput)
- [isUnique](ColorSplitterBlock.md#isunique)
- [name](ColorSplitterBlock.md#name)
- [outputs](ColorSplitterBlock.md#outputs)
- [r](ColorSplitterBlock.md#r)
- [rgbIn](ColorSplitterBlock.md#rgbin)
- [rgbOut](ColorSplitterBlock.md#rgbout)
- [rgba](ColorSplitterBlock.md#rgba)
- [target](ColorSplitterBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](ColorSplitterBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](ColorSplitterBlock.md#_buildblock)
- [\_declareOutput](ColorSplitterBlock.md#_declareoutput)
- [\_dumpPropertiesCode](ColorSplitterBlock.md#_dumppropertiescode)
- [\_inputRename](ColorSplitterBlock.md#_inputrename)
- [\_linkConnectionTypes](ColorSplitterBlock.md#_linkconnectiontypes)
- [\_outputRename](ColorSplitterBlock.md#_outputrename)
- [\_writeFloat](ColorSplitterBlock.md#_writefloat)
- [\_writeVariable](ColorSplitterBlock.md#_writevariable)
- [autoConfigure](ColorSplitterBlock.md#autoconfigure)
- [bind](ColorSplitterBlock.md#bind)
- [build](ColorSplitterBlock.md#build)
- [clone](ColorSplitterBlock.md#clone)
- [connectTo](ColorSplitterBlock.md#connectto)
- [dispose](ColorSplitterBlock.md#dispose)
- [getClassName](ColorSplitterBlock.md#getclassname)
- [getFirstAvailableInput](ColorSplitterBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](ColorSplitterBlock.md#getfirstavailableoutput)
- [getInputByName](ColorSplitterBlock.md#getinputbyname)
- [getOutputByName](ColorSplitterBlock.md#getoutputbyname)
- [getSiblingOutput](ColorSplitterBlock.md#getsiblingoutput)
- [initialize](ColorSplitterBlock.md#initialize)
- [initializeDefines](ColorSplitterBlock.md#initializedefines)
- [isAnAncestorOf](ColorSplitterBlock.md#isanancestorof)
- [isReady](ColorSplitterBlock.md#isready)
- [prepareDefines](ColorSplitterBlock.md#preparedefines)
- [provideFallbacks](ColorSplitterBlock.md#providefallbacks)
- [registerInput](ColorSplitterBlock.md#registerinput)
- [registerOutput](ColorSplitterBlock.md#registeroutput)
- [replaceRepeatableContent](ColorSplitterBlock.md#replacerepeatablecontent)
- [serialize](ColorSplitterBlock.md#serialize)
- [updateUniformsAndSamples](ColorSplitterBlock.md#updateuniformsandsamples)
- [validateBlockName](ColorSplitterBlock.md#validateblockname)

## Constructors

### constructor

• **new ColorSplitterBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorSplitterBlock.ts:16
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorSplitterBlock.ts:82
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorSplitterBlock.ts:76
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorSplitterBlock.ts:70
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorSplitterBlock.ts:63
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorSplitterBlock.ts:49
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorSplitterBlock.ts:56
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorSplitterBlock.ts:42
...
▸ `Protected` **_buildBlock**(`state`): `undefined` \| [`ColorSplitterBlock`](ColorSplitterBlock.md)
...
`undefined` \| [`ColorSplitterBlock`](ColorSplitterBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorSplitterBlock.ts:100
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorSplitterBlock.ts:86
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorSplitterBlock.ts:93
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`ColorSplitterBlock`](ColorSplitterBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/colorSplitterBlock.ts:35
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`ColorSplitterBlock`](ColorSplitterBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`ColorSplitterBlock`](ColorSplitterBlock.md)
