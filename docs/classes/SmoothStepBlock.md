[@dev/core](../README.md) / [Exports](../modules.md) / SmoothStepBlock
...
- [constructor](SmoothStepBlock.md#constructor)

### Properties

- [\_isUnique](SmoothStepBlock.md#_isunique)
- [\_target](SmoothStepBlock.md#_target)
- [comments](SmoothStepBlock.md#comments)
- [inputsAreExclusive](SmoothStepBlock.md#inputsareexclusive)
- [uniqueId](SmoothStepBlock.md#uniqueid)
- [visibleInInspector](SmoothStepBlock.md#visibleininspector)
- [visibleOnFrame](SmoothStepBlock.md#visibleonframe)

### Accessors

- [buildId](SmoothStepBlock.md#buildid)
- [edge0](SmoothStepBlock.md#edge0)
- [edge1](SmoothStepBlock.md#edge1)
- [inputs](SmoothStepBlock.md#inputs)
- [isFinalMerger](SmoothStepBlock.md#isfinalmerger)
- [isInput](SmoothStepBlock.md#isinput)
- [isUnique](SmoothStepBlock.md#isunique)
- [name](SmoothStepBlock.md#name)
- [output](SmoothStepBlock.md#output)
- [outputs](SmoothStepBlock.md#outputs)
- [target](SmoothStepBlock.md#target)
- [value](SmoothStepBlock.md#value)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](SmoothStepBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](SmoothStepBlock.md#_buildblock)
- [\_declareOutput](SmoothStepBlock.md#_declareoutput)
- [\_dumpPropertiesCode](SmoothStepBlock.md#_dumppropertiescode)
- [\_inputRename](SmoothStepBlock.md#_inputrename)
- [\_linkConnectionTypes](SmoothStepBlock.md#_linkconnectiontypes)
- [\_outputRename](SmoothStepBlock.md#_outputrename)
- [\_writeFloat](SmoothStepBlock.md#_writefloat)
- [\_writeVariable](SmoothStepBlock.md#_writevariable)
- [autoConfigure](SmoothStepBlock.md#autoconfigure)
- [bind](SmoothStepBlock.md#bind)
- [build](SmoothStepBlock.md#build)
- [clone](SmoothStepBlock.md#clone)
- [connectTo](SmoothStepBlock.md#connectto)
- [dispose](SmoothStepBlock.md#dispose)
- [getClassName](SmoothStepBlock.md#getclassname)
- [getFirstAvailableInput](SmoothStepBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](SmoothStepBlock.md#getfirstavailableoutput)
- [getInputByName](SmoothStepBlock.md#getinputbyname)
- [getOutputByName](SmoothStepBlock.md#getoutputbyname)
- [getSiblingOutput](SmoothStepBlock.md#getsiblingoutput)
- [initialize](SmoothStepBlock.md#initialize)
- [initializeDefines](SmoothStepBlock.md#initializedefines)
- [isAnAncestorOf](SmoothStepBlock.md#isanancestorof)
- [isReady](SmoothStepBlock.md#isready)
- [prepareDefines](SmoothStepBlock.md#preparedefines)
- [provideFallbacks](SmoothStepBlock.md#providefallbacks)
- [registerInput](SmoothStepBlock.md#registerinput)
- [registerOutput](SmoothStepBlock.md#registeroutput)
- [replaceRepeatableContent](SmoothStepBlock.md#replacerepeatablecontent)
- [serialize](SmoothStepBlock.md#serialize)
- [updateUniformsAndSamples](SmoothStepBlock.md#updateuniformsandsamples)
- [validateBlockName](SmoothStepBlock.md#validateblockname)

## Constructors

### constructor

• **new SmoothStepBlock**(`name`)
...
packages/dev/core/src/Materials/Node/Blocks/smoothStepBlock.ts:15
...
• `get` **edge0**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/smoothStepBlock.ts:44

___

### edge1

• `get` **edge1**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/smoothStepBlock.ts:51
...
packages/dev/core/src/Materials/Node/Blocks/smoothStepBlock.ts:58
...
packages/dev/core/src/Materials/Node/Blocks/smoothStepBlock.ts:37
...
▸ `Protected` **_buildBlock**(`state`): [`SmoothStepBlock`](SmoothStepBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/smoothStepBlock.ts:62
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`SmoothStepBlock`](SmoothStepBlock.md)
...
`undefined` \| [`SmoothStepBlock`](SmoothStepBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/smoothStepBlock.ts:30
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`SmoothStepBlock`](SmoothStepBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`SmoothStepBlock`](SmoothStepBlock.md)
