[@dev/core](../README.md) / [Exports](../modules.md) / TrailMesh
...
- [isOcclusionQueryInProgress](TrailMesh.md#isocclusionqueryinprogress)
...
- [OCCLUSION\_TYPE\_OPTIMISTIC](TrailMesh.md#occlusion_type_optimistic)
...
- [onEnabledStateChangedObservable](TrailMesh.md#onenabledstatechangedobservable)
...
- [disableEdgesRendering](TrailMesh.md#disableedgesrendering)
...
- [instantiateHierarchy](TrailMesh.md#instantiatehierarchy)
...
- [thinInstanceBufferUpdated](TrailMesh.md#thininstancebufferupdated)
...
https://github.com/babylon.js/core/src/Meshes/trailMesh.ts:19
...
https://github.com/babylon.js/core/src/Meshes/trailMesh.ts:59
...
▸ **clone**(`name?`, `newGenerator`): [`TrailMesh`](TrailMesh.md)
...
| `newGenerator` | [`TransformNode`](TransformNode.md) | `undefined` | use new generator object for cloned trail mesh |
...
https://github.com/babylon.js/core/src/Meshes/trailMesh.ts:159
...
https://github.com/babylon.js/core/src/Meshes/trailMesh.ts:55
...
▸ **getFacetNormalToRef**(`i`, `ref`): [`TrailMesh`](TrailMesh.md)
...
https://github.com/babylon.js/core/src/Meshes/trailMesh.ts:167
...
https://github.com/babylon.js/core/src/Meshes/trailMesh.ts:99
...
https://github.com/babylon.js/core/src/Meshes/trailMesh.ts:111
...
▸ **unfreezeWorldMatrix**(): [`TrailMesh`](TrailMesh.md)
...
https://github.com/babylon.js/core/src/Meshes/trailMesh.ts:121
...
▸ `Static` **Parse**(`parsedMesh`, `scene`): [`TrailMesh`](TrailMesh.md)
...
| `scene` | [`Scene`](Scene.md) | the scene to create the trail mesh in |

#### Returns

[`TrailMesh`](TrailMesh.md)

the created trail mesh
...
https://github.com/babylon.js/core/src/Meshes/trailMesh.ts:177
