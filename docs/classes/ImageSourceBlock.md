[@dev/core](../README.md) / [Exports](../modules.md) / ImageSourceBlock

# Class: ImageSourceBlock
...
- [constructor](ImageSourceBlock.md#constructor)

### Properties

- [\_isUnique](ImageSourceBlock.md#_isunique)
- [\_samplerName](ImageSourceBlock.md#_samplername)
- [\_target](ImageSourceBlock.md#_target)
- [\_texture](ImageSourceBlock.md#_texture)
- [comments](ImageSourceBlock.md#comments)
- [inputsAreExclusive](ImageSourceBlock.md#inputsareexclusive)
- [uniqueId](ImageSourceBlock.md#uniqueid)
- [visibleInInspector](ImageSourceBlock.md#visibleininspector)
- [visibleOnFrame](ImageSourceBlock.md#visibleonframe)

### Accessors

- [buildId](ImageSourceBlock.md#buildid)
- [inputs](ImageSourceBlock.md#inputs)
- [isFinalMerger](ImageSourceBlock.md#isfinalmerger)
- [isInput](ImageSourceBlock.md#isinput)
- [isUnique](ImageSourceBlock.md#isunique)
- [name](ImageSourceBlock.md#name)
- [outputs](ImageSourceBlock.md#outputs)
- [samplerName](ImageSourceBlock.md#samplername)
- [source](ImageSourceBlock.md#source)
- [target](ImageSourceBlock.md#target)
- [texture](ImageSourceBlock.md#texture)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](ImageSourceBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](ImageSourceBlock.md#_buildblock)
- [\_declareOutput](ImageSourceBlock.md#_declareoutput)
- [\_deserialize](ImageSourceBlock.md#_deserialize)
- [\_dumpPropertiesCode](ImageSourceBlock.md#_dumppropertiescode)
- [\_inputRename](ImageSourceBlock.md#_inputrename)
- [\_linkConnectionTypes](ImageSourceBlock.md#_linkconnectiontypes)
- [\_outputRename](ImageSourceBlock.md#_outputrename)
- [\_writeFloat](ImageSourceBlock.md#_writefloat)
- [\_writeVariable](ImageSourceBlock.md#_writevariable)
- [autoConfigure](ImageSourceBlock.md#autoconfigure)
- [bind](ImageSourceBlock.md#bind)
- [build](ImageSourceBlock.md#build)
- [clone](ImageSourceBlock.md#clone)
- [connectTo](ImageSourceBlock.md#connectto)
- [dispose](ImageSourceBlock.md#dispose)
- [getClassName](ImageSourceBlock.md#getclassname)
- [getFirstAvailableInput](ImageSourceBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](ImageSourceBlock.md#getfirstavailableoutput)
- [getInputByName](ImageSourceBlock.md#getinputbyname)
- [getOutputByName](ImageSourceBlock.md#getoutputbyname)
- [getSiblingOutput](ImageSourceBlock.md#getsiblingoutput)
- [initialize](ImageSourceBlock.md#initialize)
- [initializeDefines](ImageSourceBlock.md#initializedefines)
- [isAnAncestorOf](ImageSourceBlock.md#isanancestorof)
- [isReady](ImageSourceBlock.md#isready)
- [prepareDefines](ImageSourceBlock.md#preparedefines)
- [provideFallbacks](ImageSourceBlock.md#providefallbacks)
- [registerInput](ImageSourceBlock.md#registerinput)
- [registerOutput](ImageSourceBlock.md#registeroutput)
- [replaceRepeatableContent](ImageSourceBlock.md#replacerepeatablecontent)
- [serialize](ImageSourceBlock.md#serialize)
- [updateUniformsAndSamples](ImageSourceBlock.md#updateuniformsandsamples)
- [validateBlockName](ImageSourceBlock.md#validateblockname)

## Constructors

### constructor

• **new ImageSourceBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/imageSourceBlock.ts:62
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/imageSourceBlock.ts:20
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/imageSourceBlock.ts:21
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/imageSourceBlock.ts:54
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/imageSourceBlock.ts:100
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/imageSourceBlock.ts:25
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/imageSourceBlock.ts:29
...
▸ `Protected` **_buildBlock**(`state`): [`ImageSourceBlock`](ImageSourceBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/imageSourceBlock.ts:104
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/imageSourceBlock.ts:153
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/imageSourceBlock.ts:121
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/imageSourceBlock.ts:73
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`ImageSourceBlock`](ImageSourceBlock.md)
...
`undefined` \| [`ImageSourceBlock`](ImageSourceBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/imageSourceBlock.ts:93
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/imageSourceBlock.ts:81
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`ImageSourceBlock`](ImageSourceBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`ImageSourceBlock`](ImageSourceBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/imageSourceBlock.ts:143
