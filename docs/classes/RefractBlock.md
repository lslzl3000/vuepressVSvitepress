[@dev/core](../README.md) / [Exports](../modules.md) / RefractBlock
...
- [constructor](RefractBlock.md#constructor)

### Properties

- [\_isUnique](RefractBlock.md#_isunique)
- [\_target](RefractBlock.md#_target)
- [comments](RefractBlock.md#comments)
- [inputsAreExclusive](RefractBlock.md#inputsareexclusive)
- [uniqueId](RefractBlock.md#uniqueid)
- [visibleInInspector](RefractBlock.md#visibleininspector)
- [visibleOnFrame](RefractBlock.md#visibleonframe)

### Accessors

- [buildId](RefractBlock.md#buildid)
- [incident](RefractBlock.md#incident)
- [inputs](RefractBlock.md#inputs)
- [ior](RefractBlock.md#ior)
- [isFinalMerger](RefractBlock.md#isfinalmerger)
- [isInput](RefractBlock.md#isinput)
- [isUnique](RefractBlock.md#isunique)
- [name](RefractBlock.md#name)
- [normal](RefractBlock.md#normal)
- [output](RefractBlock.md#output)
- [outputs](RefractBlock.md#outputs)
- [target](RefractBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](RefractBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](RefractBlock.md#_buildblock)
- [\_declareOutput](RefractBlock.md#_declareoutput)
- [\_dumpPropertiesCode](RefractBlock.md#_dumppropertiescode)
- [\_inputRename](RefractBlock.md#_inputrename)
- [\_linkConnectionTypes](RefractBlock.md#_linkconnectiontypes)
- [\_outputRename](RefractBlock.md#_outputrename)
- [\_writeFloat](RefractBlock.md#_writefloat)
- [\_writeVariable](RefractBlock.md#_writevariable)
- [autoConfigure](RefractBlock.md#autoconfigure)
- [bind](RefractBlock.md#bind)
- [build](RefractBlock.md#build)
- [clone](RefractBlock.md#clone)
- [connectTo](RefractBlock.md#connectto)
- [dispose](RefractBlock.md#dispose)
- [getClassName](RefractBlock.md#getclassname)
- [getFirstAvailableInput](RefractBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](RefractBlock.md#getfirstavailableoutput)
- [getInputByName](RefractBlock.md#getinputbyname)
- [getOutputByName](RefractBlock.md#getoutputbyname)
- [getSiblingOutput](RefractBlock.md#getsiblingoutput)
- [initialize](RefractBlock.md#initialize)
- [initializeDefines](RefractBlock.md#initializedefines)
- [isAnAncestorOf](RefractBlock.md#isanancestorof)
- [isReady](RefractBlock.md#isready)
- [prepareDefines](RefractBlock.md#preparedefines)
- [provideFallbacks](RefractBlock.md#providefallbacks)
- [registerInput](RefractBlock.md#registerinput)
- [registerOutput](RefractBlock.md#registeroutput)
- [replaceRepeatableContent](RefractBlock.md#replacerepeatablecontent)
- [serialize](RefractBlock.md#serialize)
- [updateUniformsAndSamples](RefractBlock.md#updateuniformsandsamples)
- [validateBlockName](RefractBlock.md#validateblockname)

## Constructors

### constructor

• **new RefractBlock**(`name`)
...
packages/dev/core/src/Materials/Node/Blocks/refractBlock.ts:15
...
• `get` **incident**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/refractBlock.ts:42
...
• `get` **ior**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/refractBlock.ts:56
...
packages/dev/core/src/Materials/Node/Blocks/refractBlock.ts:49
...
packages/dev/core/src/Materials/Node/Blocks/refractBlock.ts:63
...
▸ `Protected` **_buildBlock**(`state`): [`RefractBlock`](RefractBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/refractBlock.ts:67
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`RefractBlock`](RefractBlock.md)
...
`undefined` \| [`RefractBlock`](RefractBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/refractBlock.ts:35
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`RefractBlock`](RefractBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`RefractBlock`](RefractBlock.md)
