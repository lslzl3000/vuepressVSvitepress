[@dev/core](../README.md) / [Exports](../modules.md) / LengthBlock
...
- [constructor](LengthBlock.md#constructor)

### Properties

- [\_isUnique](LengthBlock.md#_isunique)
- [\_target](LengthBlock.md#_target)
- [comments](LengthBlock.md#comments)
- [inputsAreExclusive](LengthBlock.md#inputsareexclusive)
- [uniqueId](LengthBlock.md#uniqueid)
- [visibleInInspector](LengthBlock.md#visibleininspector)
- [visibleOnFrame](LengthBlock.md#visibleonframe)

### Accessors

- [buildId](LengthBlock.md#buildid)
- [inputs](LengthBlock.md#inputs)
- [isFinalMerger](LengthBlock.md#isfinalmerger)
- [isInput](LengthBlock.md#isinput)
- [isUnique](LengthBlock.md#isunique)
- [name](LengthBlock.md#name)
- [output](LengthBlock.md#output)
- [outputs](LengthBlock.md#outputs)
- [target](LengthBlock.md#target)
- [value](LengthBlock.md#value)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](LengthBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](LengthBlock.md#_buildblock)
- [\_declareOutput](LengthBlock.md#_declareoutput)
- [\_dumpPropertiesCode](LengthBlock.md#_dumppropertiescode)
- [\_inputRename](LengthBlock.md#_inputrename)
- [\_linkConnectionTypes](LengthBlock.md#_linkconnectiontypes)
- [\_outputRename](LengthBlock.md#_outputrename)
- [\_writeFloat](LengthBlock.md#_writefloat)
- [\_writeVariable](LengthBlock.md#_writevariable)
- [autoConfigure](LengthBlock.md#autoconfigure)
- [bind](LengthBlock.md#bind)
- [build](LengthBlock.md#build)
- [clone](LengthBlock.md#clone)
- [connectTo](LengthBlock.md#connectto)
- [dispose](LengthBlock.md#dispose)
- [getClassName](LengthBlock.md#getclassname)
- [getFirstAvailableInput](LengthBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](LengthBlock.md#getfirstavailableoutput)
- [getInputByName](LengthBlock.md#getinputbyname)
- [getOutputByName](LengthBlock.md#getoutputbyname)
- [getSiblingOutput](LengthBlock.md#getsiblingoutput)
- [initialize](LengthBlock.md#initialize)
- [initializeDefines](LengthBlock.md#initializedefines)
- [isAnAncestorOf](LengthBlock.md#isanancestorof)
- [isReady](LengthBlock.md#isready)
- [prepareDefines](LengthBlock.md#preparedefines)
- [provideFallbacks](LengthBlock.md#providefallbacks)
- [registerInput](LengthBlock.md#registerinput)
- [registerOutput](LengthBlock.md#registeroutput)
- [replaceRepeatableContent](LengthBlock.md#replacerepeatablecontent)
- [serialize](LengthBlock.md#serialize)
- [updateUniformsAndSamples](LengthBlock.md#updateuniformsandsamples)
- [validateBlockName](LengthBlock.md#validateblockname)

## Constructors

### constructor

• **new LengthBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/lengthBlock.ts:15
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/lengthBlock.ts:43
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/lengthBlock.ts:36
...
▸ `Protected` **_buildBlock**(`state`): [`LengthBlock`](LengthBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/lengthBlock.ts:47
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`LengthBlock`](LengthBlock.md)
...
`undefined` \| [`LengthBlock`](LengthBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/lengthBlock.ts:29
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`LengthBlock`](LengthBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`LengthBlock`](LengthBlock.md)
