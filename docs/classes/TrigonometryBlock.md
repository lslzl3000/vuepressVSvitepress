[@dev/core](../README.md) / [Exports](../modules.md) / TrigonometryBlock
...
- [constructor](TrigonometryBlock.md#constructor)

### Properties

- [\_isUnique](TrigonometryBlock.md#_isunique)
- [\_target](TrigonometryBlock.md#_target)
- [comments](TrigonometryBlock.md#comments)
- [inputsAreExclusive](TrigonometryBlock.md#inputsareexclusive)
- [operation](TrigonometryBlock.md#operation)
- [uniqueId](TrigonometryBlock.md#uniqueid)
- [visibleInInspector](TrigonometryBlock.md#visibleininspector)
- [visibleOnFrame](TrigonometryBlock.md#visibleonframe)

### Accessors

- [buildId](TrigonometryBlock.md#buildid)
- [input](TrigonometryBlock.md#input)
- [inputs](TrigonometryBlock.md#inputs)
- [isFinalMerger](TrigonometryBlock.md#isfinalmerger)
- [isInput](TrigonometryBlock.md#isinput)
- [isUnique](TrigonometryBlock.md#isunique)
- [name](TrigonometryBlock.md#name)
- [output](TrigonometryBlock.md#output)
- [outputs](TrigonometryBlock.md#outputs)
- [target](TrigonometryBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](TrigonometryBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](TrigonometryBlock.md#_buildblock)
- [\_declareOutput](TrigonometryBlock.md#_declareoutput)
- [\_deserialize](TrigonometryBlock.md#_deserialize)
- [\_dumpPropertiesCode](TrigonometryBlock.md#_dumppropertiescode)
- [\_inputRename](TrigonometryBlock.md#_inputrename)
- [\_linkConnectionTypes](TrigonometryBlock.md#_linkconnectiontypes)
- [\_outputRename](TrigonometryBlock.md#_outputrename)
- [\_writeFloat](TrigonometryBlock.md#_writefloat)
- [\_writeVariable](TrigonometryBlock.md#_writevariable)
- [autoConfigure](TrigonometryBlock.md#autoconfigure)
- [bind](TrigonometryBlock.md#bind)
- [build](TrigonometryBlock.md#build)
- [clone](TrigonometryBlock.md#clone)
- [connectTo](TrigonometryBlock.md#connectto)
- [dispose](TrigonometryBlock.md#dispose)
- [getClassName](TrigonometryBlock.md#getclassname)
- [getFirstAvailableInput](TrigonometryBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](TrigonometryBlock.md#getfirstavailableoutput)
- [getInputByName](TrigonometryBlock.md#getinputbyname)
- [getOutputByName](TrigonometryBlock.md#getoutputbyname)
- [getSiblingOutput](TrigonometryBlock.md#getsiblingoutput)
- [initialize](TrigonometryBlock.md#initialize)
- [initializeDefines](TrigonometryBlock.md#initializedefines)
- [isAnAncestorOf](TrigonometryBlock.md#isanancestorof)
- [isReady](TrigonometryBlock.md#isready)
- [prepareDefines](TrigonometryBlock.md#preparedefines)
- [provideFallbacks](TrigonometryBlock.md#providefallbacks)
- [registerInput](TrigonometryBlock.md#registerinput)
- [registerOutput](TrigonometryBlock.md#registeroutput)
- [replaceRepeatableContent](TrigonometryBlock.md#replacerepeatablecontent)
- [serialize](TrigonometryBlock.md#serialize)
- [updateUniformsAndSamples](TrigonometryBlock.md#updateuniformsandsamples)
- [validateBlockName](TrigonometryBlock.md#validateblockname)

## Constructors

### constructor

• **new TrigonometryBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/trigonometryBlock.ts:64
...
• **operation**: [`TrigonometryBlockOperations`](../enums/TrigonometryBlockOperations.md) = `TrigonometryBlockOperations.Cos`

Gets or sets the operation applied by the block

#### Defined in

https://github.com/babylon.js/core/src/Materials/Node/Blocks/trigonometryBlock.ts:58
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/trigonometryBlock.ts:84
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/trigonometryBlock.ts:91
...
▸ `Protected` **_buildBlock**(`state`): [`TrigonometryBlock`](TrigonometryBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/trigonometryBlock.ts:95
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/trigonometryBlock.ts:189
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/trigonometryBlock.ts:195
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`TrigonometryBlock`](TrigonometryBlock.md)
...
`undefined` \| [`TrigonometryBlock`](TrigonometryBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/trigonometryBlock.ts:77
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`TrigonometryBlock`](TrigonometryBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`TrigonometryBlock`](TrigonometryBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/trigonometryBlock.ts:181
