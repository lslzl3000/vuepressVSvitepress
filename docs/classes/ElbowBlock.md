[@dev/core](../README.md) / [Exports](../modules.md) / ElbowBlock
...
- [constructor](ElbowBlock.md#constructor)

### Properties

- [\_isUnique](ElbowBlock.md#_isunique)
- [\_target](ElbowBlock.md#_target)
- [comments](ElbowBlock.md#comments)
- [inputsAreExclusive](ElbowBlock.md#inputsareexclusive)
- [uniqueId](ElbowBlock.md#uniqueid)
- [visibleInInspector](ElbowBlock.md#visibleininspector)
- [visibleOnFrame](ElbowBlock.md#visibleonframe)

### Accessors

- [buildId](ElbowBlock.md#buildid)
- [input](ElbowBlock.md#input)
- [inputs](ElbowBlock.md#inputs)
- [isFinalMerger](ElbowBlock.md#isfinalmerger)
- [isInput](ElbowBlock.md#isinput)
- [isUnique](ElbowBlock.md#isunique)
- [name](ElbowBlock.md#name)
- [output](ElbowBlock.md#output)
- [outputs](ElbowBlock.md#outputs)
- [target](ElbowBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](ElbowBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](ElbowBlock.md#_buildblock)
- [\_declareOutput](ElbowBlock.md#_declareoutput)
- [\_dumpPropertiesCode](ElbowBlock.md#_dumppropertiescode)
- [\_inputRename](ElbowBlock.md#_inputrename)
- [\_linkConnectionTypes](ElbowBlock.md#_linkconnectiontypes)
- [\_outputRename](ElbowBlock.md#_outputrename)
- [\_writeFloat](ElbowBlock.md#_writefloat)
- [\_writeVariable](ElbowBlock.md#_writevariable)
- [autoConfigure](ElbowBlock.md#autoconfigure)
- [bind](ElbowBlock.md#bind)
- [build](ElbowBlock.md#build)
- [clone](ElbowBlock.md#clone)
- [connectTo](ElbowBlock.md#connectto)
- [dispose](ElbowBlock.md#dispose)
- [getClassName](ElbowBlock.md#getclassname)
- [getFirstAvailableInput](ElbowBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](ElbowBlock.md#getfirstavailableoutput)
- [getInputByName](ElbowBlock.md#getinputbyname)
- [getOutputByName](ElbowBlock.md#getoutputbyname)
- [getSiblingOutput](ElbowBlock.md#getsiblingoutput)
- [initialize](ElbowBlock.md#initialize)
- [initializeDefines](ElbowBlock.md#initializedefines)
- [isAnAncestorOf](ElbowBlock.md#isanancestorof)
- [isReady](ElbowBlock.md#isready)
- [prepareDefines](ElbowBlock.md#preparedefines)
- [provideFallbacks](ElbowBlock.md#providefallbacks)
- [registerInput](ElbowBlock.md#registerinput)
- [registerOutput](ElbowBlock.md#registeroutput)
- [replaceRepeatableContent](ElbowBlock.md#replacerepeatablecontent)
- [serialize](ElbowBlock.md#serialize)
- [updateUniformsAndSamples](ElbowBlock.md#updateuniformsandsamples)
- [validateBlockName](ElbowBlock.md#validateblockname)
...
packages/dev/core/src/Materials/Node/Blocks/elbowBlock.ts:15
...
packages/dev/core/src/Materials/Node/Blocks/elbowBlock.ts:35
...
packages/dev/core/src/Materials/Node/Blocks/elbowBlock.ts:42
...
packages/dev/core/src/Materials/Node/Blocks/elbowBlock.ts:49
...
packages/dev/core/src/Materials/Node/Blocks/elbowBlock.ts:65
...
▸ `Protected` **_buildBlock**(`state`): [`ElbowBlock`](ElbowBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/elbowBlock.ts:72
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`ElbowBlock`](ElbowBlock.md)
...
`undefined` \| [`ElbowBlock`](ElbowBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/elbowBlock.ts:28
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`ElbowBlock`](ElbowBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`ElbowBlock`](ElbowBlock.md)
