[@dev/core](../README.md) / [Exports](../modules.md) / NLerpBlock
...
- [constructor](NLerpBlock.md#constructor)

### Properties

- [\_isUnique](NLerpBlock.md#_isunique)
- [\_target](NLerpBlock.md#_target)
- [comments](NLerpBlock.md#comments)
- [inputsAreExclusive](NLerpBlock.md#inputsareexclusive)
- [uniqueId](NLerpBlock.md#uniqueid)
- [visibleInInspector](NLerpBlock.md#visibleininspector)
- [visibleOnFrame](NLerpBlock.md#visibleonframe)

### Accessors

- [buildId](NLerpBlock.md#buildid)
- [gradient](NLerpBlock.md#gradient)
- [inputs](NLerpBlock.md#inputs)
- [isFinalMerger](NLerpBlock.md#isfinalmerger)
- [isInput](NLerpBlock.md#isinput)
- [isUnique](NLerpBlock.md#isunique)
- [left](NLerpBlock.md#left)
- [name](NLerpBlock.md#name)
- [output](NLerpBlock.md#output)
- [outputs](NLerpBlock.md#outputs)
- [right](NLerpBlock.md#right)
- [target](NLerpBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](NLerpBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](NLerpBlock.md#_buildblock)
- [\_declareOutput](NLerpBlock.md#_declareoutput)
- [\_dumpPropertiesCode](NLerpBlock.md#_dumppropertiescode)
- [\_inputRename](NLerpBlock.md#_inputrename)
- [\_linkConnectionTypes](NLerpBlock.md#_linkconnectiontypes)
- [\_outputRename](NLerpBlock.md#_outputrename)
- [\_writeFloat](NLerpBlock.md#_writefloat)
- [\_writeVariable](NLerpBlock.md#_writevariable)
- [autoConfigure](NLerpBlock.md#autoconfigure)
- [bind](NLerpBlock.md#bind)
- [build](NLerpBlock.md#build)
- [clone](NLerpBlock.md#clone)
- [connectTo](NLerpBlock.md#connectto)
- [dispose](NLerpBlock.md#dispose)
- [getClassName](NLerpBlock.md#getclassname)
- [getFirstAvailableInput](NLerpBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](NLerpBlock.md#getfirstavailableoutput)
- [getInputByName](NLerpBlock.md#getinputbyname)
- [getOutputByName](NLerpBlock.md#getoutputbyname)
- [getSiblingOutput](NLerpBlock.md#getsiblingoutput)
- [initialize](NLerpBlock.md#initialize)
- [initializeDefines](NLerpBlock.md#initializedefines)
- [isAnAncestorOf](NLerpBlock.md#isanancestorof)
- [isReady](NLerpBlock.md#isready)
- [prepareDefines](NLerpBlock.md#preparedefines)
- [provideFallbacks](NLerpBlock.md#providefallbacks)
- [registerInput](NLerpBlock.md#registerinput)
- [registerOutput](NLerpBlock.md#registeroutput)
- [replaceRepeatableContent](NLerpBlock.md#replacerepeatablecontent)
- [serialize](NLerpBlock.md#serialize)
- [updateUniformsAndSamples](NLerpBlock.md#updateuniformsandsamples)
- [validateBlockName](NLerpBlock.md#validateblockname)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/nLerpBlock.ts:15
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/nLerpBlock.ts:55
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/nLerpBlock.ts:41
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/nLerpBlock.ts:62
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/nLerpBlock.ts:48
...
▸ `Protected` **_buildBlock**(`state`): [`NLerpBlock`](NLerpBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/nLerpBlock.ts:66
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`NLerpBlock`](NLerpBlock.md)
...
`undefined` \| [`NLerpBlock`](NLerpBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/nLerpBlock.ts:34
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`NLerpBlock`](NLerpBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`NLerpBlock`](NLerpBlock.md)
