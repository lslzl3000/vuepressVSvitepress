[@dev/core](../README.md) / [Exports](../modules.md) / TwirlBlock
...
- [constructor](TwirlBlock.md#constructor)

### Properties

- [\_isUnique](TwirlBlock.md#_isunique)
- [\_target](TwirlBlock.md#_target)
- [comments](TwirlBlock.md#comments)
- [inputsAreExclusive](TwirlBlock.md#inputsareexclusive)
- [uniqueId](TwirlBlock.md#uniqueid)
- [visibleInInspector](TwirlBlock.md#visibleininspector)
- [visibleOnFrame](TwirlBlock.md#visibleonframe)

### Accessors

- [buildId](TwirlBlock.md#buildid)
- [center](TwirlBlock.md#center)
- [input](TwirlBlock.md#input)
- [inputs](TwirlBlock.md#inputs)
- [isFinalMerger](TwirlBlock.md#isfinalmerger)
- [isInput](TwirlBlock.md#isinput)
- [isUnique](TwirlBlock.md#isunique)
- [name](TwirlBlock.md#name)
- [offset](TwirlBlock.md#offset)
- [output](TwirlBlock.md#output)
- [outputs](TwirlBlock.md#outputs)
- [strength](TwirlBlock.md#strength)
- [target](TwirlBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](TwirlBlock.md#willbegeneratedintovertexshaderfromfragmentshader)
- [x](TwirlBlock.md#x)
- [y](TwirlBlock.md#y)

### Methods

- [\_buildBlock](TwirlBlock.md#_buildblock)
- [\_declareOutput](TwirlBlock.md#_declareoutput)
- [\_dumpPropertiesCode](TwirlBlock.md#_dumppropertiescode)
- [\_inputRename](TwirlBlock.md#_inputrename)
- [\_linkConnectionTypes](TwirlBlock.md#_linkconnectiontypes)
- [\_outputRename](TwirlBlock.md#_outputrename)
- [\_writeFloat](TwirlBlock.md#_writefloat)
- [\_writeVariable](TwirlBlock.md#_writevariable)
- [autoConfigure](TwirlBlock.md#autoconfigure)
- [bind](TwirlBlock.md#bind)
- [build](TwirlBlock.md#build)
- [clone](TwirlBlock.md#clone)
- [connectTo](TwirlBlock.md#connectto)
- [dispose](TwirlBlock.md#dispose)
- [getClassName](TwirlBlock.md#getclassname)
- [getFirstAvailableInput](TwirlBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](TwirlBlock.md#getfirstavailableoutput)
- [getInputByName](TwirlBlock.md#getinputbyname)
- [getOutputByName](TwirlBlock.md#getoutputbyname)
- [getSiblingOutput](TwirlBlock.md#getsiblingoutput)
- [initialize](TwirlBlock.md#initialize)
- [initializeDefines](TwirlBlock.md#initializedefines)
- [isAnAncestorOf](TwirlBlock.md#isanancestorof)
- [isReady](TwirlBlock.md#isready)
- [prepareDefines](TwirlBlock.md#preparedefines)
- [provideFallbacks](TwirlBlock.md#providefallbacks)
- [registerInput](TwirlBlock.md#registerinput)
- [registerOutput](TwirlBlock.md#registeroutput)
- [replaceRepeatableContent](TwirlBlock.md#replacerepeatablecontent)
- [serialize](TwirlBlock.md#serialize)
- [updateUniformsAndSamples](TwirlBlock.md#updateuniformsandsamples)
- [validateBlockName](TwirlBlock.md#validateblockname)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/twirlBlock.ts:18
...
• `get` **center**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/twirlBlock.ts:55
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/twirlBlock.ts:41
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/twirlBlock.ts:62
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/twirlBlock.ts:69
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/twirlBlock.ts:48
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/twirlBlock.ts:76
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/twirlBlock.ts:83

## Methods

### \_buildBlock

▸ `Protected` **_buildBlock**(`state`): [`TwirlBlock`](TwirlBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/twirlBlock.ts:110
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/twirlBlock.ts:87
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`TwirlBlock`](TwirlBlock.md)
...
`undefined` \| [`TwirlBlock`](TwirlBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/twirlBlock.ts:34
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`TwirlBlock`](TwirlBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`TwirlBlock`](TwirlBlock.md)
