[@dev/core](../README.md) / [Exports](../modules.md) / ParticleBlendMultiplyBlock
...
- [constructor](ParticleBlendMultiplyBlock.md#constructor)

### Properties

- [\_isUnique](ParticleBlendMultiplyBlock.md#_isunique)
- [\_target](ParticleBlendMultiplyBlock.md#_target)
- [comments](ParticleBlendMultiplyBlock.md#comments)
- [inputsAreExclusive](ParticleBlendMultiplyBlock.md#inputsareexclusive)
- [uniqueId](ParticleBlendMultiplyBlock.md#uniqueid)
- [visibleInInspector](ParticleBlendMultiplyBlock.md#visibleininspector)
- [visibleOnFrame](ParticleBlendMultiplyBlock.md#visibleonframe)

### Accessors

- [alphaColor](ParticleBlendMultiplyBlock.md#alphacolor)
- [alphaTexture](ParticleBlendMultiplyBlock.md#alphatexture)
- [blendColor](ParticleBlendMultiplyBlock.md#blendcolor)
- [buildId](ParticleBlendMultiplyBlock.md#buildid)
- [color](ParticleBlendMultiplyBlock.md#color)
- [inputs](ParticleBlendMultiplyBlock.md#inputs)
- [isFinalMerger](ParticleBlendMultiplyBlock.md#isfinalmerger)
- [isInput](ParticleBlendMultiplyBlock.md#isinput)
- [isUnique](ParticleBlendMultiplyBlock.md#isunique)
- [name](ParticleBlendMultiplyBlock.md#name)
- [outputs](ParticleBlendMultiplyBlock.md#outputs)
- [target](ParticleBlendMultiplyBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](ParticleBlendMultiplyBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](ParticleBlendMultiplyBlock.md#_buildblock)
- [\_declareOutput](ParticleBlendMultiplyBlock.md#_declareoutput)
- [\_dumpPropertiesCode](ParticleBlendMultiplyBlock.md#_dumppropertiescode)
- [\_inputRename](ParticleBlendMultiplyBlock.md#_inputrename)
- [\_linkConnectionTypes](ParticleBlendMultiplyBlock.md#_linkconnectiontypes)
- [\_outputRename](ParticleBlendMultiplyBlock.md#_outputrename)
- [\_writeFloat](ParticleBlendMultiplyBlock.md#_writefloat)
- [\_writeVariable](ParticleBlendMultiplyBlock.md#_writevariable)
- [autoConfigure](ParticleBlendMultiplyBlock.md#autoconfigure)
- [bind](ParticleBlendMultiplyBlock.md#bind)
- [build](ParticleBlendMultiplyBlock.md#build)
- [clone](ParticleBlendMultiplyBlock.md#clone)
- [connectTo](ParticleBlendMultiplyBlock.md#connectto)
- [dispose](ParticleBlendMultiplyBlock.md#dispose)
- [getClassName](ParticleBlendMultiplyBlock.md#getclassname)
- [getFirstAvailableInput](ParticleBlendMultiplyBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](ParticleBlendMultiplyBlock.md#getfirstavailableoutput)
- [getInputByName](ParticleBlendMultiplyBlock.md#getinputbyname)
- [getOutputByName](ParticleBlendMultiplyBlock.md#getoutputbyname)
- [getSiblingOutput](ParticleBlendMultiplyBlock.md#getsiblingoutput)
- [initialize](ParticleBlendMultiplyBlock.md#initialize)
- [initializeDefines](ParticleBlendMultiplyBlock.md#initializedefines)
- [isAnAncestorOf](ParticleBlendMultiplyBlock.md#isanancestorof)
- [isReady](ParticleBlendMultiplyBlock.md#isready)
- [prepareDefines](ParticleBlendMultiplyBlock.md#preparedefines)
- [provideFallbacks](ParticleBlendMultiplyBlock.md#providefallbacks)
- [registerInput](ParticleBlendMultiplyBlock.md#registerinput)
- [registerOutput](ParticleBlendMultiplyBlock.md#registeroutput)
- [replaceRepeatableContent](ParticleBlendMultiplyBlock.md#replacerepeatablecontent)
- [serialize](ParticleBlendMultiplyBlock.md#serialize)
- [updateUniformsAndSamples](ParticleBlendMultiplyBlock.md#updateuniformsandsamples)
- [validateBlockName](ParticleBlendMultiplyBlock.md#validateblockname)

## Constructors

### constructor

• **new ParticleBlendMultiplyBlock**(`name`)
...
packages/dev/core/src/Materials/Node/Blocks/Particle/particleBlendMultiplyBlock.ts:16
...
• `get` **alphaColor**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/Particle/particleBlendMultiplyBlock.ts:53

___

### alphaTexture

• `get` **alphaTexture**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/Particle/particleBlendMultiplyBlock.ts:46

___

### blendColor

• `get` **blendColor**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/Particle/particleBlendMultiplyBlock.ts:60
...
packages/dev/core/src/Materials/Node/Blocks/Particle/particleBlendMultiplyBlock.ts:39
...
▸ `Protected` **_buildBlock**(`state`): `undefined` \| [`ParticleBlendMultiplyBlock`](ParticleBlendMultiplyBlock.md)
...
`undefined` \| [`ParticleBlendMultiplyBlock`](ParticleBlendMultiplyBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/Particle/particleBlendMultiplyBlock.ts:72
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`ParticleBlendMultiplyBlock`](ParticleBlendMultiplyBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/Particle/particleBlendMultiplyBlock.ts:32
...
packages/dev/core/src/Materials/Node/Blocks/Particle/particleBlendMultiplyBlock.ts:68
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`ParticleBlendMultiplyBlock`](ParticleBlendMultiplyBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`ParticleBlendMultiplyBlock`](ParticleBlendMultiplyBlock.md)
