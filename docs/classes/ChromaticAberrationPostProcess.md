[@dev/core](../README.md) / [Exports](../modules.md) / ChromaticAberrationPostProcess
...
- [constructor](ChromaticAberrationPostProcess.md#constructor)

### Properties

- [\_indexParameters](ChromaticAberrationPostProcess.md#_indexparameters)
- [\_postProcessDefines](ChromaticAberrationPostProcess.md#_postprocessdefines)
- [\_scene](ChromaticAberrationPostProcess.md#_scene)
- [aberrationAmount](ChromaticAberrationPostProcess.md#aberrationamount)
- [adaptScaleToCurrentViewport](ChromaticAberrationPostProcess.md#adaptscaletocurrentviewport)
- [alphaConstants](ChromaticAberrationPostProcess.md#alphaconstants)
- [alphaMode](ChromaticAberrationPostProcess.md#alphamode)
- [alwaysForcePOT](ChromaticAberrationPostProcess.md#alwaysforcepot)
- [animations](ChromaticAberrationPostProcess.md#animations)
- [autoClear](ChromaticAberrationPostProcess.md#autoclear)
- [centerPosition](ChromaticAberrationPostProcess.md#centerposition)
- [clearColor](ChromaticAberrationPostProcess.md#clearcolor)
- [direction](ChromaticAberrationPostProcess.md#direction)
- [enablePixelPerfectMode](ChromaticAberrationPostProcess.md#enablepixelperfectmode)
- [externalTextureSamplerBinding](ChromaticAberrationPostProcess.md#externaltexturesamplerbinding)
- [forceFullscreenViewport](ChromaticAberrationPostProcess.md#forcefullscreenviewport)
- [height](ChromaticAberrationPostProcess.md#height)
- [inspectableCustomProperties](ChromaticAberrationPostProcess.md#inspectablecustomproperties)
- [name](ChromaticAberrationPostProcess.md#name)
- [nodeMaterialSource](ChromaticAberrationPostProcess.md#nodematerialsource)
- [onActivateObservable](ChromaticAberrationPostProcess.md#onactivateobservable)
- [onAfterRenderObservable](ChromaticAberrationPostProcess.md#onafterrenderobservable)
- [onApplyObservable](ChromaticAberrationPostProcess.md#onapplyobservable)
- [onBeforeRenderObservable](ChromaticAberrationPostProcess.md#onbeforerenderobservable)
- [onSizeChangedObservable](ChromaticAberrationPostProcess.md#onsizechangedobservable)
- [radialIntensity](ChromaticAberrationPostProcess.md#radialintensity)
- [renderTargetSamplingMode](ChromaticAberrationPostProcess.md#rendertargetsamplingmode)
- [scaleMode](ChromaticAberrationPostProcess.md#scalemode)
- [screenHeight](ChromaticAberrationPostProcess.md#screenheight)
- [screenWidth](ChromaticAberrationPostProcess.md#screenwidth)
- [uniqueId](ChromaticAberrationPostProcess.md#uniqueid)
- [width](ChromaticAberrationPostProcess.md#width)

### Accessors

- [aspectRatio](ChromaticAberrationPostProcess.md#aspectratio)
- [inputTexture](ChromaticAberrationPostProcess.md#inputtexture)
- [isSupported](ChromaticAberrationPostProcess.md#issupported)
- [onActivate](ChromaticAberrationPostProcess.md#onactivate)
- [onAfterRender](ChromaticAberrationPostProcess.md#onafterrender)
- [onApply](ChromaticAberrationPostProcess.md#onapply)
- [onBeforeRender](ChromaticAberrationPostProcess.md#onbeforerender)
- [onSizeChanged](ChromaticAberrationPostProcess.md#onsizechanged)
- [samples](ChromaticAberrationPostProcess.md#samples)
- [texelSize](ChromaticAberrationPostProcess.md#texelsize)

### Methods

- [activate](ChromaticAberrationPostProcess.md#activate)
- [apply](ChromaticAberrationPostProcess.md#apply)
- [clone](ChromaticAberrationPostProcess.md#clone)
- [dispose](ChromaticAberrationPostProcess.md#dispose)
- [getCamera](ChromaticAberrationPostProcess.md#getcamera)
- [getClassName](ChromaticAberrationPostProcess.md#getclassname)
- [getEffect](ChromaticAberrationPostProcess.md#geteffect)
- [getEffectName](ChromaticAberrationPostProcess.md#geteffectname)
- [getEngine](ChromaticAberrationPostProcess.md#getengine)
- [isReady](ChromaticAberrationPostProcess.md#isready)
- [isReusable](ChromaticAberrationPostProcess.md#isreusable)
- [markTextureDirty](ChromaticAberrationPostProcess.md#marktexturedirty)
- [restoreDefaultInputTexture](ChromaticAberrationPostProcess.md#restoredefaultinputtexture)
- [serialize](ChromaticAberrationPostProcess.md#serialize)
- [setPrePassRenderer](ChromaticAberrationPostProcess.md#setprepassrenderer)
- [shareOutputWith](ChromaticAberrationPostProcess.md#shareoutputwith)
- [updateEffect](ChromaticAberrationPostProcess.md#updateeffect)
- [useOwnOutput](ChromaticAberrationPostProcess.md#useownoutput)
- [Parse](ChromaticAberrationPostProcess.md#parse)

## Constructors

### constructor

• **new ChromaticAberrationPostProcess**(`name`, `screenWidth`, `screenHeight`, `options`, `camera`, `samplingMode?`, `engine?`, `reusable?`, `textureType?`, `blockCompilation?`)
...
| `screenWidth` | `number` | `undefined` | The width of the screen to apply the effect on. |
| `screenHeight` | `number` | `undefined` | The height of the screen to apply the effect on. |
...
https://github.com/babylon.js/core/src/PostProcesses/chromaticAberrationPostProcess.ts:73
...
https://github.com/babylon.js/core/src/PostProcesses/chromaticAberrationPostProcess.ts:24
...
https://github.com/babylon.js/core/src/PostProcesses/chromaticAberrationPostProcess.ts:42
...
https://github.com/babylon.js/core/src/PostProcesses/chromaticAberrationPostProcess.ts:36
...
https://github.com/babylon.js/core/src/PostProcesses/chromaticAberrationPostProcess.ts:30
...
https://github.com/babylon.js/core/src/PostProcesses/chromaticAberrationPostProcess.ts:50
...
https://github.com/babylon.js/core/src/PostProcesses/chromaticAberrationPostProcess.ts:46
...
"ChromaticAberrationPostProcess" string
...
https://github.com/babylon.js/core/src/PostProcesses/chromaticAberrationPostProcess.ts:56
