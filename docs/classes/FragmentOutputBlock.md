[@dev/core](../README.md) / [Exports](../modules.md) / FragmentOutputBlock
...
- [constructor](FragmentOutputBlock.md#constructor)

### Properties

- [\_gammaDefineName](FragmentOutputBlock.md#_gammadefinename)
- [\_isUnique](FragmentOutputBlock.md#_isunique)
- [\_linearDefineName](FragmentOutputBlock.md#_lineardefinename)
- [\_target](FragmentOutputBlock.md#_target)
- [comments](FragmentOutputBlock.md#comments)
- [convertToGammaSpace](FragmentOutputBlock.md#converttogammaspace)
- [convertToLinearSpace](FragmentOutputBlock.md#converttolinearspace)
- [inputsAreExclusive](FragmentOutputBlock.md#inputsareexclusive)
- [uniqueId](FragmentOutputBlock.md#uniqueid)
- [useLogarithmicDepth](FragmentOutputBlock.md#uselogarithmicdepth)
- [visibleInInspector](FragmentOutputBlock.md#visibleininspector)
- [visibleOnFrame](FragmentOutputBlock.md#visibleonframe)

### Accessors

- [a](FragmentOutputBlock.md#a)
- [buildId](FragmentOutputBlock.md#buildid)
- [inputs](FragmentOutputBlock.md#inputs)
- [isFinalMerger](FragmentOutputBlock.md#isfinalmerger)
- [isInput](FragmentOutputBlock.md#isinput)
- [isUnique](FragmentOutputBlock.md#isunique)
- [name](FragmentOutputBlock.md#name)
- [outputs](FragmentOutputBlock.md#outputs)
- [rgb](FragmentOutputBlock.md#rgb)
- [rgba](FragmentOutputBlock.md#rgba)
- [target](FragmentOutputBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](FragmentOutputBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](FragmentOutputBlock.md#_buildblock)
- [\_declareOutput](FragmentOutputBlock.md#_declareoutput)
- [\_deserialize](FragmentOutputBlock.md#_deserialize)
- [\_dumpPropertiesCode](FragmentOutputBlock.md#_dumppropertiescode)
- [\_inputRename](FragmentOutputBlock.md#_inputrename)
- [\_linkConnectionTypes](FragmentOutputBlock.md#_linkconnectiontypes)
- [\_outputRename](FragmentOutputBlock.md#_outputrename)
- [\_writeFloat](FragmentOutputBlock.md#_writefloat)
- [\_writeVariable](FragmentOutputBlock.md#_writevariable)
- [autoConfigure](FragmentOutputBlock.md#autoconfigure)
- [bind](FragmentOutputBlock.md#bind)
- [build](FragmentOutputBlock.md#build)
- [clone](FragmentOutputBlock.md#clone)
- [connectTo](FragmentOutputBlock.md#connectto)
- [dispose](FragmentOutputBlock.md#dispose)
- [getClassName](FragmentOutputBlock.md#getclassname)
- [getFirstAvailableInput](FragmentOutputBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](FragmentOutputBlock.md#getfirstavailableoutput)
- [getInputByName](FragmentOutputBlock.md#getinputbyname)
- [getOutputByName](FragmentOutputBlock.md#getoutputbyname)
- [getSiblingOutput](FragmentOutputBlock.md#getsiblingoutput)
- [initialize](FragmentOutputBlock.md#initialize)
- [initializeDefines](FragmentOutputBlock.md#initializedefines)
- [isAnAncestorOf](FragmentOutputBlock.md#isanancestorof)
- [isReady](FragmentOutputBlock.md#isready)
- [prepareDefines](FragmentOutputBlock.md#preparedefines)
- [provideFallbacks](FragmentOutputBlock.md#providefallbacks)
- [registerInput](FragmentOutputBlock.md#registerinput)
- [registerOutput](FragmentOutputBlock.md#registeroutput)
- [replaceRepeatableContent](FragmentOutputBlock.md#replacerepeatablecontent)
- [serialize](FragmentOutputBlock.md#serialize)
- [updateUniformsAndSamples](FragmentOutputBlock.md#updateuniformsandsamples)
- [validateBlockName](FragmentOutputBlock.md#validateblockname)

## Constructors

### constructor

• **new FragmentOutputBlock**(`name`)
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/fragmentOutputBlock.ts:28
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/fragmentOutputBlock.ts:22
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/fragmentOutputBlock.ts:21
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/fragmentOutputBlock.ts:40
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/fragmentOutputBlock.ts:44
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/fragmentOutputBlock.ts:48
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/fragmentOutputBlock.ts:84
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/fragmentOutputBlock.ts:77
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/fragmentOutputBlock.ts:70
...
▸ `Protected` **_buildBlock**(`state`): [`FragmentOutputBlock`](FragmentOutputBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/fragmentOutputBlock.ts:99
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/fragmentOutputBlock.ts:175
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/fragmentOutputBlock.ts:156
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/fragmentOutputBlock.ts:93
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`FragmentOutputBlock`](FragmentOutputBlock.md)
...
`undefined` \| [`FragmentOutputBlock`](FragmentOutputBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/fragmentOutputBlock.ts:54
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/fragmentOutputBlock.ts:62
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/fragmentOutputBlock.ts:88
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`FragmentOutputBlock`](FragmentOutputBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`FragmentOutputBlock`](FragmentOutputBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/Fragment/fragmentOutputBlock.ts:165
