[@dev/core](../README.md) / [Exports](../modules.md) / RemapBlock
...
- [constructor](RemapBlock.md#constructor)

### Properties

- [\_isUnique](RemapBlock.md#_isunique)
- [\_target](RemapBlock.md#_target)
- [comments](RemapBlock.md#comments)
- [inputsAreExclusive](RemapBlock.md#inputsareexclusive)
- [sourceRange](RemapBlock.md#sourcerange)
- [targetRange](RemapBlock.md#targetrange)
- [uniqueId](RemapBlock.md#uniqueid)
- [visibleInInspector](RemapBlock.md#visibleininspector)
- [visibleOnFrame](RemapBlock.md#visibleonframe)

### Accessors

- [buildId](RemapBlock.md#buildid)
- [input](RemapBlock.md#input)
- [inputs](RemapBlock.md#inputs)
- [isFinalMerger](RemapBlock.md#isfinalmerger)
- [isInput](RemapBlock.md#isinput)
- [isUnique](RemapBlock.md#isunique)
- [name](RemapBlock.md#name)
- [output](RemapBlock.md#output)
- [outputs](RemapBlock.md#outputs)
- [sourceMax](RemapBlock.md#sourcemax)
- [sourceMin](RemapBlock.md#sourcemin)
- [target](RemapBlock.md#target)
- [targetMax](RemapBlock.md#targetmax)
- [targetMin](RemapBlock.md#targetmin)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](RemapBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](RemapBlock.md#_buildblock)
- [\_declareOutput](RemapBlock.md#_declareoutput)
- [\_deserialize](RemapBlock.md#_deserialize)
- [\_dumpPropertiesCode](RemapBlock.md#_dumppropertiescode)
- [\_inputRename](RemapBlock.md#_inputrename)
- [\_linkConnectionTypes](RemapBlock.md#_linkconnectiontypes)
- [\_outputRename](RemapBlock.md#_outputrename)
- [\_writeFloat](RemapBlock.md#_writefloat)
- [\_writeVariable](RemapBlock.md#_writevariable)
- [autoConfigure](RemapBlock.md#autoconfigure)
- [bind](RemapBlock.md#bind)
- [build](RemapBlock.md#build)
- [clone](RemapBlock.md#clone)
- [connectTo](RemapBlock.md#connectto)
- [dispose](RemapBlock.md#dispose)
- [getClassName](RemapBlock.md#getclassname)
- [getFirstAvailableInput](RemapBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](RemapBlock.md#getfirstavailableoutput)
- [getInputByName](RemapBlock.md#getinputbyname)
- [getOutputByName](RemapBlock.md#getoutputbyname)
- [getSiblingOutput](RemapBlock.md#getsiblingoutput)
- [initialize](RemapBlock.md#initialize)
- [initializeDefines](RemapBlock.md#initializedefines)
- [isAnAncestorOf](RemapBlock.md#isanancestorof)
- [isReady](RemapBlock.md#isready)
- [prepareDefines](RemapBlock.md#preparedefines)
- [provideFallbacks](RemapBlock.md#providefallbacks)
- [registerInput](RemapBlock.md#registerinput)
- [registerOutput](RemapBlock.md#registeroutput)
- [replaceRepeatableContent](RemapBlock.md#replacerepeatablecontent)
- [serialize](RemapBlock.md#serialize)
- [updateUniformsAndSamples](RemapBlock.md#updateuniformsandsamples)
- [validateBlockName](RemapBlock.md#validateblockname)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/remapBlock.ts:30
...
• **sourceRange**: [`Vector2`](Vector2.md)

Gets or sets the source range

#### Defined in

https://github.com/babylon.js/core/src/Materials/Node/Blocks/remapBlock.ts:18

___

### targetRange

• **targetRange**: [`Vector2`](Vector2.md)

Gets or sets the target range

#### Defined in

https://github.com/babylon.js/core/src/Materials/Node/Blocks/remapBlock.ts:24
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/remapBlock.ts:55
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/remapBlock.ts:90
...
• `get` **sourceMax**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/remapBlock.ts:69

___

### sourceMin

• `get` **sourceMin**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/remapBlock.ts:62
...
• `get` **targetMax**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/remapBlock.ts:83

___

### targetMin

• `get` **targetMin**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/remapBlock.ts:76
...
▸ `Protected` **_buildBlock**(`state`): [`RemapBlock`](RemapBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/remapBlock.ts:94
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/remapBlock.ts:129
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/remapBlock.ts:112
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`RemapBlock`](RemapBlock.md)
...
`undefined` \| [`RemapBlock`](RemapBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/remapBlock.ts:48
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`RemapBlock`](RemapBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`RemapBlock`](RemapBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/remapBlock.ts:120
