[@dev/core](../README.md) / [Exports](../modules.md) / CustomBlock
...
- [constructor](CustomBlock.md#constructor)

### Properties

- [\_code](CustomBlock.md#_code)
- [\_isUnique](CustomBlock.md#_isunique)
- [\_options](CustomBlock.md#_options)
- [\_target](CustomBlock.md#_target)
- [comments](CustomBlock.md#comments)
- [inputsAreExclusive](CustomBlock.md#inputsareexclusive)
- [uniqueId](CustomBlock.md#uniqueid)
- [visibleInInspector](CustomBlock.md#visibleininspector)
- [visibleOnFrame](CustomBlock.md#visibleonframe)

### Accessors

- [buildId](CustomBlock.md#buildid)
- [inputs](CustomBlock.md#inputs)
- [isFinalMerger](CustomBlock.md#isfinalmerger)
- [isInput](CustomBlock.md#isinput)
- [isUnique](CustomBlock.md#isunique)
- [name](CustomBlock.md#name)
- [options](CustomBlock.md#options)
- [outputs](CustomBlock.md#outputs)
- [target](CustomBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](CustomBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](CustomBlock.md#_buildblock)
- [\_declareOutput](CustomBlock.md#_declareoutput)
- [\_deserialize](CustomBlock.md#_deserialize)
- [\_deserializeOptions](CustomBlock.md#_deserializeoptions)
- [\_dumpPropertiesCode](CustomBlock.md#_dumppropertiescode)
- [\_findInputByName](CustomBlock.md#_findinputbyname)
- [\_inputRename](CustomBlock.md#_inputrename)
- [\_linkConnectionTypes](CustomBlock.md#_linkconnectiontypes)
- [\_outputRename](CustomBlock.md#_outputrename)
- [\_writeFloat](CustomBlock.md#_writefloat)
- [\_writeVariable](CustomBlock.md#_writevariable)
- [autoConfigure](CustomBlock.md#autoconfigure)
- [bind](CustomBlock.md#bind)
- [build](CustomBlock.md#build)
- [clone](CustomBlock.md#clone)
- [connectTo](CustomBlock.md#connectto)
- [dispose](CustomBlock.md#dispose)
- [getClassName](CustomBlock.md#getclassname)
- [getFirstAvailableInput](CustomBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](CustomBlock.md#getfirstavailableoutput)
- [getInputByName](CustomBlock.md#getinputbyname)
- [getOutputByName](CustomBlock.md#getoutputbyname)
- [getSiblingOutput](CustomBlock.md#getsiblingoutput)
- [initialize](CustomBlock.md#initialize)
- [initializeDefines](CustomBlock.md#initializedefines)
- [isAnAncestorOf](CustomBlock.md#isanancestorof)
- [isReady](CustomBlock.md#isready)
- [prepareDefines](CustomBlock.md#preparedefines)
- [provideFallbacks](CustomBlock.md#providefallbacks)
- [registerInput](CustomBlock.md#registerinput)
- [registerOutput](CustomBlock.md#registeroutput)
- [replaceRepeatableContent](CustomBlock.md#replacerepeatablecontent)
- [serialize](CustomBlock.md#serialize)
- [updateUniformsAndSamples](CustomBlock.md#updateuniformsandsamples)
- [validateBlockName](CustomBlock.md#validateblockname)

## Constructors

### constructor

• **new CustomBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/customBlock.ts:32
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/customBlock.ts:15
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/customBlock.ts:14
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/customBlock.ts:20
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/customBlock.ts:24
...
▸ `Protected` **_buildBlock**(`state`): [`CustomBlock`](CustomBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/customBlock.ts:44
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/customBlock.ts:112

___

### \_deserializeOptions

▸ `Private` **_deserializeOptions**(`options`): `void`
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/customBlock.ts:118
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/customBlock.ts:96

___

### \_findInputByName

▸ `Private` **_findInputByName**(`name`): [`Nullable`](../modules.md#nullable)[[`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md), `number`]
...
[`Nullable`](../modules.md#nullable)[[`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md), `number`]

#### Defined in

https://github.com/babylon.js/core/src/Materials/Node/Blocks/customBlock.ts:158
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`CustomBlock`](CustomBlock.md)
...
`undefined` \| [`CustomBlock`](CustomBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/customBlock.ts:40
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`CustomBlock`](CustomBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`CustomBlock`](CustomBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/customBlock.ts:104
