[@dev/core](../README.md) / [Exports](../modules.md) / LinesMesh
...
- [isPickable](LinesMesh.md#ispickable)
...
- [OCCLUSION\_TYPE\_NONE](LinesMesh.md#occlusion_type_none)
...
- [onEnabledStateChangedObservable](LinesMesh.md#onenabledstatechangedobservable)
...
- [disableEdgesRendering](LinesMesh.md#disableedgesrendering)
...
- [instantiateHierarchy](LinesMesh.md#instantiatehierarchy)
...
- [thinInstancePartialBufferUpdate](LinesMesh.md#thininstancepartialbufferupdate)
...
▸ `Private` **_isShaderMaterial**(`shader`): shader is ShaderMaterial

#### Parameters

| Name | Type |
| :------ | :------ |
| `shader` | [`Material`](Material.md) |

#### Returns

shader is ShaderMaterial

#### Defined in

packages/dev/core/src/Meshes/linesMesh.ts:43
...
▸ **clone**(`name`, `newParent?`, `doNotCloneChildren?`): [`LinesMesh`](LinesMesh.md)
...
packages/dev/core/src/Meshes/linesMesh.ts:225
...
▸ **createInstance**(`name`): [`InstancedLinesMesh`](InstancedLinesMesh.md)
...
packages/dev/core/src/Meshes/linesMesh.ts:235
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `doNotRecurse?` | `boolean` | If children should be disposed |
...
packages/dev/core/src/Meshes/linesMesh.ts:214

___

### enableEdgesRendering

▸ **enableEdgesRendering**(`epsilon?`, `checkVerticesInsteadOfIndices?`): [`AbstractMesh`](AbstractMesh.md)
...
packages/dev/core/src/Rendering/edgesRenderer.ts:70
...
packages/dev/core/src/Meshes/linesMesh.ts:130
...
▸ **getFacetNormalToRef**(`i`, `ref`): [`LinesMesh`](LinesMesh.md)
...
packages/dev/core/src/Meshes/linesMesh.ts:119
...
packages/dev/core/src/Meshes/linesMesh.ts:253
...
▸ **unfreezeWorldMatrix**(): [`LinesMesh`](LinesMesh.md)
...
▸ `Static` **Parse**(`parsedMesh`, `scene`): [`LinesMesh`](LinesMesh.md)
...
packages/dev/core/src/Meshes/linesMesh.ts:265
