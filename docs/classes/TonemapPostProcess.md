[@dev/core](../README.md) / [Exports](../modules.md) / TonemapPostProcess
...
- [constructor](TonemapPostProcess.md#constructor)

### Properties

- [\_indexParameters](TonemapPostProcess.md#_indexparameters)
- [\_postProcessDefines](TonemapPostProcess.md#_postprocessdefines)
- [\_scene](TonemapPostProcess.md#_scene)
- [adaptScaleToCurrentViewport](TonemapPostProcess.md#adaptscaletocurrentviewport)
- [alphaConstants](TonemapPostProcess.md#alphaconstants)
- [alphaMode](TonemapPostProcess.md#alphamode)
- [alwaysForcePOT](TonemapPostProcess.md#alwaysforcepot)
- [animations](TonemapPostProcess.md#animations)
- [autoClear](TonemapPostProcess.md#autoclear)
- [clearColor](TonemapPostProcess.md#clearcolor)
- [enablePixelPerfectMode](TonemapPostProcess.md#enablepixelperfectmode)
- [exposureAdjustment](TonemapPostProcess.md#exposureadjustment)
- [externalTextureSamplerBinding](TonemapPostProcess.md#externaltexturesamplerbinding)
- [forceFullscreenViewport](TonemapPostProcess.md#forcefullscreenviewport)
- [height](TonemapPostProcess.md#height)
- [inspectableCustomProperties](TonemapPostProcess.md#inspectablecustomproperties)
- [name](TonemapPostProcess.md#name)
- [nodeMaterialSource](TonemapPostProcess.md#nodematerialsource)
- [onActivateObservable](TonemapPostProcess.md#onactivateobservable)
- [onAfterRenderObservable](TonemapPostProcess.md#onafterrenderobservable)
- [onApplyObservable](TonemapPostProcess.md#onapplyobservable)
- [onBeforeRenderObservable](TonemapPostProcess.md#onbeforerenderobservable)
- [onSizeChangedObservable](TonemapPostProcess.md#onsizechangedobservable)
- [renderTargetSamplingMode](TonemapPostProcess.md#rendertargetsamplingmode)
- [scaleMode](TonemapPostProcess.md#scalemode)
- [uniqueId](TonemapPostProcess.md#uniqueid)
- [width](TonemapPostProcess.md#width)

### Accessors

- [aspectRatio](TonemapPostProcess.md#aspectratio)
- [inputTexture](TonemapPostProcess.md#inputtexture)
- [isSupported](TonemapPostProcess.md#issupported)
- [onActivate](TonemapPostProcess.md#onactivate)
- [onAfterRender](TonemapPostProcess.md#onafterrender)
- [onApply](TonemapPostProcess.md#onapply)
- [onBeforeRender](TonemapPostProcess.md#onbeforerender)
- [onSizeChanged](TonemapPostProcess.md#onsizechanged)
- [samples](TonemapPostProcess.md#samples)
- [texelSize](TonemapPostProcess.md#texelsize)

### Methods

- [activate](TonemapPostProcess.md#activate)
- [apply](TonemapPostProcess.md#apply)
- [clone](TonemapPostProcess.md#clone)
- [dispose](TonemapPostProcess.md#dispose)
- [getCamera](TonemapPostProcess.md#getcamera)
- [getClassName](TonemapPostProcess.md#getclassname)
- [getEffect](TonemapPostProcess.md#geteffect)
- [getEffectName](TonemapPostProcess.md#geteffectname)
- [getEngine](TonemapPostProcess.md#getengine)
- [isReady](TonemapPostProcess.md#isready)
- [isReusable](TonemapPostProcess.md#isreusable)
- [markTextureDirty](TonemapPostProcess.md#marktexturedirty)
- [restoreDefaultInputTexture](TonemapPostProcess.md#restoredefaultinputtexture)
- [serialize](TonemapPostProcess.md#serialize)
- [setPrePassRenderer](TonemapPostProcess.md#setprepassrenderer)
- [shareOutputWith](TonemapPostProcess.md#shareoutputwith)
- [updateEffect](TonemapPostProcess.md#updateeffect)
- [useOwnOutput](TonemapPostProcess.md#useownoutput)
- [Parse](TonemapPostProcess.md#parse)

## Constructors

### constructor

• **new TonemapPostProcess**(`name`, `_operator`, `exposureAdjustment`, `camera`, `samplingMode?`, `engine?`, `textureFormat?`, `reusable?`)
...
| :------ | :------ | :------ | :------ |
| `name` | `string` | `undefined` | defines the name of the postprocess |
| `_operator` | [`TonemappingOperator`](../enums/TonemappingOperator.md) | `undefined` | defines the operator to use |
| `exposureAdjustment` | `number` | `undefined` | defines the required exposure adjustment |
| `camera` | [`Camera`](Camera.md) | `undefined` | defines the camera to use (can be null) |
| `samplingMode` | `number` | `Constants.TEXTURE_BILINEAR_SAMPLINGMODE` | defines the required sampling mode (BABYLON.Texture.BILINEAR_SAMPLINGMODE by default) |
| `engine?` | [`Engine`](Engine.md) | `undefined` | defines the hosting engine (can be ignore if camera is set) |
| `textureFormat` | `number` | `Constants.TEXTURETYPE_UNSIGNED_INT` | defines the texture format to use (BABYLON.Engine.TEXTURETYPE_UNSIGNED_INT by default) |
...
packages/dev/core/src/PostProcesses/tonemapPostProcess.ts:45
...
packages/dev/core/src/PostProcesses/tonemapPostProcess.ts:49
...
packages/dev/core/src/PostProcesses/tonemapPostProcess.ts:30
