[@dev/core](../README.md) / [Exports](../modules.md) / FilterPostProcess
...
- [constructor](FilterPostProcess.md#constructor)

### Properties

- [\_indexParameters](FilterPostProcess.md#_indexparameters)
- [\_postProcessDefines](FilterPostProcess.md#_postprocessdefines)
- [\_scene](FilterPostProcess.md#_scene)
- [adaptScaleToCurrentViewport](FilterPostProcess.md#adaptscaletocurrentviewport)
- [alphaConstants](FilterPostProcess.md#alphaconstants)
- [alphaMode](FilterPostProcess.md#alphamode)
- [alwaysForcePOT](FilterPostProcess.md#alwaysforcepot)
- [animations](FilterPostProcess.md#animations)
- [autoClear](FilterPostProcess.md#autoclear)
- [clearColor](FilterPostProcess.md#clearcolor)
- [enablePixelPerfectMode](FilterPostProcess.md#enablepixelperfectmode)
- [externalTextureSamplerBinding](FilterPostProcess.md#externaltexturesamplerbinding)
- [forceFullscreenViewport](FilterPostProcess.md#forcefullscreenviewport)
- [height](FilterPostProcess.md#height)
- [inspectableCustomProperties](FilterPostProcess.md#inspectablecustomproperties)
- [kernelMatrix](FilterPostProcess.md#kernelmatrix)
- [name](FilterPostProcess.md#name)
- [nodeMaterialSource](FilterPostProcess.md#nodematerialsource)
- [onActivateObservable](FilterPostProcess.md#onactivateobservable)
- [onAfterRenderObservable](FilterPostProcess.md#onafterrenderobservable)
- [onApplyObservable](FilterPostProcess.md#onapplyobservable)
- [onBeforeRenderObservable](FilterPostProcess.md#onbeforerenderobservable)
- [onSizeChangedObservable](FilterPostProcess.md#onsizechangedobservable)
- [renderTargetSamplingMode](FilterPostProcess.md#rendertargetsamplingmode)
- [scaleMode](FilterPostProcess.md#scalemode)
- [uniqueId](FilterPostProcess.md#uniqueid)
- [width](FilterPostProcess.md#width)

### Accessors

- [aspectRatio](FilterPostProcess.md#aspectratio)
- [inputTexture](FilterPostProcess.md#inputtexture)
- [isSupported](FilterPostProcess.md#issupported)
- [onActivate](FilterPostProcess.md#onactivate)
- [onAfterRender](FilterPostProcess.md#onafterrender)
- [onApply](FilterPostProcess.md#onapply)
- [onBeforeRender](FilterPostProcess.md#onbeforerender)
- [onSizeChanged](FilterPostProcess.md#onsizechanged)
- [samples](FilterPostProcess.md#samples)
- [texelSize](FilterPostProcess.md#texelsize)

### Methods

- [activate](FilterPostProcess.md#activate)
- [apply](FilterPostProcess.md#apply)
- [clone](FilterPostProcess.md#clone)
- [dispose](FilterPostProcess.md#dispose)
- [getCamera](FilterPostProcess.md#getcamera)
- [getClassName](FilterPostProcess.md#getclassname)
- [getEffect](FilterPostProcess.md#geteffect)
- [getEffectName](FilterPostProcess.md#geteffectname)
- [getEngine](FilterPostProcess.md#getengine)
- [isReady](FilterPostProcess.md#isready)
- [isReusable](FilterPostProcess.md#isreusable)
- [markTextureDirty](FilterPostProcess.md#marktexturedirty)
- [restoreDefaultInputTexture](FilterPostProcess.md#restoredefaultinputtexture)
- [serialize](FilterPostProcess.md#serialize)
- [setPrePassRenderer](FilterPostProcess.md#setprepassrenderer)
- [shareOutputWith](FilterPostProcess.md#shareoutputwith)
- [updateEffect](FilterPostProcess.md#updateeffect)
- [useOwnOutput](FilterPostProcess.md#useownoutput)
- [Parse](FilterPostProcess.md#parse)

## Constructors

### constructor

• **new FilterPostProcess**(`name`, `kernelMatrix`, `options`, `camera`, `samplingMode?`, `engine?`, `reusable?`)
...
| `kernelMatrix` | [`Matrix`](Matrix.md) | The matrix to be applied to the image |
...
https://github.com/babylon.js/core/src/PostProcesses/filterPostProcess.ts:41
...
• **kernelMatrix**: [`Matrix`](Matrix.md)

The matrix to be applied to the image

#### Defined in

https://github.com/babylon.js/core/src/PostProcesses/filterPostProcess.ts:21
...
https://github.com/babylon.js/core/src/PostProcesses/filterPostProcess.ts:27
