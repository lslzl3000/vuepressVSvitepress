[@dev/core](../README.md) / [Exports](../modules.md) / GoldbergMesh
...
- [occlusionQueryAlgorithmType](GoldbergMesh.md#occlusionqueryalgorithmtype)
...
- [partitioningSubdivisions](GoldbergMesh.md#partitioningsubdivisions)
...
- [enableEdgesRendering](GoldbergMesh.md#enableedgesrendering)
...
- [intersectsPoint](GoldbergMesh.md#intersectspoint)
...
- [thinInstanceGetWorldMatrices](GoldbergMesh.md#thininstancegetworldmatrices)
...
▸ `Private` **_changeGoldbergFaceColors**(`colorRange`): `number`[]

#### Parameters

| Name | Type |
| :------ | :------ |
| `colorRange` | (`number` \| [`Color4`](Color4.md))[][] |
...
packages/dev/core/src/Meshes/goldbergMesh.ts:107

___

### \_changeGoldbergFaceUVs

▸ `Private` **_changeGoldbergFaceUVs**(`uvRange`): [`FloatArray`](../modules.md#floatarray)

#### Parameters

| Name | Type |
| :------ | :------ |
| `uvRange` | (`number` \| [`Vector2`](Vector2.md))[][] |
...
packages/dev/core/src/Meshes/goldbergMesh.ts:149
...
packages/dev/core/src/Meshes/mesh.ts:754
...
▸ **getFacetNormalToRef**(`i`, `ref`): [`GoldbergMesh`](GoldbergMesh.md)
...
### placeOnGoldbergFaceAt

▸ **placeOnGoldbergFaceAt**(`mesh`, `face`, `position`): `void`
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `mesh` | [`Mesh`](Mesh.md) | Defines the mesh to position |
| `face` | `number` | Defines the face to position onto |
| `position` | [`Vector3`](Vector3.md) | Defines the position relative to the face we are positioning the mesh onto |
...
packages/dev/core/src/Meshes/goldbergMesh.ts:224
...
▸ **relatedGoldbergFace**(`poleOrShared`, `fromPole?`): `number`
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `poleOrShared` | `number` | Defines the pole index or the shared face index if the fromPole parameter is passed in |
| `fromPole?` | `number` | Defines an optional pole index to find the related info from |

#### Returns

`number`

the goldberg face number

#### Defined in

packages/dev/core/src/Meshes/goldbergMesh.ts:87
...
packages/dev/core/src/Meshes/goldbergMesh.ts:237
...
▸ **setGoldbergFaceColors**(`colorRange`): `void`
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `colorRange` | (`number` \| [`Color4`](Color4.md))[][] | the new color to apply to the mesh |
...
packages/dev/core/src/Meshes/goldbergMesh.ts:135

___

### setGoldbergFaceUVs

▸ **setGoldbergFaceUVs**(`uvRange`): `void`
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `uvRange` | (`number` \| [`Vector2`](Vector2.md))[][] | the new UVs to apply to the mesh |
...
packages/dev/core/src/Meshes/goldbergMesh.ts:204
...
▸ **unfreezeWorldMatrix**(): [`GoldbergMesh`](GoldbergMesh.md)
...
▸ **updateGoldbergFaceColors**(`colorRange`): `void`
...
packages/dev/core/src/Meshes/goldbergMesh.ts:144

___

### updateGoldbergFaceUVs

▸ **updateGoldbergFaceUVs**(`uvRange`): `void`
...
packages/dev/core/src/Meshes/goldbergMesh.ts:213
...
▸ `Static` **Parse**(`parsedMesh`, `scene`): [`GoldbergMesh`](GoldbergMesh.md)
...
| `scene` | [`Scene`](Scene.md) | the scene to create the goldberg mesh in |

#### Returns

[`GoldbergMesh`](GoldbergMesh.md)

the created goldberg mesh
...
packages/dev/core/src/Meshes/goldbergMesh.ts:288
