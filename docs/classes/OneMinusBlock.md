[@dev/core](../README.md) / [Exports](../modules.md) / OneMinusBlock
...
- [constructor](OneMinusBlock.md#constructor)

### Properties

- [\_isUnique](OneMinusBlock.md#_isunique)
- [\_target](OneMinusBlock.md#_target)
- [comments](OneMinusBlock.md#comments)
- [inputsAreExclusive](OneMinusBlock.md#inputsareexclusive)
- [uniqueId](OneMinusBlock.md#uniqueid)
- [visibleInInspector](OneMinusBlock.md#visibleininspector)
- [visibleOnFrame](OneMinusBlock.md#visibleonframe)

### Accessors

- [buildId](OneMinusBlock.md#buildid)
- [input](OneMinusBlock.md#input)
- [inputs](OneMinusBlock.md#inputs)
- [isFinalMerger](OneMinusBlock.md#isfinalmerger)
- [isInput](OneMinusBlock.md#isinput)
- [isUnique](OneMinusBlock.md#isunique)
- [name](OneMinusBlock.md#name)
- [output](OneMinusBlock.md#output)
- [outputs](OneMinusBlock.md#outputs)
- [target](OneMinusBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](OneMinusBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](OneMinusBlock.md#_buildblock)
- [\_declareOutput](OneMinusBlock.md#_declareoutput)
- [\_dumpPropertiesCode](OneMinusBlock.md#_dumppropertiescode)
- [\_inputRename](OneMinusBlock.md#_inputrename)
- [\_linkConnectionTypes](OneMinusBlock.md#_linkconnectiontypes)
- [\_outputRename](OneMinusBlock.md#_outputrename)
- [\_writeFloat](OneMinusBlock.md#_writefloat)
- [\_writeVariable](OneMinusBlock.md#_writevariable)
- [autoConfigure](OneMinusBlock.md#autoconfigure)
- [bind](OneMinusBlock.md#bind)
- [build](OneMinusBlock.md#build)
- [clone](OneMinusBlock.md#clone)
- [connectTo](OneMinusBlock.md#connectto)
- [dispose](OneMinusBlock.md#dispose)
- [getClassName](OneMinusBlock.md#getclassname)
- [getFirstAvailableInput](OneMinusBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](OneMinusBlock.md#getfirstavailableoutput)
- [getInputByName](OneMinusBlock.md#getinputbyname)
- [getOutputByName](OneMinusBlock.md#getoutputbyname)
- [getSiblingOutput](OneMinusBlock.md#getsiblingoutput)
- [initialize](OneMinusBlock.md#initialize)
- [initializeDefines](OneMinusBlock.md#initializedefines)
- [isAnAncestorOf](OneMinusBlock.md#isanancestorof)
- [isReady](OneMinusBlock.md#isready)
- [prepareDefines](OneMinusBlock.md#preparedefines)
- [provideFallbacks](OneMinusBlock.md#providefallbacks)
- [registerInput](OneMinusBlock.md#registerinput)
- [registerOutput](OneMinusBlock.md#registeroutput)
- [replaceRepeatableContent](OneMinusBlock.md#replacerepeatablecontent)
- [serialize](OneMinusBlock.md#serialize)
- [updateUniformsAndSamples](OneMinusBlock.md#updateuniformsandsamples)
- [validateBlockName](OneMinusBlock.md#validateblockname)

## Constructors

### constructor

• **new OneMinusBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/oneMinusBlock.ts:15
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/oneMinusBlock.ts:36
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/oneMinusBlock.ts:43
...
▸ `Protected` **_buildBlock**(`state`): [`OneMinusBlock`](OneMinusBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/oneMinusBlock.ts:47
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`OneMinusBlock`](OneMinusBlock.md)
...
`undefined` \| [`OneMinusBlock`](OneMinusBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/oneMinusBlock.ts:29
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`OneMinusBlock`](OneMinusBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`OneMinusBlock`](OneMinusBlock.md)
