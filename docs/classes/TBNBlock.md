[@dev/core](../README.md) / [Exports](../modules.md) / TBNBlock
...
- [constructor](TBNBlock.md#constructor)

### Properties

- [\_isUnique](TBNBlock.md#_isunique)
- [\_target](TBNBlock.md#_target)
- [comments](TBNBlock.md#comments)
- [inputsAreExclusive](TBNBlock.md#inputsareexclusive)
- [uniqueId](TBNBlock.md#uniqueid)
- [visibleInInspector](TBNBlock.md#visibleininspector)
- [visibleOnFrame](TBNBlock.md#visibleonframe)

### Accessors

- [TBN](TBNBlock.md#tbn)
- [buildId](TBNBlock.md#buildid)
- [inputs](TBNBlock.md#inputs)
- [isFinalMerger](TBNBlock.md#isfinalmerger)
- [isInput](TBNBlock.md#isinput)
- [isUnique](TBNBlock.md#isunique)
- [name](TBNBlock.md#name)
- [normal](TBNBlock.md#normal)
- [outputs](TBNBlock.md#outputs)
- [tangent](TBNBlock.md#tangent)
- [target](TBNBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](TBNBlock.md#willbegeneratedintovertexshaderfromfragmentshader)
- [world](TBNBlock.md#world)

### Methods

- [\_buildBlock](TBNBlock.md#_buildblock)
- [\_declareOutput](TBNBlock.md#_declareoutput)
- [\_dumpPropertiesCode](TBNBlock.md#_dumppropertiescode)
- [\_inputRename](TBNBlock.md#_inputrename)
- [\_linkConnectionTypes](TBNBlock.md#_linkconnectiontypes)
- [\_outputRename](TBNBlock.md#_outputrename)
- [\_writeFloat](TBNBlock.md#_writefloat)
- [\_writeVariable](TBNBlock.md#_writevariable)
- [autoConfigure](TBNBlock.md#autoconfigure)
- [bind](TBNBlock.md#bind)
- [build](TBNBlock.md#build)
- [clone](TBNBlock.md#clone)
- [connectTo](TBNBlock.md#connectto)
- [dispose](TBNBlock.md#dispose)
- [getClassName](TBNBlock.md#getclassname)
- [getFirstAvailableInput](TBNBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](TBNBlock.md#getfirstavailableoutput)
- [getInputByName](TBNBlock.md#getinputbyname)
- [getOutputByName](TBNBlock.md#getoutputbyname)
- [getSiblingOutput](TBNBlock.md#getsiblingoutput)
- [initialize](TBNBlock.md#initialize)
- [initializeDefines](TBNBlock.md#initializedefines)
- [isAnAncestorOf](TBNBlock.md#isanancestorof)
- [isReady](TBNBlock.md#isready)
- [prepareDefines](TBNBlock.md#preparedefines)
- [provideFallbacks](TBNBlock.md#providefallbacks)
- [registerInput](TBNBlock.md#registerinput)
- [registerOutput](TBNBlock.md#registeroutput)
- [replaceRepeatableContent](TBNBlock.md#replacerepeatablecontent)
- [serialize](TBNBlock.md#serialize)
- [updateUniformsAndSamples](TBNBlock.md#updateuniformsandsamples)
- [validateBlockName](TBNBlock.md#validateblockname)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/TBNBlock.ts:22
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/TBNBlock.ts:82
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/TBNBlock.ts:60
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/TBNBlock.ts:67
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/TBNBlock.ts:86
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/TBNBlock.ts:90
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/TBNBlock.ts:74

## Methods

### \_buildBlock

▸ `Protected` **_buildBlock**(`state`): [`TBNBlock`](TBNBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/TBNBlock.ts:143
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/TBNBlock.ts:92
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`TBNBlock`](TBNBlock.md)
...
`undefined` \| [`TBNBlock`](TBNBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/TBNBlock.ts:42
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/TBNBlock.ts:50
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/TBNBlock.ts:124
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`TBNBlock`](TBNBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`TBNBlock`](TBNBlock.md)
