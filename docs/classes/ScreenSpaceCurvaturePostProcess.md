[@dev/core](../README.md) / [Exports](../modules.md) / ScreenSpaceCurvaturePostProcess
...
- [constructor](ScreenSpaceCurvaturePostProcess.md#constructor)

### Properties

- [\_geometryBufferRenderer](ScreenSpaceCurvaturePostProcess.md#_geometrybufferrenderer)
- [\_indexParameters](ScreenSpaceCurvaturePostProcess.md#_indexparameters)
- [\_postProcessDefines](ScreenSpaceCurvaturePostProcess.md#_postprocessdefines)
- [\_scene](ScreenSpaceCurvaturePostProcess.md#_scene)
- [adaptScaleToCurrentViewport](ScreenSpaceCurvaturePostProcess.md#adaptscaletocurrentviewport)
- [alphaConstants](ScreenSpaceCurvaturePostProcess.md#alphaconstants)
- [alphaMode](ScreenSpaceCurvaturePostProcess.md#alphamode)
- [alwaysForcePOT](ScreenSpaceCurvaturePostProcess.md#alwaysforcepot)
- [animations](ScreenSpaceCurvaturePostProcess.md#animations)
- [autoClear](ScreenSpaceCurvaturePostProcess.md#autoclear)
- [clearColor](ScreenSpaceCurvaturePostProcess.md#clearcolor)
- [enablePixelPerfectMode](ScreenSpaceCurvaturePostProcess.md#enablepixelperfectmode)
- [externalTextureSamplerBinding](ScreenSpaceCurvaturePostProcess.md#externaltexturesamplerbinding)
- [forceFullscreenViewport](ScreenSpaceCurvaturePostProcess.md#forcefullscreenviewport)
- [height](ScreenSpaceCurvaturePostProcess.md#height)
- [inspectableCustomProperties](ScreenSpaceCurvaturePostProcess.md#inspectablecustomproperties)
- [name](ScreenSpaceCurvaturePostProcess.md#name)
- [nodeMaterialSource](ScreenSpaceCurvaturePostProcess.md#nodematerialsource)
- [onActivateObservable](ScreenSpaceCurvaturePostProcess.md#onactivateobservable)
- [onAfterRenderObservable](ScreenSpaceCurvaturePostProcess.md#onafterrenderobservable)
- [onApplyObservable](ScreenSpaceCurvaturePostProcess.md#onapplyobservable)
- [onBeforeRenderObservable](ScreenSpaceCurvaturePostProcess.md#onbeforerenderobservable)
- [onSizeChangedObservable](ScreenSpaceCurvaturePostProcess.md#onsizechangedobservable)
- [renderTargetSamplingMode](ScreenSpaceCurvaturePostProcess.md#rendertargetsamplingmode)
- [ridge](ScreenSpaceCurvaturePostProcess.md#ridge)
- [scaleMode](ScreenSpaceCurvaturePostProcess.md#scalemode)
- [uniqueId](ScreenSpaceCurvaturePostProcess.md#uniqueid)
- [valley](ScreenSpaceCurvaturePostProcess.md#valley)
- [width](ScreenSpaceCurvaturePostProcess.md#width)

### Accessors

- [aspectRatio](ScreenSpaceCurvaturePostProcess.md#aspectratio)
- [inputTexture](ScreenSpaceCurvaturePostProcess.md#inputtexture)
- [isSupported](ScreenSpaceCurvaturePostProcess.md#issupported)
- [onActivate](ScreenSpaceCurvaturePostProcess.md#onactivate)
- [onAfterRender](ScreenSpaceCurvaturePostProcess.md#onafterrender)
- [onApply](ScreenSpaceCurvaturePostProcess.md#onapply)
- [onBeforeRender](ScreenSpaceCurvaturePostProcess.md#onbeforerender)
- [onSizeChanged](ScreenSpaceCurvaturePostProcess.md#onsizechanged)
- [samples](ScreenSpaceCurvaturePostProcess.md#samples)
- [texelSize](ScreenSpaceCurvaturePostProcess.md#texelsize)
- [IsSupported](ScreenSpaceCurvaturePostProcess.md#issupported-1)

### Methods

- [activate](ScreenSpaceCurvaturePostProcess.md#activate)
- [apply](ScreenSpaceCurvaturePostProcess.md#apply)
- [clone](ScreenSpaceCurvaturePostProcess.md#clone)
- [dispose](ScreenSpaceCurvaturePostProcess.md#dispose)
- [getCamera](ScreenSpaceCurvaturePostProcess.md#getcamera)
- [getClassName](ScreenSpaceCurvaturePostProcess.md#getclassname)
- [getEffect](ScreenSpaceCurvaturePostProcess.md#geteffect)
- [getEffectName](ScreenSpaceCurvaturePostProcess.md#geteffectname)
- [getEngine](ScreenSpaceCurvaturePostProcess.md#getengine)
- [isReady](ScreenSpaceCurvaturePostProcess.md#isready)
- [isReusable](ScreenSpaceCurvaturePostProcess.md#isreusable)
- [markTextureDirty](ScreenSpaceCurvaturePostProcess.md#marktexturedirty)
- [restoreDefaultInputTexture](ScreenSpaceCurvaturePostProcess.md#restoredefaultinputtexture)
- [serialize](ScreenSpaceCurvaturePostProcess.md#serialize)
- [setPrePassRenderer](ScreenSpaceCurvaturePostProcess.md#setprepassrenderer)
- [shareOutputWith](ScreenSpaceCurvaturePostProcess.md#shareoutputwith)
- [updateEffect](ScreenSpaceCurvaturePostProcess.md#updateeffect)
- [useOwnOutput](ScreenSpaceCurvaturePostProcess.md#useownoutput)
- [Parse](ScreenSpaceCurvaturePostProcess.md#parse)

## Constructors

### constructor

• **new ScreenSpaceCurvaturePostProcess**(`name`, `scene`, `options`, `camera`, `samplingMode?`, `engine?`, `reusable?`, `textureType?`, `blockCompilation?`)
...
packages/dev/core/src/PostProcesses/screenSpaceCurvaturePostProcess.ts:57

## Properties

### \_geometryBufferRenderer

• `Private` **\_geometryBufferRenderer**: [`Nullable`](../modules.md#nullable)[`GeometryBufferRenderer`](GeometryBufferRenderer.md)

#### Defined in

packages/dev/core/src/PostProcesses/screenSpaceCurvaturePostProcess.ts:35
...
packages/dev/core/src/PostProcesses/screenSpaceCurvaturePostProcess.ts:27
...
packages/dev/core/src/PostProcesses/screenSpaceCurvaturePostProcess.ts:33
...
packages/dev/core/src/PostProcesses/screenSpaceCurvaturePostProcess.ts:105
...
"ScreenSpaceCurvaturePostProcess" string
...
packages/dev/core/src/PostProcesses/screenSpaceCurvaturePostProcess.ts:41
