[@dev/core](../README.md) / [Exports](../modules.md) / ArcTan2Block
...
- [constructor](ArcTan2Block.md#constructor)

### Properties

- [\_isUnique](ArcTan2Block.md#_isunique)
- [\_target](ArcTan2Block.md#_target)
- [comments](ArcTan2Block.md#comments)
- [inputsAreExclusive](ArcTan2Block.md#inputsareexclusive)
- [uniqueId](ArcTan2Block.md#uniqueid)
- [visibleInInspector](ArcTan2Block.md#visibleininspector)
- [visibleOnFrame](ArcTan2Block.md#visibleonframe)

### Accessors

- [buildId](ArcTan2Block.md#buildid)
- [inputs](ArcTan2Block.md#inputs)
- [isFinalMerger](ArcTan2Block.md#isfinalmerger)
- [isInput](ArcTan2Block.md#isinput)
- [isUnique](ArcTan2Block.md#isunique)
- [name](ArcTan2Block.md#name)
- [output](ArcTan2Block.md#output)
- [outputs](ArcTan2Block.md#outputs)
- [target](ArcTan2Block.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](ArcTan2Block.md#willbegeneratedintovertexshaderfromfragmentshader)
- [x](ArcTan2Block.md#x)
- [y](ArcTan2Block.md#y)

### Methods

- [\_buildBlock](ArcTan2Block.md#_buildblock)
- [\_declareOutput](ArcTan2Block.md#_declareoutput)
- [\_dumpPropertiesCode](ArcTan2Block.md#_dumppropertiescode)
- [\_inputRename](ArcTan2Block.md#_inputrename)
- [\_linkConnectionTypes](ArcTan2Block.md#_linkconnectiontypes)
- [\_outputRename](ArcTan2Block.md#_outputrename)
- [\_writeFloat](ArcTan2Block.md#_writefloat)
- [\_writeVariable](ArcTan2Block.md#_writevariable)
- [autoConfigure](ArcTan2Block.md#autoconfigure)
- [bind](ArcTan2Block.md#bind)
- [build](ArcTan2Block.md#build)
- [clone](ArcTan2Block.md#clone)
- [connectTo](ArcTan2Block.md#connectto)
- [dispose](ArcTan2Block.md#dispose)
- [getClassName](ArcTan2Block.md#getclassname)
- [getFirstAvailableInput](ArcTan2Block.md#getfirstavailableinput)
- [getFirstAvailableOutput](ArcTan2Block.md#getfirstavailableoutput)
- [getInputByName](ArcTan2Block.md#getinputbyname)
- [getOutputByName](ArcTan2Block.md#getoutputbyname)
- [getSiblingOutput](ArcTan2Block.md#getsiblingoutput)
- [initialize](ArcTan2Block.md#initialize)
- [initializeDefines](ArcTan2Block.md#initializedefines)
- [isAnAncestorOf](ArcTan2Block.md#isanancestorof)
- [isReady](ArcTan2Block.md#isready)
- [prepareDefines](ArcTan2Block.md#preparedefines)
- [provideFallbacks](ArcTan2Block.md#providefallbacks)
- [registerInput](ArcTan2Block.md#registerinput)
- [registerOutput](ArcTan2Block.md#registeroutput)
- [replaceRepeatableContent](ArcTan2Block.md#replacerepeatablecontent)
- [serialize](ArcTan2Block.md#serialize)
- [updateUniformsAndSamples](ArcTan2Block.md#updateuniformsandsamples)
- [validateBlockName](ArcTan2Block.md#validateblockname)

## Constructors

### constructor

• **new ArcTan2Block**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/arcTan2Block.ts:15
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/arcTan2Block.ts:48
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/arcTan2Block.ts:34
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/arcTan2Block.ts:41

## Methods

### \_buildBlock

▸ `Protected` **_buildBlock**(`state`): [`ArcTan2Block`](ArcTan2Block.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/arcTan2Block.ts:52
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`ArcTan2Block`](ArcTan2Block.md)
...
`undefined` \| [`ArcTan2Block`](ArcTan2Block.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/arcTan2Block.ts:27
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`ArcTan2Block`](ArcTan2Block.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`ArcTan2Block`](ArcTan2Block.md)
