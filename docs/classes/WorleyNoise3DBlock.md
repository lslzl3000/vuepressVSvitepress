[@dev/core](../README.md) / [Exports](../modules.md) / WorleyNoise3DBlock
...
- [constructor](WorleyNoise3DBlock.md#constructor)

### Properties

- [\_isUnique](WorleyNoise3DBlock.md#_isunique)
- [\_target](WorleyNoise3DBlock.md#_target)
- [comments](WorleyNoise3DBlock.md#comments)
- [inputsAreExclusive](WorleyNoise3DBlock.md#inputsareexclusive)
- [manhattanDistance](WorleyNoise3DBlock.md#manhattandistance)
- [uniqueId](WorleyNoise3DBlock.md#uniqueid)
- [visibleInInspector](WorleyNoise3DBlock.md#visibleininspector)
- [visibleOnFrame](WorleyNoise3DBlock.md#visibleonframe)

### Accessors

- [buildId](WorleyNoise3DBlock.md#buildid)
- [inputs](WorleyNoise3DBlock.md#inputs)
- [isFinalMerger](WorleyNoise3DBlock.md#isfinalmerger)
- [isInput](WorleyNoise3DBlock.md#isinput)
- [isUnique](WorleyNoise3DBlock.md#isunique)
- [jitter](WorleyNoise3DBlock.md#jitter)
- [name](WorleyNoise3DBlock.md#name)
- [output](WorleyNoise3DBlock.md#output)
- [outputs](WorleyNoise3DBlock.md#outputs)
- [seed](WorleyNoise3DBlock.md#seed)
- [target](WorleyNoise3DBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](WorleyNoise3DBlock.md#willbegeneratedintovertexshaderfromfragmentshader)
- [x](WorleyNoise3DBlock.md#x)
- [y](WorleyNoise3DBlock.md#y)

### Methods

- [\_buildBlock](WorleyNoise3DBlock.md#_buildblock)
- [\_declareOutput](WorleyNoise3DBlock.md#_declareoutput)
- [\_deserialize](WorleyNoise3DBlock.md#_deserialize)
- [\_dumpPropertiesCode](WorleyNoise3DBlock.md#_dumppropertiescode)
- [\_inputRename](WorleyNoise3DBlock.md#_inputrename)
- [\_linkConnectionTypes](WorleyNoise3DBlock.md#_linkconnectiontypes)
- [\_outputRename](WorleyNoise3DBlock.md#_outputrename)
- [\_writeFloat](WorleyNoise3DBlock.md#_writefloat)
- [\_writeVariable](WorleyNoise3DBlock.md#_writevariable)
- [autoConfigure](WorleyNoise3DBlock.md#autoconfigure)
- [bind](WorleyNoise3DBlock.md#bind)
- [build](WorleyNoise3DBlock.md#build)
- [clone](WorleyNoise3DBlock.md#clone)
- [connectTo](WorleyNoise3DBlock.md#connectto)
- [dispose](WorleyNoise3DBlock.md#dispose)
- [getClassName](WorleyNoise3DBlock.md#getclassname)
- [getFirstAvailableInput](WorleyNoise3DBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](WorleyNoise3DBlock.md#getfirstavailableoutput)
- [getInputByName](WorleyNoise3DBlock.md#getinputbyname)
- [getOutputByName](WorleyNoise3DBlock.md#getoutputbyname)
- [getSiblingOutput](WorleyNoise3DBlock.md#getsiblingoutput)
- [initialize](WorleyNoise3DBlock.md#initialize)
- [initializeDefines](WorleyNoise3DBlock.md#initializedefines)
- [isAnAncestorOf](WorleyNoise3DBlock.md#isanancestorof)
- [isReady](WorleyNoise3DBlock.md#isready)
- [prepareDefines](WorleyNoise3DBlock.md#preparedefines)
- [provideFallbacks](WorleyNoise3DBlock.md#providefallbacks)
- [registerInput](WorleyNoise3DBlock.md#registerinput)
- [registerOutput](WorleyNoise3DBlock.md#registeroutput)
- [replaceRepeatableContent](WorleyNoise3DBlock.md#replacerepeatablecontent)
- [serialize](WorleyNoise3DBlock.md#serialize)
- [updateUniformsAndSamples](WorleyNoise3DBlock.md#updateuniformsandsamples)
- [validateBlockName](WorleyNoise3DBlock.md#validateblockname)

## Constructors

### constructor

• **new WorleyNoise3DBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/worleyNoise3DBlock.ts:29
...
• **manhattanDistance**: `boolean` = `false`

Gets or sets a boolean indicating that normal should be inverted on X axis

#### Defined in

https://github.com/babylon.js/core/src/Materials/Node/Blocks/worleyNoise3DBlock.ts:23
...
• `get` **jitter**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/worleyNoise3DBlock.ts:57
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/worleyNoise3DBlock.ts:64
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/worleyNoise3DBlock.ts:50
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/worleyNoise3DBlock.ts:71
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/worleyNoise3DBlock.ts:78

## Methods

### \_buildBlock

▸ `Protected` **_buildBlock**(`state`): `undefined` \| [`WorleyNoise3DBlock`](WorleyNoise3DBlock.md)
...
`undefined` \| [`WorleyNoise3DBlock`](WorleyNoise3DBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/worleyNoise3DBlock.ts:82
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/worleyNoise3DBlock.ts:288
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/worleyNoise3DBlock.ts:267
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`WorleyNoise3DBlock`](WorleyNoise3DBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/worleyNoise3DBlock.ts:43
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`WorleyNoise3DBlock`](WorleyNoise3DBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`WorleyNoise3DBlock`](WorleyNoise3DBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/worleyNoise3DBlock.ts:275
