[@dev/core](../README.md) / [Exports](../modules.md) / StopAnimationAction
...
- [constructor](StopAnimationAction.md#constructor)

### Properties

- [\_target](StopAnimationAction.md#_target)
- [onBeforeExecuteObservable](StopAnimationAction.md#onbeforeexecuteobservable)
- [trigger](StopAnimationAction.md#trigger)
- [triggerOptions](StopAnimationAction.md#triggeroptions)

### Methods

- [execute](StopAnimationAction.md#execute)
- [getTriggerParameter](StopAnimationAction.md#gettriggerparameter)
- [serialize](StopAnimationAction.md#serialize)
- [setTriggerParameter](StopAnimationAction.md#settriggerparameter)
- [skipToNextActiveAction](StopAnimationAction.md#skiptonextactiveaction)
- [then](StopAnimationAction.md#then)

## Constructors

### constructor

• **new StopAnimationAction**(`triggerOptions`, `target`, `condition?`)
...
packages/dev/core/src/Actions/directActions.ts:347
...
packages/dev/core/src/Actions/directActions.ts:339
...
packages/dev/core/src/Actions/directActions.ts:358
...
packages/dev/core/src/Actions/directActions.ts:368
