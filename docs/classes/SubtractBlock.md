[@dev/core](../README.md) / [Exports](../modules.md) / SubtractBlock
...
- [constructor](SubtractBlock.md#constructor)

### Properties

- [\_isUnique](SubtractBlock.md#_isunique)
- [\_target](SubtractBlock.md#_target)
- [comments](SubtractBlock.md#comments)
- [inputsAreExclusive](SubtractBlock.md#inputsareexclusive)
- [uniqueId](SubtractBlock.md#uniqueid)
- [visibleInInspector](SubtractBlock.md#visibleininspector)
- [visibleOnFrame](SubtractBlock.md#visibleonframe)

### Accessors

- [buildId](SubtractBlock.md#buildid)
- [inputs](SubtractBlock.md#inputs)
- [isFinalMerger](SubtractBlock.md#isfinalmerger)
- [isInput](SubtractBlock.md#isinput)
- [isUnique](SubtractBlock.md#isunique)
- [left](SubtractBlock.md#left)
- [name](SubtractBlock.md#name)
- [output](SubtractBlock.md#output)
- [outputs](SubtractBlock.md#outputs)
- [right](SubtractBlock.md#right)
- [target](SubtractBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](SubtractBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](SubtractBlock.md#_buildblock)
- [\_declareOutput](SubtractBlock.md#_declareoutput)
- [\_dumpPropertiesCode](SubtractBlock.md#_dumppropertiescode)
- [\_inputRename](SubtractBlock.md#_inputrename)
- [\_linkConnectionTypes](SubtractBlock.md#_linkconnectiontypes)
- [\_outputRename](SubtractBlock.md#_outputrename)
- [\_writeFloat](SubtractBlock.md#_writefloat)
- [\_writeVariable](SubtractBlock.md#_writevariable)
- [autoConfigure](SubtractBlock.md#autoconfigure)
- [bind](SubtractBlock.md#bind)
- [build](SubtractBlock.md#build)
- [clone](SubtractBlock.md#clone)
- [connectTo](SubtractBlock.md#connectto)
- [dispose](SubtractBlock.md#dispose)
- [getClassName](SubtractBlock.md#getclassname)
- [getFirstAvailableInput](SubtractBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](SubtractBlock.md#getfirstavailableoutput)
- [getInputByName](SubtractBlock.md#getinputbyname)
- [getOutputByName](SubtractBlock.md#getoutputbyname)
- [getSiblingOutput](SubtractBlock.md#getsiblingoutput)
- [initialize](SubtractBlock.md#initialize)
- [initializeDefines](SubtractBlock.md#initializedefines)
- [isAnAncestorOf](SubtractBlock.md#isanancestorof)
- [isReady](SubtractBlock.md#isready)
- [prepareDefines](SubtractBlock.md#preparedefines)
- [provideFallbacks](SubtractBlock.md#providefallbacks)
- [registerInput](SubtractBlock.md#registerinput)
- [registerOutput](SubtractBlock.md#registeroutput)
- [replaceRepeatableContent](SubtractBlock.md#replacerepeatablecontent)
- [serialize](SubtractBlock.md#serialize)
- [updateUniformsAndSamples](SubtractBlock.md#updateuniformsandsamples)
- [validateBlockName](SubtractBlock.md#validateblockname)

## Constructors

### constructor

• **new SubtractBlock**(`name`)
...
packages/dev/core/src/Materials/Node/Blocks/subtractBlock.ts:15
...
packages/dev/core/src/Materials/Node/Blocks/subtractBlock.ts:37
...
packages/dev/core/src/Materials/Node/Blocks/subtractBlock.ts:51
...
packages/dev/core/src/Materials/Node/Blocks/subtractBlock.ts:44
...
▸ `Protected` **_buildBlock**(`state`): [`SubtractBlock`](SubtractBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/subtractBlock.ts:55
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`SubtractBlock`](SubtractBlock.md)
...
`undefined` \| [`SubtractBlock`](SubtractBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/subtractBlock.ts:30
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`SubtractBlock`](SubtractBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`SubtractBlock`](SubtractBlock.md)
