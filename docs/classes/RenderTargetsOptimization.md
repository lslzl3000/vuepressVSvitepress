[@dev/core](../README.md) / [Exports](../modules.md) / RenderTargetsOptimization
...
- [constructor](RenderTargetsOptimization.md#constructor)

### Properties

- [priority](RenderTargetsOptimization.md#priority)

### Methods

- [apply](RenderTargetsOptimization.md#apply)
- [getDescription](RenderTargetsOptimization.md#getdescription)

## Constructors

### constructor

• **new RenderTargetsOptimization**(`priority?`)
...
packages/dev/core/src/Misc/sceneOptimizer.ts:330
...
packages/dev/core/src/Misc/sceneOptimizer.ts:320
