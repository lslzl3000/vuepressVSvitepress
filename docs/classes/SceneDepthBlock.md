[@dev/core](../README.md) / [Exports](../modules.md) / SceneDepthBlock
...
- [constructor](SceneDepthBlock.md#constructor)

### Properties

- [\_isUnique](SceneDepthBlock.md#_isunique)
- [\_mainUVName](SceneDepthBlock.md#_mainuvname)
- [\_samplerName](SceneDepthBlock.md#_samplername)
- [\_target](SceneDepthBlock.md#_target)
- [\_tempTextureRead](SceneDepthBlock.md#_temptextureread)
- [comments](SceneDepthBlock.md#comments)
- [force32itsFloat](SceneDepthBlock.md#force32itsfloat)
- [inputsAreExclusive](SceneDepthBlock.md#inputsareexclusive)
- [uniqueId](SceneDepthBlock.md#uniqueid)
- [useNonLinearDepth](SceneDepthBlock.md#usenonlineardepth)
- [visibleInInspector](SceneDepthBlock.md#visibleininspector)
- [visibleOnFrame](SceneDepthBlock.md#visibleonframe)

### Accessors

- [buildId](SceneDepthBlock.md#buildid)
- [depth](SceneDepthBlock.md#depth)
- [inputs](SceneDepthBlock.md#inputs)
- [isFinalMerger](SceneDepthBlock.md#isfinalmerger)
- [isInput](SceneDepthBlock.md#isinput)
- [isUnique](SceneDepthBlock.md#isunique)
- [name](SceneDepthBlock.md#name)
- [outputs](SceneDepthBlock.md#outputs)
- [target](SceneDepthBlock.md#target)
- [uv](SceneDepthBlock.md#uv)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](SceneDepthBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](SceneDepthBlock.md#_buildblock)
- [\_declareOutput](SceneDepthBlock.md#_declareoutput)
- [\_deserialize](SceneDepthBlock.md#_deserialize)
- [\_dumpPropertiesCode](SceneDepthBlock.md#_dumppropertiescode)
- [\_getTexture](SceneDepthBlock.md#_gettexture)
- [\_injectVertexCode](SceneDepthBlock.md#_injectvertexcode)
- [\_inputRename](SceneDepthBlock.md#_inputrename)
- [\_linkConnectionTypes](SceneDepthBlock.md#_linkconnectiontypes)
- [\_outputRename](SceneDepthBlock.md#_outputrename)
- [\_writeFloat](SceneDepthBlock.md#_writefloat)
- [\_writeOutput](SceneDepthBlock.md#_writeoutput)
- [\_writeTextureRead](SceneDepthBlock.md#_writetextureread)
- [\_writeVariable](SceneDepthBlock.md#_writevariable)
- [autoConfigure](SceneDepthBlock.md#autoconfigure)
- [bind](SceneDepthBlock.md#bind)
- [build](SceneDepthBlock.md#build)
- [clone](SceneDepthBlock.md#clone)
- [connectTo](SceneDepthBlock.md#connectto)
- [dispose](SceneDepthBlock.md#dispose)
- [getClassName](SceneDepthBlock.md#getclassname)
- [getFirstAvailableInput](SceneDepthBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](SceneDepthBlock.md#getfirstavailableoutput)
- [getInputByName](SceneDepthBlock.md#getinputbyname)
- [getOutputByName](SceneDepthBlock.md#getoutputbyname)
- [getSiblingOutput](SceneDepthBlock.md#getsiblingoutput)
- [initialize](SceneDepthBlock.md#initialize)
- [initializeDefines](SceneDepthBlock.md#initializedefines)
- [isAnAncestorOf](SceneDepthBlock.md#isanancestorof)
- [isReady](SceneDepthBlock.md#isready)
- [prepareDefines](SceneDepthBlock.md#preparedefines)
- [provideFallbacks](SceneDepthBlock.md#providefallbacks)
- [registerInput](SceneDepthBlock.md#registerinput)
- [registerOutput](SceneDepthBlock.md#registeroutput)
- [replaceRepeatableContent](SceneDepthBlock.md#replacerepeatablecontent)
- [serialize](SceneDepthBlock.md#serialize)
- [updateUniformsAndSamples](SceneDepthBlock.md#updateuniformsandsamples)
- [validateBlockName](SceneDepthBlock.md#validateblockname)

## Constructors

### constructor

• **new SceneDepthBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/sceneDepthBlock.ts:44
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/sceneDepthBlock.ts:21
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/sceneDepthBlock.ts:20
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/sceneDepthBlock.ts:22
...
• **force32itsFloat**: `boolean` = `false`

Defines if the depth renderer should be setup in full 32 bits float mode

#### Defined in

https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/sceneDepthBlock.ts:38
...
• **useNonLinearDepth**: `boolean` = `false`

Defines if the depth renderer should be setup in non linear mode

#### Defined in

https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/sceneDepthBlock.ts:30
...
• `get` **depth**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/sceneDepthBlock.ts:77
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/sceneDepthBlock.ts:89
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/sceneDepthBlock.ts:70
...
▸ `Protected` **_buildBlock**(`state`): `undefined` \| [`SceneDepthBlock`](SceneDepthBlock.md)
...
`undefined` \| [`SceneDepthBlock`](SceneDepthBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/sceneDepthBlock.ts:184
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/sceneDepthBlock.ts:227
...
▸ `Private` **_getTexture**(`scene`): [`BaseTexture`](BaseTexture.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/sceneDepthBlock.ts:101
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/sceneDepthBlock.ts:113
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/sceneDepthBlock.ts:166
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/sceneDepthBlock.ts:146
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/sceneDepthBlock.ts:107
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`SceneDepthBlock`](SceneDepthBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/sceneDepthBlock.ts:63
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/sceneDepthBlock.ts:85
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`SceneDepthBlock`](SceneDepthBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`SceneDepthBlock`](SceneDepthBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Dual/sceneDepthBlock.ts:218
