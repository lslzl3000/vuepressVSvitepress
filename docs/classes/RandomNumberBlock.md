[@dev/core](../README.md) / [Exports](../modules.md) / RandomNumberBlock
...
- [constructor](RandomNumberBlock.md#constructor)

### Properties

- [\_isUnique](RandomNumberBlock.md#_isunique)
- [\_target](RandomNumberBlock.md#_target)
- [comments](RandomNumberBlock.md#comments)
- [inputsAreExclusive](RandomNumberBlock.md#inputsareexclusive)
- [uniqueId](RandomNumberBlock.md#uniqueid)
- [visibleInInspector](RandomNumberBlock.md#visibleininspector)
- [visibleOnFrame](RandomNumberBlock.md#visibleonframe)

### Accessors

- [buildId](RandomNumberBlock.md#buildid)
- [inputs](RandomNumberBlock.md#inputs)
- [isFinalMerger](RandomNumberBlock.md#isfinalmerger)
- [isInput](RandomNumberBlock.md#isinput)
- [isUnique](RandomNumberBlock.md#isunique)
- [name](RandomNumberBlock.md#name)
- [output](RandomNumberBlock.md#output)
- [outputs](RandomNumberBlock.md#outputs)
- [seed](RandomNumberBlock.md#seed)
- [target](RandomNumberBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](RandomNumberBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](RandomNumberBlock.md#_buildblock)
- [\_declareOutput](RandomNumberBlock.md#_declareoutput)
- [\_dumpPropertiesCode](RandomNumberBlock.md#_dumppropertiescode)
- [\_inputRename](RandomNumberBlock.md#_inputrename)
- [\_linkConnectionTypes](RandomNumberBlock.md#_linkconnectiontypes)
- [\_outputRename](RandomNumberBlock.md#_outputrename)
- [\_writeFloat](RandomNumberBlock.md#_writefloat)
- [\_writeVariable](RandomNumberBlock.md#_writevariable)
- [autoConfigure](RandomNumberBlock.md#autoconfigure)
- [bind](RandomNumberBlock.md#bind)
- [build](RandomNumberBlock.md#build)
- [clone](RandomNumberBlock.md#clone)
- [connectTo](RandomNumberBlock.md#connectto)
- [dispose](RandomNumberBlock.md#dispose)
- [getClassName](RandomNumberBlock.md#getclassname)
- [getFirstAvailableInput](RandomNumberBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](RandomNumberBlock.md#getfirstavailableoutput)
- [getInputByName](RandomNumberBlock.md#getinputbyname)
- [getOutputByName](RandomNumberBlock.md#getoutputbyname)
- [getSiblingOutput](RandomNumberBlock.md#getsiblingoutput)
- [initialize](RandomNumberBlock.md#initialize)
- [initializeDefines](RandomNumberBlock.md#initializedefines)
- [isAnAncestorOf](RandomNumberBlock.md#isanancestorof)
- [isReady](RandomNumberBlock.md#isready)
- [prepareDefines](RandomNumberBlock.md#preparedefines)
- [provideFallbacks](RandomNumberBlock.md#providefallbacks)
- [registerInput](RandomNumberBlock.md#registerinput)
- [registerOutput](RandomNumberBlock.md#registeroutput)
- [replaceRepeatableContent](RandomNumberBlock.md#replacerepeatablecontent)
- [serialize](RandomNumberBlock.md#serialize)
- [updateUniformsAndSamples](RandomNumberBlock.md#updateuniformsandsamples)
- [validateBlockName](RandomNumberBlock.md#validateblockname)

## Constructors

### constructor

• **new RandomNumberBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/randomNumberBlock.ts:18
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/randomNumberBlock.ts:48
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/randomNumberBlock.ts:41
...
▸ `Protected` **_buildBlock**(`state`): [`RandomNumberBlock`](RandomNumberBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/randomNumberBlock.ts:52
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`RandomNumberBlock`](RandomNumberBlock.md)
...
`undefined` \| [`RandomNumberBlock`](RandomNumberBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/randomNumberBlock.ts:34
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`RandomNumberBlock`](RandomNumberBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`RandomNumberBlock`](RandomNumberBlock.md)
