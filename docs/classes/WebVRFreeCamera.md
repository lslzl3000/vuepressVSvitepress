[@dev/core](../README.md) / [Exports](../modules.md) / WebVRFreeCamera
...
- [\_worldToDevice](WebVRFreeCamera.md#_worldtodevice)
...
- [RIG\_MODE\_CUSTOM](WebVRFreeCamera.md#rig_mode_custom)
...
- [\_computeViewMatrix](WebVRFreeCamera.md#_computeviewmatrix)
...
- [update](WebVRFreeCamera.md#update)
...
https://github.com/babylon.js/core/src/Cameras/VR/webVRCamera.ts:744
...
https://github.com/babylon.js/core/src/Cameras/VR/webVRCamera.ts:546
...
https://github.com/babylon.js/core/src/Cameras/VR/webVRCamera.ts:647
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `poseData` | [`DevicePose`](../interfaces/DevicePose.md) | Pose coming from the device |
...
https://github.com/babylon.js/core/src/Cameras/VR/webVRCamera.ts:477

___

### useStandingMatrix

▸ **useStandingMatrix**(`callback?`): `void`
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `callback` | (`bool`: `boolean`) => `void` | will be called when the standing matrix is set. Callback parameter is if the standing matrix is supported. |
...
https://github.com/babylon.js/core/src/Cameras/VR/webVRCamera.ts:362
...
https://github.com/babylon.js/core/src/Cameras/VR/webVRCamera.ts:386
