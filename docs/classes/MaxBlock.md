[@dev/core](../README.md) / [Exports](../modules.md) / MaxBlock
...
- [constructor](MaxBlock.md#constructor)

### Properties

- [\_isUnique](MaxBlock.md#_isunique)
- [\_target](MaxBlock.md#_target)
- [comments](MaxBlock.md#comments)
- [inputsAreExclusive](MaxBlock.md#inputsareexclusive)
- [uniqueId](MaxBlock.md#uniqueid)
- [visibleInInspector](MaxBlock.md#visibleininspector)
- [visibleOnFrame](MaxBlock.md#visibleonframe)

### Accessors

- [buildId](MaxBlock.md#buildid)
- [inputs](MaxBlock.md#inputs)
- [isFinalMerger](MaxBlock.md#isfinalmerger)
- [isInput](MaxBlock.md#isinput)
- [isUnique](MaxBlock.md#isunique)
- [left](MaxBlock.md#left)
- [name](MaxBlock.md#name)
- [output](MaxBlock.md#output)
- [outputs](MaxBlock.md#outputs)
- [right](MaxBlock.md#right)
- [target](MaxBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](MaxBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](MaxBlock.md#_buildblock)
- [\_declareOutput](MaxBlock.md#_declareoutput)
- [\_dumpPropertiesCode](MaxBlock.md#_dumppropertiescode)
- [\_inputRename](MaxBlock.md#_inputrename)
- [\_linkConnectionTypes](MaxBlock.md#_linkconnectiontypes)
- [\_outputRename](MaxBlock.md#_outputrename)
- [\_writeFloat](MaxBlock.md#_writefloat)
- [\_writeVariable](MaxBlock.md#_writevariable)
- [autoConfigure](MaxBlock.md#autoconfigure)
- [bind](MaxBlock.md#bind)
- [build](MaxBlock.md#build)
- [clone](MaxBlock.md#clone)
- [connectTo](MaxBlock.md#connectto)
- [dispose](MaxBlock.md#dispose)
- [getClassName](MaxBlock.md#getclassname)
- [getFirstAvailableInput](MaxBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](MaxBlock.md#getfirstavailableoutput)
- [getInputByName](MaxBlock.md#getinputbyname)
- [getOutputByName](MaxBlock.md#getoutputbyname)
- [getSiblingOutput](MaxBlock.md#getsiblingoutput)
- [initialize](MaxBlock.md#initialize)
- [initializeDefines](MaxBlock.md#initializedefines)
- [isAnAncestorOf](MaxBlock.md#isanancestorof)
- [isReady](MaxBlock.md#isready)
- [prepareDefines](MaxBlock.md#preparedefines)
- [provideFallbacks](MaxBlock.md#providefallbacks)
- [registerInput](MaxBlock.md#registerinput)
- [registerOutput](MaxBlock.md#registeroutput)
- [replaceRepeatableContent](MaxBlock.md#replacerepeatablecontent)
- [serialize](MaxBlock.md#serialize)
- [updateUniformsAndSamples](MaxBlock.md#updateuniformsandsamples)
- [validateBlockName](MaxBlock.md#validateblockname)
...
packages/dev/core/src/Materials/Node/Blocks/maxBlock.ts:15
...
packages/dev/core/src/Materials/Node/Blocks/maxBlock.ts:37
...
packages/dev/core/src/Materials/Node/Blocks/maxBlock.ts:51
...
packages/dev/core/src/Materials/Node/Blocks/maxBlock.ts:44
...
▸ `Protected` **_buildBlock**(`state`): [`MaxBlock`](MaxBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/maxBlock.ts:55
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`MaxBlock`](MaxBlock.md)
...
`undefined` \| [`MaxBlock`](MaxBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/maxBlock.ts:30
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`MaxBlock`](MaxBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`MaxBlock`](MaxBlock.md)
