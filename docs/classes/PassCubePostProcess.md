[@dev/core](../README.md) / [Exports](../modules.md) / PassCubePostProcess
...
- [constructor](PassCubePostProcess.md#constructor)

### Properties

- [\_face](PassCubePostProcess.md#_face)
- [\_indexParameters](PassCubePostProcess.md#_indexparameters)
- [\_postProcessDefines](PassCubePostProcess.md#_postprocessdefines)
- [\_scene](PassCubePostProcess.md#_scene)
- [adaptScaleToCurrentViewport](PassCubePostProcess.md#adaptscaletocurrentviewport)
- [alphaConstants](PassCubePostProcess.md#alphaconstants)
- [alphaMode](PassCubePostProcess.md#alphamode)
- [alwaysForcePOT](PassCubePostProcess.md#alwaysforcepot)
- [animations](PassCubePostProcess.md#animations)
- [autoClear](PassCubePostProcess.md#autoclear)
- [clearColor](PassCubePostProcess.md#clearcolor)
- [enablePixelPerfectMode](PassCubePostProcess.md#enablepixelperfectmode)
- [externalTextureSamplerBinding](PassCubePostProcess.md#externaltexturesamplerbinding)
- [forceFullscreenViewport](PassCubePostProcess.md#forcefullscreenviewport)
- [height](PassCubePostProcess.md#height)
- [inspectableCustomProperties](PassCubePostProcess.md#inspectablecustomproperties)
- [name](PassCubePostProcess.md#name)
- [nodeMaterialSource](PassCubePostProcess.md#nodematerialsource)
- [onActivateObservable](PassCubePostProcess.md#onactivateobservable)
- [onAfterRenderObservable](PassCubePostProcess.md#onafterrenderobservable)
- [onApplyObservable](PassCubePostProcess.md#onapplyobservable)
- [onBeforeRenderObservable](PassCubePostProcess.md#onbeforerenderobservable)
- [onSizeChangedObservable](PassCubePostProcess.md#onsizechangedobservable)
- [renderTargetSamplingMode](PassCubePostProcess.md#rendertargetsamplingmode)
- [scaleMode](PassCubePostProcess.md#scalemode)
- [uniqueId](PassCubePostProcess.md#uniqueid)
- [width](PassCubePostProcess.md#width)

### Accessors

- [aspectRatio](PassCubePostProcess.md#aspectratio)
- [face](PassCubePostProcess.md#face)
- [inputTexture](PassCubePostProcess.md#inputtexture)
- [isSupported](PassCubePostProcess.md#issupported)
- [onActivate](PassCubePostProcess.md#onactivate)
- [onAfterRender](PassCubePostProcess.md#onafterrender)
- [onApply](PassCubePostProcess.md#onapply)
- [onBeforeRender](PassCubePostProcess.md#onbeforerender)
- [onSizeChanged](PassCubePostProcess.md#onsizechanged)
- [samples](PassCubePostProcess.md#samples)
- [texelSize](PassCubePostProcess.md#texelsize)

### Methods

- [activate](PassCubePostProcess.md#activate)
- [apply](PassCubePostProcess.md#apply)
- [clone](PassCubePostProcess.md#clone)
- [dispose](PassCubePostProcess.md#dispose)
- [getCamera](PassCubePostProcess.md#getcamera)
- [getClassName](PassCubePostProcess.md#getclassname)
- [getEffect](PassCubePostProcess.md#geteffect)
- [getEffectName](PassCubePostProcess.md#geteffectname)
- [getEngine](PassCubePostProcess.md#getengine)
- [isReady](PassCubePostProcess.md#isready)
- [isReusable](PassCubePostProcess.md#isreusable)
- [markTextureDirty](PassCubePostProcess.md#marktexturedirty)
- [restoreDefaultInputTexture](PassCubePostProcess.md#restoredefaultinputtexture)
- [serialize](PassCubePostProcess.md#serialize)
- [setPrePassRenderer](PassCubePostProcess.md#setprepassrenderer)
- [shareOutputWith](PassCubePostProcess.md#shareoutputwith)
- [updateEffect](PassCubePostProcess.md#updateeffect)
- [useOwnOutput](PassCubePostProcess.md#useownoutput)
- [Parse](PassCubePostProcess.md#parse)

## Constructors

### constructor

• **new PassCubePostProcess**(`name`, `options`, `camera?`, `samplingMode?`, `engine?`, `reusable?`, `textureType?`, `blockCompilation?`)
...
| `camera` | [`Nullable`](../modules.md#nullable)[`Camera`](Camera.md) | `null` | The camera to apply the render pass to. |
...
| `textureType` | `number` | `Constants.TEXTURETYPE_UNSIGNED_INT` | The type of texture to be used when performing the post processing. |
...
packages/dev/core/src/PostProcesses/passPostProcess.ts:145
...
packages/dev/core/src/PostProcesses/passPostProcess.ts:83
...
packages/dev/core/src/PostProcesses/passPostProcess.ts:94
...
packages/dev/core/src/PostProcesses/passPostProcess.ts:98
...
packages/dev/core/src/PostProcesses/passPostProcess.ts:130
