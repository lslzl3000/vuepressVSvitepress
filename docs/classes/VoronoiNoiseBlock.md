[@dev/core](../README.md) / [Exports](../modules.md) / VoronoiNoiseBlock

# Class: VoronoiNoiseBlock
...
- [constructor](VoronoiNoiseBlock.md#constructor)

### Properties

- [\_isUnique](VoronoiNoiseBlock.md#_isunique)
- [\_target](VoronoiNoiseBlock.md#_target)
- [comments](VoronoiNoiseBlock.md#comments)
- [inputsAreExclusive](VoronoiNoiseBlock.md#inputsareexclusive)
- [uniqueId](VoronoiNoiseBlock.md#uniqueid)
- [visibleInInspector](VoronoiNoiseBlock.md#visibleininspector)
- [visibleOnFrame](VoronoiNoiseBlock.md#visibleonframe)

### Accessors

- [buildId](VoronoiNoiseBlock.md#buildid)
- [cells](VoronoiNoiseBlock.md#cells)
- [density](VoronoiNoiseBlock.md#density)
- [inputs](VoronoiNoiseBlock.md#inputs)
- [isFinalMerger](VoronoiNoiseBlock.md#isfinalmerger)
- [isInput](VoronoiNoiseBlock.md#isinput)
- [isUnique](VoronoiNoiseBlock.md#isunique)
- [name](VoronoiNoiseBlock.md#name)
- [offset](VoronoiNoiseBlock.md#offset)
- [output](VoronoiNoiseBlock.md#output)
- [outputs](VoronoiNoiseBlock.md#outputs)
- [seed](VoronoiNoiseBlock.md#seed)
- [target](VoronoiNoiseBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](VoronoiNoiseBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](VoronoiNoiseBlock.md#_buildblock)
- [\_declareOutput](VoronoiNoiseBlock.md#_declareoutput)
- [\_dumpPropertiesCode](VoronoiNoiseBlock.md#_dumppropertiescode)
- [\_inputRename](VoronoiNoiseBlock.md#_inputrename)
- [\_linkConnectionTypes](VoronoiNoiseBlock.md#_linkconnectiontypes)
- [\_outputRename](VoronoiNoiseBlock.md#_outputrename)
- [\_writeFloat](VoronoiNoiseBlock.md#_writefloat)
- [\_writeVariable](VoronoiNoiseBlock.md#_writevariable)
- [autoConfigure](VoronoiNoiseBlock.md#autoconfigure)
- [bind](VoronoiNoiseBlock.md#bind)
- [build](VoronoiNoiseBlock.md#build)
- [clone](VoronoiNoiseBlock.md#clone)
- [connectTo](VoronoiNoiseBlock.md#connectto)
- [dispose](VoronoiNoiseBlock.md#dispose)
- [getClassName](VoronoiNoiseBlock.md#getclassname)
- [getFirstAvailableInput](VoronoiNoiseBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](VoronoiNoiseBlock.md#getfirstavailableoutput)
- [getInputByName](VoronoiNoiseBlock.md#getinputbyname)
- [getOutputByName](VoronoiNoiseBlock.md#getoutputbyname)
- [getSiblingOutput](VoronoiNoiseBlock.md#getsiblingoutput)
- [initialize](VoronoiNoiseBlock.md#initialize)
- [initializeDefines](VoronoiNoiseBlock.md#initializedefines)
- [isAnAncestorOf](VoronoiNoiseBlock.md#isanancestorof)
- [isReady](VoronoiNoiseBlock.md#isready)
- [prepareDefines](VoronoiNoiseBlock.md#preparedefines)
- [provideFallbacks](VoronoiNoiseBlock.md#providefallbacks)
- [registerInput](VoronoiNoiseBlock.md#registerinput)
- [registerOutput](VoronoiNoiseBlock.md#registeroutput)
- [replaceRepeatableContent](VoronoiNoiseBlock.md#replacerepeatablecontent)
- [serialize](VoronoiNoiseBlock.md#serialize)
- [updateUniformsAndSamples](VoronoiNoiseBlock.md#updateuniformsandsamples)
- [validateBlockName](VoronoiNoiseBlock.md#validateblockname)

## Constructors

### constructor

• **new VoronoiNoiseBlock**(`name`)
...
packages/dev/core/src/Materials/Node/Blocks/voronoiNoiseBlock.ts:16
...
• `get` **cells**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/voronoiNoiseBlock.ts:65

___

### density

• `get` **density**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/voronoiNoiseBlock.ts:51
...
• `get` **offset**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/voronoiNoiseBlock.ts:44
...
packages/dev/core/src/Materials/Node/Blocks/voronoiNoiseBlock.ts:58
...
packages/dev/core/src/Materials/Node/Blocks/voronoiNoiseBlock.ts:37
...
▸ `Protected` **_buildBlock**(`state`): `undefined` \| [`VoronoiNoiseBlock`](VoronoiNoiseBlock.md)
...
`undefined` \| [`VoronoiNoiseBlock`](VoronoiNoiseBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/voronoiNoiseBlock.ts:69
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`VoronoiNoiseBlock`](VoronoiNoiseBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/voronoiNoiseBlock.ts:30
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`VoronoiNoiseBlock`](VoronoiNoiseBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`VoronoiNoiseBlock`](VoronoiNoiseBlock.md)
