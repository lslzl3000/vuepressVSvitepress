[@dev/core](../README.md) / [Exports](../modules.md) / ModBlock
...
- [constructor](ModBlock.md#constructor)

### Properties

- [\_isUnique](ModBlock.md#_isunique)
- [\_target](ModBlock.md#_target)
- [comments](ModBlock.md#comments)
- [inputsAreExclusive](ModBlock.md#inputsareexclusive)
- [uniqueId](ModBlock.md#uniqueid)
- [visibleInInspector](ModBlock.md#visibleininspector)
- [visibleOnFrame](ModBlock.md#visibleonframe)

### Accessors

- [buildId](ModBlock.md#buildid)
- [inputs](ModBlock.md#inputs)
- [isFinalMerger](ModBlock.md#isfinalmerger)
- [isInput](ModBlock.md#isinput)
- [isUnique](ModBlock.md#isunique)
- [left](ModBlock.md#left)
- [name](ModBlock.md#name)
- [output](ModBlock.md#output)
- [outputs](ModBlock.md#outputs)
- [right](ModBlock.md#right)
- [target](ModBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](ModBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](ModBlock.md#_buildblock)
- [\_declareOutput](ModBlock.md#_declareoutput)
- [\_dumpPropertiesCode](ModBlock.md#_dumppropertiescode)
- [\_inputRename](ModBlock.md#_inputrename)
- [\_linkConnectionTypes](ModBlock.md#_linkconnectiontypes)
- [\_outputRename](ModBlock.md#_outputrename)
- [\_writeFloat](ModBlock.md#_writefloat)
- [\_writeVariable](ModBlock.md#_writevariable)
- [autoConfigure](ModBlock.md#autoconfigure)
- [bind](ModBlock.md#bind)
- [build](ModBlock.md#build)
- [clone](ModBlock.md#clone)
- [connectTo](ModBlock.md#connectto)
- [dispose](ModBlock.md#dispose)
- [getClassName](ModBlock.md#getclassname)
- [getFirstAvailableInput](ModBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](ModBlock.md#getfirstavailableoutput)
- [getInputByName](ModBlock.md#getinputbyname)
- [getOutputByName](ModBlock.md#getoutputbyname)
- [getSiblingOutput](ModBlock.md#getsiblingoutput)
- [initialize](ModBlock.md#initialize)
- [initializeDefines](ModBlock.md#initializedefines)
- [isAnAncestorOf](ModBlock.md#isanancestorof)
- [isReady](ModBlock.md#isready)
- [prepareDefines](ModBlock.md#preparedefines)
- [provideFallbacks](ModBlock.md#providefallbacks)
- [registerInput](ModBlock.md#registerinput)
- [registerOutput](ModBlock.md#registeroutput)
- [replaceRepeatableContent](ModBlock.md#replacerepeatablecontent)
- [serialize](ModBlock.md#serialize)
- [updateUniformsAndSamples](ModBlock.md#updateuniformsandsamples)
- [validateBlockName](ModBlock.md#validateblockname)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/modBlock.ts:15
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/modBlock.ts:37
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/modBlock.ts:51
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/modBlock.ts:44
...
▸ `Protected` **_buildBlock**(`state`): [`ModBlock`](ModBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/modBlock.ts:55
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`ModBlock`](ModBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/modBlock.ts:30
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`ModBlock`](ModBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`ModBlock`](ModBlock.md)
