[@dev/core](../README.md) / [Exports](../modules.md) / VRMultiviewToSingleviewPostProcess
...
- [constructor](VRMultiviewToSingleviewPostProcess.md#constructor)

### Properties

- [\_indexParameters](VRMultiviewToSingleviewPostProcess.md#_indexparameters)
- [\_postProcessDefines](VRMultiviewToSingleviewPostProcess.md#_postprocessdefines)
- [\_scene](VRMultiviewToSingleviewPostProcess.md#_scene)
- [adaptScaleToCurrentViewport](VRMultiviewToSingleviewPostProcess.md#adaptscaletocurrentviewport)
- [alphaConstants](VRMultiviewToSingleviewPostProcess.md#alphaconstants)
- [alphaMode](VRMultiviewToSingleviewPostProcess.md#alphamode)
- [alwaysForcePOT](VRMultiviewToSingleviewPostProcess.md#alwaysforcepot)
- [animations](VRMultiviewToSingleviewPostProcess.md#animations)
- [autoClear](VRMultiviewToSingleviewPostProcess.md#autoclear)
- [clearColor](VRMultiviewToSingleviewPostProcess.md#clearcolor)
- [enablePixelPerfectMode](VRMultiviewToSingleviewPostProcess.md#enablepixelperfectmode)
- [externalTextureSamplerBinding](VRMultiviewToSingleviewPostProcess.md#externaltexturesamplerbinding)
- [forceFullscreenViewport](VRMultiviewToSingleviewPostProcess.md#forcefullscreenviewport)
- [height](VRMultiviewToSingleviewPostProcess.md#height)
- [inspectableCustomProperties](VRMultiviewToSingleviewPostProcess.md#inspectablecustomproperties)
- [name](VRMultiviewToSingleviewPostProcess.md#name)
- [nodeMaterialSource](VRMultiviewToSingleviewPostProcess.md#nodematerialsource)
- [onActivateObservable](VRMultiviewToSingleviewPostProcess.md#onactivateobservable)
- [onAfterRenderObservable](VRMultiviewToSingleviewPostProcess.md#onafterrenderobservable)
- [onApplyObservable](VRMultiviewToSingleviewPostProcess.md#onapplyobservable)
- [onBeforeRenderObservable](VRMultiviewToSingleviewPostProcess.md#onbeforerenderobservable)
- [onSizeChangedObservable](VRMultiviewToSingleviewPostProcess.md#onsizechangedobservable)
- [renderTargetSamplingMode](VRMultiviewToSingleviewPostProcess.md#rendertargetsamplingmode)
- [scaleMode](VRMultiviewToSingleviewPostProcess.md#scalemode)
- [uniqueId](VRMultiviewToSingleviewPostProcess.md#uniqueid)
- [width](VRMultiviewToSingleviewPostProcess.md#width)

### Accessors

- [aspectRatio](VRMultiviewToSingleviewPostProcess.md#aspectratio)
- [inputTexture](VRMultiviewToSingleviewPostProcess.md#inputtexture)
- [isSupported](VRMultiviewToSingleviewPostProcess.md#issupported)
- [onActivate](VRMultiviewToSingleviewPostProcess.md#onactivate)
- [onAfterRender](VRMultiviewToSingleviewPostProcess.md#onafterrender)
- [onApply](VRMultiviewToSingleviewPostProcess.md#onapply)
- [onBeforeRender](VRMultiviewToSingleviewPostProcess.md#onbeforerender)
- [onSizeChanged](VRMultiviewToSingleviewPostProcess.md#onsizechanged)
- [samples](VRMultiviewToSingleviewPostProcess.md#samples)
- [texelSize](VRMultiviewToSingleviewPostProcess.md#texelsize)

### Methods

- [activate](VRMultiviewToSingleviewPostProcess.md#activate)
- [apply](VRMultiviewToSingleviewPostProcess.md#apply)
- [clone](VRMultiviewToSingleviewPostProcess.md#clone)
- [dispose](VRMultiviewToSingleviewPostProcess.md#dispose)
- [getCamera](VRMultiviewToSingleviewPostProcess.md#getcamera)
- [getClassName](VRMultiviewToSingleviewPostProcess.md#getclassname)
- [getEffect](VRMultiviewToSingleviewPostProcess.md#geteffect)
- [getEffectName](VRMultiviewToSingleviewPostProcess.md#geteffectname)
- [getEngine](VRMultiviewToSingleviewPostProcess.md#getengine)
- [isReady](VRMultiviewToSingleviewPostProcess.md#isready)
- [isReusable](VRMultiviewToSingleviewPostProcess.md#isreusable)
- [markTextureDirty](VRMultiviewToSingleviewPostProcess.md#marktexturedirty)
- [restoreDefaultInputTexture](VRMultiviewToSingleviewPostProcess.md#restoredefaultinputtexture)
- [serialize](VRMultiviewToSingleviewPostProcess.md#serialize)
- [setPrePassRenderer](VRMultiviewToSingleviewPostProcess.md#setprepassrenderer)
- [shareOutputWith](VRMultiviewToSingleviewPostProcess.md#shareoutputwith)
- [updateEffect](VRMultiviewToSingleviewPostProcess.md#updateeffect)
- [useOwnOutput](VRMultiviewToSingleviewPostProcess.md#useownoutput)
- [Parse](VRMultiviewToSingleviewPostProcess.md#parse)

## Constructors

### constructor

• **new VRMultiviewToSingleviewPostProcess**(`name`, `camera`, `scaleFactor`)
...
| :------ | :------ | :------ |
| `name` | `string` | name of the post process |
| `camera` | [`Camera`](Camera.md) | camera to be applied to |
| `scaleFactor` | `number` | scaling factor to the size of the output texture |
...
https://github.com/babylon.js/core/src/PostProcesses/vrMultiviewToSingleviewPostProcess.ts:28
...
https://github.com/babylon.js/core/src/PostProcesses/vrMultiviewToSingleviewPostProcess.ts:18
