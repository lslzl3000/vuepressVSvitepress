[@dev/core](../README.md) / [Exports](../modules.md) / FrontFacingBlock
...
- [constructor](FrontFacingBlock.md#constructor)

### Properties

- [\_isUnique](FrontFacingBlock.md#_isunique)
- [\_target](FrontFacingBlock.md#_target)
- [comments](FrontFacingBlock.md#comments)
- [inputsAreExclusive](FrontFacingBlock.md#inputsareexclusive)
- [uniqueId](FrontFacingBlock.md#uniqueid)
- [visibleInInspector](FrontFacingBlock.md#visibleininspector)
- [visibleOnFrame](FrontFacingBlock.md#visibleonframe)

### Accessors

- [buildId](FrontFacingBlock.md#buildid)
- [inputs](FrontFacingBlock.md#inputs)
- [isFinalMerger](FrontFacingBlock.md#isfinalmerger)
- [isInput](FrontFacingBlock.md#isinput)
- [isUnique](FrontFacingBlock.md#isunique)
- [name](FrontFacingBlock.md#name)
- [output](FrontFacingBlock.md#output)
- [outputs](FrontFacingBlock.md#outputs)
- [target](FrontFacingBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](FrontFacingBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](FrontFacingBlock.md#_buildblock)
- [\_declareOutput](FrontFacingBlock.md#_declareoutput)
- [\_dumpPropertiesCode](FrontFacingBlock.md#_dumppropertiescode)
- [\_inputRename](FrontFacingBlock.md#_inputrename)
- [\_linkConnectionTypes](FrontFacingBlock.md#_linkconnectiontypes)
- [\_outputRename](FrontFacingBlock.md#_outputrename)
- [\_writeFloat](FrontFacingBlock.md#_writefloat)
- [\_writeVariable](FrontFacingBlock.md#_writevariable)
- [autoConfigure](FrontFacingBlock.md#autoconfigure)
- [bind](FrontFacingBlock.md#bind)
- [build](FrontFacingBlock.md#build)
- [clone](FrontFacingBlock.md#clone)
- [connectTo](FrontFacingBlock.md#connectto)
- [dispose](FrontFacingBlock.md#dispose)
- [getClassName](FrontFacingBlock.md#getclassname)
- [getFirstAvailableInput](FrontFacingBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](FrontFacingBlock.md#getfirstavailableoutput)
- [getInputByName](FrontFacingBlock.md#getinputbyname)
- [getOutputByName](FrontFacingBlock.md#getoutputbyname)
- [getSiblingOutput](FrontFacingBlock.md#getsiblingoutput)
- [initialize](FrontFacingBlock.md#initialize)
- [initializeDefines](FrontFacingBlock.md#initializedefines)
- [isAnAncestorOf](FrontFacingBlock.md#isanancestorof)
- [isReady](FrontFacingBlock.md#isready)
- [prepareDefines](FrontFacingBlock.md#preparedefines)
- [provideFallbacks](FrontFacingBlock.md#providefallbacks)
- [registerInput](FrontFacingBlock.md#registerinput)
- [registerOutput](FrontFacingBlock.md#registeroutput)
- [replaceRepeatableContent](FrontFacingBlock.md#replacerepeatablecontent)
- [serialize](FrontFacingBlock.md#serialize)
- [updateUniformsAndSamples](FrontFacingBlock.md#updateuniformsandsamples)
- [validateBlockName](FrontFacingBlock.md#validateblockname)

## Constructors

### constructor

• **new FrontFacingBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/frontFacingBlock.ts:15
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/frontFacingBlock.ts:32
...
▸ `Protected` **_buildBlock**(`state`): [`FrontFacingBlock`](FrontFacingBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/frontFacingBlock.ts:36
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`FrontFacingBlock`](FrontFacingBlock.md)
...
`undefined` \| [`FrontFacingBlock`](FrontFacingBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/frontFacingBlock.ts:25
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`FrontFacingBlock`](FrontFacingBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`FrontFacingBlock`](FrontFacingBlock.md)
