[@dev/core](../README.md) / [Exports](../modules.md) / MatrixBuilderBlock

# Class: MatrixBuilderBlock
...
- [constructor](MatrixBuilderBlock.md#constructor)

### Properties

- [\_isUnique](MatrixBuilderBlock.md#_isunique)
- [\_target](MatrixBuilderBlock.md#_target)
- [comments](MatrixBuilderBlock.md#comments)
- [inputsAreExclusive](MatrixBuilderBlock.md#inputsareexclusive)
- [uniqueId](MatrixBuilderBlock.md#uniqueid)
- [visibleInInspector](MatrixBuilderBlock.md#visibleininspector)
- [visibleOnFrame](MatrixBuilderBlock.md#visibleonframe)

### Accessors

- [buildId](MatrixBuilderBlock.md#buildid)
- [inputs](MatrixBuilderBlock.md#inputs)
- [isFinalMerger](MatrixBuilderBlock.md#isfinalmerger)
- [isInput](MatrixBuilderBlock.md#isinput)
- [isUnique](MatrixBuilderBlock.md#isunique)
- [name](MatrixBuilderBlock.md#name)
- [output](MatrixBuilderBlock.md#output)
- [outputs](MatrixBuilderBlock.md#outputs)
- [row0](MatrixBuilderBlock.md#row0)
- [row1](MatrixBuilderBlock.md#row1)
- [row2](MatrixBuilderBlock.md#row2)
- [row3](MatrixBuilderBlock.md#row3)
- [target](MatrixBuilderBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](MatrixBuilderBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](MatrixBuilderBlock.md#_buildblock)
- [\_declareOutput](MatrixBuilderBlock.md#_declareoutput)
- [\_dumpPropertiesCode](MatrixBuilderBlock.md#_dumppropertiescode)
- [\_inputRename](MatrixBuilderBlock.md#_inputrename)
- [\_linkConnectionTypes](MatrixBuilderBlock.md#_linkconnectiontypes)
- [\_outputRename](MatrixBuilderBlock.md#_outputrename)
- [\_writeFloat](MatrixBuilderBlock.md#_writefloat)
- [\_writeVariable](MatrixBuilderBlock.md#_writevariable)
- [autoConfigure](MatrixBuilderBlock.md#autoconfigure)
- [bind](MatrixBuilderBlock.md#bind)
- [build](MatrixBuilderBlock.md#build)
- [clone](MatrixBuilderBlock.md#clone)
- [connectTo](MatrixBuilderBlock.md#connectto)
- [dispose](MatrixBuilderBlock.md#dispose)
- [getClassName](MatrixBuilderBlock.md#getclassname)
- [getFirstAvailableInput](MatrixBuilderBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](MatrixBuilderBlock.md#getfirstavailableoutput)
- [getInputByName](MatrixBuilderBlock.md#getinputbyname)
- [getOutputByName](MatrixBuilderBlock.md#getoutputbyname)
- [getSiblingOutput](MatrixBuilderBlock.md#getsiblingoutput)
- [initialize](MatrixBuilderBlock.md#initialize)
- [initializeDefines](MatrixBuilderBlock.md#initializedefines)
- [isAnAncestorOf](MatrixBuilderBlock.md#isanancestorof)
- [isReady](MatrixBuilderBlock.md#isready)
- [prepareDefines](MatrixBuilderBlock.md#preparedefines)
- [provideFallbacks](MatrixBuilderBlock.md#providefallbacks)
- [registerInput](MatrixBuilderBlock.md#registerinput)
- [registerOutput](MatrixBuilderBlock.md#registeroutput)
- [replaceRepeatableContent](MatrixBuilderBlock.md#replacerepeatablecontent)
- [serialize](MatrixBuilderBlock.md#serialize)
- [updateUniformsAndSamples](MatrixBuilderBlock.md#updateuniformsandsamples)
- [validateBlockName](MatrixBuilderBlock.md#validateblockname)

## Constructors

### constructor

• **new MatrixBuilderBlock**(`name`)
...
packages/dev/core/src/Materials/Node/Blocks/matrixBuilderBlock.ts:18
...
packages/dev/core/src/Materials/Node/Blocks/matrixBuilderBlock.ts:67
...
• `get` **row0**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/matrixBuilderBlock.ts:39

___

### row1

• `get` **row1**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/matrixBuilderBlock.ts:46

___

### row2

• `get` **row2**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/matrixBuilderBlock.ts:53

___

### row3

• `get` **row3**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/matrixBuilderBlock.ts:60
...
▸ `Protected` **_buildBlock**(`state`): [`MatrixBuilderBlock`](MatrixBuilderBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/matrixBuilderBlock.ts:97
...
packages/dev/core/src/Materials/Node/Blocks/matrixBuilderBlock.ts:71
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`MatrixBuilderBlock`](MatrixBuilderBlock.md)
...
`undefined` \| [`MatrixBuilderBlock`](MatrixBuilderBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/matrixBuilderBlock.ts:32
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`MatrixBuilderBlock`](MatrixBuilderBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`MatrixBuilderBlock`](MatrixBuilderBlock.md)
