[@dev/core](../README.md) / [Exports](../modules.md) / WebGPUEngine
...
- [\_renderTargetEncoderDescriptor](WebGPUEngine.md#_rendertargetencoderdescriptor)
...
- [validateShaderPrograms](WebGPUEngine.md#validateshaderprograms)
...
- [TEXTURETYPE\_UNSIGNED\_INT\_10F\_11F\_11F\_REV](WebGPUEngine.md#texturetype_unsigned_int_10f_11f_11f_rev)
...
- [frameId](WebGPUEngine.md#frameid)
...
- [\_mustUpdateStencilRef](WebGPUEngine.md#_mustupdatestencilref)
...
- [createPipelineContext](WebGPUEngine.md#createpipelinecontext)
...
- [getFragmentShaderSource](WebGPUEngine.md#getfragmentshadersource)
...
- [setDepthFunctionToGreater](WebGPUEngine.md#setdepthfunctiontogreater)
...
- [updateVideoTexture](WebGPUEngine.md#updatevideotexture)
...
• `Private` **\_blendColorsCurrent**: [`Nullable`](../modules.md#nullable)`number`[][]
...
• `Private` **\_colorFormat**: ``null`` \| `GPUTextureFormat`
...
• `Private` `Readonly` **\_defaultSampleCount**: ``4``
...
packages/dev/core/src/Engines/webgpuEngine.ts:236
...
packages/dev/core/src/Engines/webgpuEngine.ts:344
...
packages/dev/core/src/Engines/webgpuEngine.ts:217
...
packages/dev/core/src/Engines/webgpuEngine.ts:198
...
packages/dev/core/src/Engines/webgpuEngine.ts:458
...
packages/dev/core/src/Engines/webgpuEngine.ts:405
...
packages/dev/core/src/Engines/webgpuEngine.ts:409
...
packages/dev/core/src/Engines/webgpuEngine.ts:392
...
packages/dev/core/src/Engines/webgpuEngine.ts:396
...
packages/dev/core/src/Engines/webgpuEngine.ts:379
...
packages/dev/core/src/Engines/webgpuEngine.ts:383
...
packages/dev/core/src/Engines/webgpuEngine.ts:451
...
packages/dev/core/src/Engines/webgpuEngine.ts:1878
...
packages/dev/core/src/Engines/webgpuEngine.ts:368
...
packages/dev/core/src/Engines/webgpuEngine.ts:372
...
packages/dev/core/src/Engines/webgpuEngine.ts:349
...
packages/dev/core/src/Engines/webgpuEngine.ts:353
...
packages/dev/core/src/Engines/webgpuEngine.ts:446
...
packages/dev/core/src/Engines/webgpuEngine.ts:441
...
packages/dev/core/src/Engines/webgpuEngine.ts:467
...
packages/dev/core/src/Engines/webgpuEngine.ts:433
...
packages/dev/core/src/Engines/webgpuEngine.ts:418
...
▸ `Private` **_applyBlendColor**(`renderPass`): `void`
...
packages/dev/core/src/Engines/webgpuEngine.ts:1279

___

### \_applyRenderPassChanges

▸ `Private` **_applyRenderPassChanges**(`renderPass`, `bundleList`): `void`
...
| :------ | :------ |
| `renderPass` | `GPURenderPassEncoder` |
| `bundleList` | [`Nullable`](../modules.md#nullable)`WebGPUBundleList` |
...
packages/dev/core/src/Engines/webgpuEngine.ts:3228

___

### \_applyScissor

▸ `Private` **_applyScissor**(`renderPass`): `void`
...
packages/dev/core/src/Engines/webgpuEngine.ts:1181

___

### \_applyViewport

▸ `Private` **_applyViewport**(`renderPass`): `void`
...
packages/dev/core/src/Engines/webgpuEngine.ts:1107

___

### \_clearFullQuad

▸ `Private` **_clearFullQuad**(`clearColor?`, `clearDepth?`, `clearStencil?`): `void`

#### Parameters

| Name | Type |
| :------ | :------ |
| `clearColor?` | [`Nullable`](../modules.md#nullable)`IColor4Like` |
| `clearDepth?` | `boolean` |
...
packages/dev/core/src/Engines/webgpuEngine.ts:1349

___

### \_compilePipelineStageDescriptor

▸ `Private` **_compilePipelineStageDescriptor**(`vertexCode`, `fragmentCode`, `defines`, `shaderLanguage`): `IWebGPURenderPipelineStageDescriptor`
...
| `shaderLanguage` | [`ShaderLanguage`](../enums/ShaderLanguage.md) |
...
packages/dev/core/src/Engines/webgpuEngine.ts:1637

___

### \_compileRawPipelineStageDescriptor

▸ `Private` **_compileRawPipelineStageDescriptor**(`vertexCode`, `fragmentCode`, `shaderLanguage`): `IWebGPURenderPipelineStageDescriptor`
...
packages/dev/core/src/Engines/webgpuEngine.ts:1630

___

### \_compileRawShaderToSpirV

▸ `Private` **_compileRawShaderToSpirV**(`source`, `type`): `Uint32Array`
...
packages/dev/core/src/Engines/webgpuEngine.ts:1587

___

### \_compileShaderToSpirV

▸ `Private` **_compileShaderToSpirV**(`source`, `type`, `defines`, `shaderVersion`): `Uint32Array`
...
packages/dev/core/src/Engines/webgpuEngine.ts:1591
...
packages/dev/core/src/Engines/webgpuEngine.ts:937
...
▸ `Private` **_createPipelineStageDescriptor**(`vertexShader`, `fragmentShader`, `shaderLanguage`): `IWebGPURenderPipelineStageDescriptor`

#### Parameters

| Name | Type |
| :------ | :------ |
| `vertexShader` | `string` \| `Uint32Array` |
| `fragmentShader` | `string` \| `Uint32Array` |
| `shaderLanguage` | [`ShaderLanguage`](../enums/ShaderLanguage.md) |
...
packages/dev/core/src/Engines/webgpuEngine.ts:1604
...
packages/dev/core/src/Engines/webgpuEngine.ts:1863
...
▸ `Private` **_draw**(`drawType`, `fillMode`, `start`, `count`, `instancesCount`): `void`
...
packages/dev/core/src/Engines/webgpuEngine.ts:3263
...
packages/dev/core/src/Engines/webgpuEngine.ts:2956
...
packages/dev/core/src/Engines/webgpuEngine.ts:2870

___

### \_getWGSLShader

▸ `Private` **_getWGSLShader**(`source`, `type`, `defines`): `string`
...
packages/dev/core/src/Engines/webgpuEngine.ts:1595
...
▸ `Private` **_initGlslang**(`glslangOptions?`): `Promise``any`

#### Parameters

| Name | Type |
| :------ | :------ |
| `glslangOptions?` | [`GlslangOptions`](../interfaces/GlslangOptions.md) |
...
packages/dev/core/src/Engines/webgpuEngine.ts:732
...
packages/dev/core/src/Engines/webgpuEngine.ts:845
...
packages/dev/core/src/Engines/webgpuEngine.ts:761
...
packages/dev/core/src/Engines/webgpuEngine.ts:854

___

### \_mustUpdateBlendColor

▸ `Private` **_mustUpdateBlendColor**(`renderPass`): `boolean`
...
packages/dev/core/src/Engines/webgpuEngine.ts:1259

___

### \_mustUpdateScissor

▸ `Private` **_mustUpdateScissor**(`renderPass`): `boolean`
...
packages/dev/core/src/Engines/webgpuEngine.ts:1161

___

### \_mustUpdateStencilRef

▸ `Private` **_mustUpdateStencilRef**(`renderPass`): `boolean`
...
packages/dev/core/src/Engines/webgpuEngine.ts:1233

___

### \_mustUpdateViewport

▸ `Private` **_mustUpdateViewport**(`renderPass`): `boolean`
...
packages/dev/core/src/Engines/webgpuEngine.ts:1086
...
### \_resetCurrentColorBlend

▸ `Private` **_resetCurrentColorBlend**(`index`): `void`
...
packages/dev/core/src/Engines/webgpuEngine.ts:1255

___

### \_resetCurrentScissor

▸ `Private` **_resetCurrentScissor**(`index`): `void`
...
packages/dev/core/src/Engines/webgpuEngine.ts:1154

___

### \_resetCurrentStencilRef

▸ `Private` **_resetCurrentStencilRef**(`index`): `void`
...
packages/dev/core/src/Engines/webgpuEngine.ts:1229

___

### \_resetCurrentViewport

▸ `Private` **_resetCurrentViewport**(`index`): `void`
...
packages/dev/core/src/Engines/webgpuEngine.ts:1072
...
▸ `Private` **_scissorIsActive**(): `boolean`
...
packages/dev/core/src/Engines/webgpuEngine.ts:1206
...
▸ `Protected` **_setTexture**(`channel`, `texture`, `isPartOfTextureArray?`, `depthStencilTexture?`, `name?`, `baseName?`): `boolean`
...
| `texture` | [`Nullable`](../modules.md#nullable)[`BaseTexture`](BaseTexture.md) | `undefined` |
...
packages/dev/core/src/Engines/webgpuEngine.ts:2248
...
▸ `Private` **_startMainRenderPass**(`setClearStates`, `clearColor?`, `clearDepth?`, `clearStencil?`): `void`
...
packages/dev/core/src/Engines/webgpuEngine.ts:2886

___

### \_startRenderTargetRenderPass

▸ `Private` **_startRenderTargetRenderPass**(`renderTargetWrapper`, `setClearStates`, `clearColor`, `clearDepth`, `clearStencil`): `void`

#### Parameters

| Name | Type |
| :------ | :------ |
| `renderTargetWrapper` | [`RenderTargetWrapper`](RenderTargetWrapper.md) |
| `setClearStates` | `boolean` |
| `clearColor` | [`Nullable`](../modules.md#nullable)`IColor4Like` |
| `clearDepth` | `boolean` |
| `clearStencil` | `boolean` |
...
packages/dev/core/src/Engines/webgpuEngine.ts:2706
...
packages/dev/core/src/Engines/webgpuEngine.ts:3497
...
packages/dev/core/src/Engines/webgpuEngine.ts:2573
...
packages/dev/core/src/Engines/webgpuEngine.ts:1500
...
packages/dev/core/src/Engines/webgpuEngine.ts:2994
...
packages/dev/core/src/Engines/webgpuEngine.ts:1290
...
packages/dev/core/src/Engines/webgpuEngine.ts:1707
...
packages/dev/core/src/Engines/webgpuEngine.ts:1408
...
| `uniformsNamesOrEngine` | `string`[] \| [`Engine`](Engine.md) | `undefined` | defines either a list of uniform names or the engine to use |
...
| `fallbacks?` | [`EffectFallbacks`](EffectFallbacks.md) | `undefined` | defines the list of potential fallbacks to use if shader compilation fails |
...
packages/dev/core/src/Engines/webgpuEngine.ts:1537
...
packages/dev/core/src/Engines/webgpuEngine.ts:1417
...
`undefined` \| `WebGPUMaterialContext`
...
packages/dev/core/src/Engines/webgpuEngine.ts:1699
...
packages/dev/core/src/Engines/webgpuEngine.ts:1691
...
packages/dev/core/src/Engines/webgpuEngine.ts:2010
...
packages/dev/core/src/Engines/webgpuEngine.ts:1388
...
packages/dev/core/src/Engines/webgpuEngine.ts:1217
...
packages/dev/core/src/Engines/webgpuEngine.ts:3419
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `fillMode` | `number` | `undefined` | defines the primitive to use |
| `verticesStart` | `number` | `undefined` | defines the index of first vertex to draw |
| `verticesCount` | `number` | `undefined` | defines the count of vertices to draw |
| `instancesCount` | `number` | `1` | defines the number of instances to draw (if instantiation is enabled) |
...
packages/dev/core/src/Engines/webgpuEngine.ts:3407
...
| :------ | :------ | :------ | :------ |
| `fillMode` | `number` | `undefined` | defines the primitive to use |
| `indexStart` | `number` | `undefined` | defines the starting index |
| `indexCount` | `number` | `undefined` | defines the number of index to draw |
| `instancesCount` | `number` | `1` | defines the number of instances to draw (if instantiation is enabled) |
...
packages/dev/core/src/Engines/webgpuEngine.ts:3396
...
packages/dev/core/src/Engines/webgpuEngine.ts:1782
...
packages/dev/core/src/Engines/webgpuEngine.ts:1210
...
packages/dev/core/src/Engines/webgpuEngine.ts:2580
...
▸ **flushFramebuffer**(`reopenPass?`): `void`
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `reopenPass` | `boolean` | `true` | true to reopen at the end of the function the pass that was active when entering the function |
...
packages/dev/core/src/Engines/webgpuEngine.ts:2653
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `texture` | [`InternalTexture`](InternalTexture.md) | defines the render target texture to use |
...
packages/dev/core/src/Engines/webgpuEngine.ts:2130
...
packages/dev/core/src/Engines/webgpuEngine.ts:2359
...
packages/dev/core/src/Engines/webgpuEngine.ts:1761
...
packages/dev/core/src/Engines/webgpuEngine.ts:1058
...
[Engine](Engine.md).[getError](Engine.md#geterror)

#### Defined in

packages/dev/core/src/Engines/webgpuEngine.ts:3472
...
packages/dev/core/src/Engines/webgpuEngine.ts:475
...
packages/dev/core/src/Engines/webgpuEngine.ts:3448
...
packages/dev/core/src/Engines/webgpuEngine.ts:3435
...
packages/dev/core/src/Engines/webgpuEngine.ts:3460
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `glslangOptions?` | [`GlslangOptions`](../interfaces/GlslangOptions.md) | Defines the GLSLang compiler options if necessary |
| `twgslOptions?` | [`TwgslOptions`](../interfaces/TwgslOptions.md) | Defines the Twgsl compiler options if necessary |
...
packages/dev/core/src/Engines/webgpuEngine.ts:590
...
packages/dev/core/src/Engines/webgpuEngine.ts:1679
...
packages/dev/core/src/Engines/webgpuEngine.ts:2547
...
packages/dev/core/src/Engines/webgpuEngine.ts:1854
...
packages/dev/core/src/Engines/webgpuEngine.ts:3139
...
packages/dev/core/src/Engines/webgpuEngine.ts:1049
...
packages/dev/core/src/Engines/webgpuEngine.ts:3185
...
packages/dev/core/src/Engines/webgpuEngine.ts:3189
...
packages/dev/core/src/Engines/webgpuEngine.ts:953
...
packages/dev/core/src/Engines/webgpuEngine.ts:3203
...
| :------ | :------ | :------ |
| `channel` | `number` | The texture channel |
| `unused` | [`Nullable`](../modules.md#nullable)`WebGLUniformLocation` | unused parameter |
| `texture` | [`Nullable`](../modules.md#nullable)[`BaseTexture`](BaseTexture.md) | The texture to apply |
| `name` | `string` | The name of the uniform in the effect |
...
packages/dev/core/src/Engines/webgpuEngine.ts:2231
...
| `unused` | [`Nullable`](../modules.md#nullable)`WebGLUniformLocation` | unused parameter |
| `textures` | [`BaseTexture`](BaseTexture.md)[] | defines the array of textures to bind |
...
packages/dev/core/src/Engines/webgpuEngine.ts:2242
...
packages/dev/core/src/Engines/webgpuEngine.ts:360
...
packages/dev/core/src/Engines/webgpuEngine.ts:3096
...
packages/dev/core/src/Engines/webgpuEngine.ts:1907
...
packages/dev/core/src/Engines/webgpuEngine.ts:2412
...
packages/dev/core/src/Engines/webgpuEngine.ts:2186
...
packages/dev/core/src/Engines/webgpuEngine.ts:2151
...
packages/dev/core/src/Engines/webgpuEngine.ts:2167
...
packages/dev/core/src/Engines/webgpuEngine.ts:1013
...
packages/dev/core/src/Engines/webgpuEngine.ts:2126
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `texture` | `GPUTexture` | defines the external texture |
...
packages/dev/core/src/Engines/webgpuEngine.ts:2114
...
▸ `Static` **CreateAsync**(`canvas`, `options?`): `Promise`[`WebGPUEngine`](WebGPUEngine.md)
...
`Promise`[`WebGPUEngine`](WebGPUEngine.md)

a promise that resolves with the created engine

#### Defined in

packages/dev/core/src/Engines/webgpuEngine.ts:507
