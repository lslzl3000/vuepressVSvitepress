[@dev/core](../README.md) / [Exports](../modules.md) / BlackAndWhitePostProcess
...
- [constructor](BlackAndWhitePostProcess.md#constructor)

### Properties

- [\_indexParameters](BlackAndWhitePostProcess.md#_indexparameters)
- [\_postProcessDefines](BlackAndWhitePostProcess.md#_postprocessdefines)
- [\_scene](BlackAndWhitePostProcess.md#_scene)
- [adaptScaleToCurrentViewport](BlackAndWhitePostProcess.md#adaptscaletocurrentviewport)
- [alphaConstants](BlackAndWhitePostProcess.md#alphaconstants)
- [alphaMode](BlackAndWhitePostProcess.md#alphamode)
- [alwaysForcePOT](BlackAndWhitePostProcess.md#alwaysforcepot)
- [animations](BlackAndWhitePostProcess.md#animations)
- [autoClear](BlackAndWhitePostProcess.md#autoclear)
- [clearColor](BlackAndWhitePostProcess.md#clearcolor)
- [degree](BlackAndWhitePostProcess.md#degree)
- [enablePixelPerfectMode](BlackAndWhitePostProcess.md#enablepixelperfectmode)
- [externalTextureSamplerBinding](BlackAndWhitePostProcess.md#externaltexturesamplerbinding)
- [forceFullscreenViewport](BlackAndWhitePostProcess.md#forcefullscreenviewport)
- [height](BlackAndWhitePostProcess.md#height)
- [inspectableCustomProperties](BlackAndWhitePostProcess.md#inspectablecustomproperties)
- [name](BlackAndWhitePostProcess.md#name)
- [nodeMaterialSource](BlackAndWhitePostProcess.md#nodematerialsource)
- [onActivateObservable](BlackAndWhitePostProcess.md#onactivateobservable)
- [onAfterRenderObservable](BlackAndWhitePostProcess.md#onafterrenderobservable)
- [onApplyObservable](BlackAndWhitePostProcess.md#onapplyobservable)
- [onBeforeRenderObservable](BlackAndWhitePostProcess.md#onbeforerenderobservable)
- [onSizeChangedObservable](BlackAndWhitePostProcess.md#onsizechangedobservable)
- [renderTargetSamplingMode](BlackAndWhitePostProcess.md#rendertargetsamplingmode)
- [scaleMode](BlackAndWhitePostProcess.md#scalemode)
- [uniqueId](BlackAndWhitePostProcess.md#uniqueid)
- [width](BlackAndWhitePostProcess.md#width)

### Accessors

- [aspectRatio](BlackAndWhitePostProcess.md#aspectratio)
- [inputTexture](BlackAndWhitePostProcess.md#inputtexture)
- [isSupported](BlackAndWhitePostProcess.md#issupported)
- [onActivate](BlackAndWhitePostProcess.md#onactivate)
- [onAfterRender](BlackAndWhitePostProcess.md#onafterrender)
- [onApply](BlackAndWhitePostProcess.md#onapply)
- [onBeforeRender](BlackAndWhitePostProcess.md#onbeforerender)
- [onSizeChanged](BlackAndWhitePostProcess.md#onsizechanged)
- [samples](BlackAndWhitePostProcess.md#samples)
- [texelSize](BlackAndWhitePostProcess.md#texelsize)

### Methods

- [activate](BlackAndWhitePostProcess.md#activate)
- [apply](BlackAndWhitePostProcess.md#apply)
- [clone](BlackAndWhitePostProcess.md#clone)
- [dispose](BlackAndWhitePostProcess.md#dispose)
- [getCamera](BlackAndWhitePostProcess.md#getcamera)
- [getClassName](BlackAndWhitePostProcess.md#getclassname)
- [getEffect](BlackAndWhitePostProcess.md#geteffect)
- [getEffectName](BlackAndWhitePostProcess.md#geteffectname)
- [getEngine](BlackAndWhitePostProcess.md#getengine)
- [isReady](BlackAndWhitePostProcess.md#isready)
- [isReusable](BlackAndWhitePostProcess.md#isreusable)
- [markTextureDirty](BlackAndWhitePostProcess.md#marktexturedirty)
- [restoreDefaultInputTexture](BlackAndWhitePostProcess.md#restoredefaultinputtexture)
- [serialize](BlackAndWhitePostProcess.md#serialize)
- [setPrePassRenderer](BlackAndWhitePostProcess.md#setprepassrenderer)
- [shareOutputWith](BlackAndWhitePostProcess.md#shareoutputwith)
- [updateEffect](BlackAndWhitePostProcess.md#updateeffect)
- [useOwnOutput](BlackAndWhitePostProcess.md#useownoutput)
- [Parse](BlackAndWhitePostProcess.md#parse)

## Constructors

### constructor

• **new BlackAndWhitePostProcess**(`name`, `options`, `camera`, `samplingMode?`, `engine?`, `reusable?`)
...
https://github.com/babylon.js/core/src/PostProcesses/blackAndWhitePostProcess.ts:42
...
https://github.com/babylon.js/core/src/PostProcesses/blackAndWhitePostProcess.ts:22
...
"BlackAndWhitePostProcess" string
...
https://github.com/babylon.js/core/src/PostProcesses/blackAndWhitePostProcess.ts:28
