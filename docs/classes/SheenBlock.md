[@dev/core](../README.md) / [Exports](../modules.md) / SheenBlock
...
- [constructor](SheenBlock.md#constructor)

### Properties

- [\_isUnique](SheenBlock.md#_isunique)
- [\_target](SheenBlock.md#_target)
- [albedoScaling](SheenBlock.md#albedoscaling)
- [comments](SheenBlock.md#comments)
- [inputsAreExclusive](SheenBlock.md#inputsareexclusive)
- [linkSheenWithAlbedo](SheenBlock.md#linksheenwithalbedo)
- [uniqueId](SheenBlock.md#uniqueid)
- [visibleInInspector](SheenBlock.md#visibleininspector)
- [visibleOnFrame](SheenBlock.md#visibleonframe)

### Accessors

- [buildId](SheenBlock.md#buildid)
- [color](SheenBlock.md#color)
- [inputs](SheenBlock.md#inputs)
- [intensity](SheenBlock.md#intensity)
- [isFinalMerger](SheenBlock.md#isfinalmerger)
- [isInput](SheenBlock.md#isinput)
- [isUnique](SheenBlock.md#isunique)
- [name](SheenBlock.md#name)
- [outputs](SheenBlock.md#outputs)
- [roughness](SheenBlock.md#roughness)
- [sheen](SheenBlock.md#sheen)
- [target](SheenBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](SheenBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](SheenBlock.md#_buildblock)
- [\_declareOutput](SheenBlock.md#_declareoutput)
- [\_deserialize](SheenBlock.md#_deserialize)
- [\_dumpPropertiesCode](SheenBlock.md#_dumppropertiescode)
- [\_inputRename](SheenBlock.md#_inputrename)
- [\_linkConnectionTypes](SheenBlock.md#_linkconnectiontypes)
- [\_outputRename](SheenBlock.md#_outputrename)
- [\_writeFloat](SheenBlock.md#_writefloat)
- [\_writeVariable](SheenBlock.md#_writevariable)
- [autoConfigure](SheenBlock.md#autoconfigure)
- [bind](SheenBlock.md#bind)
- [build](SheenBlock.md#build)
- [clone](SheenBlock.md#clone)
- [connectTo](SheenBlock.md#connectto)
- [dispose](SheenBlock.md#dispose)
- [getClassName](SheenBlock.md#getclassname)
- [getCode](SheenBlock.md#getcode)
- [getFirstAvailableInput](SheenBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](SheenBlock.md#getfirstavailableoutput)
- [getInputByName](SheenBlock.md#getinputbyname)
- [getOutputByName](SheenBlock.md#getoutputbyname)
- [getSiblingOutput](SheenBlock.md#getsiblingoutput)
- [initialize](SheenBlock.md#initialize)
- [initializeDefines](SheenBlock.md#initializedefines)
- [isAnAncestorOf](SheenBlock.md#isanancestorof)
- [isReady](SheenBlock.md#isready)
- [prepareDefines](SheenBlock.md#preparedefines)
- [provideFallbacks](SheenBlock.md#providefallbacks)
- [registerInput](SheenBlock.md#registerinput)
- [registerOutput](SheenBlock.md#registeroutput)
- [replaceRepeatableContent](SheenBlock.md#replacerepeatablecontent)
- [serialize](SheenBlock.md#serialize)
- [updateUniformsAndSamples](SheenBlock.md#updateuniformsandsamples)
- [validateBlockName](SheenBlock.md#validateblockname)
...
packages/dev/core/src/Materials/Node/Blocks/PBR/sheenBlock.ts:24
...
packages/dev/core/src/Materials/Node/Blocks/PBR/sheenBlock.ts:47
...
packages/dev/core/src/Materials/Node/Blocks/PBR/sheenBlock.ts:53
...
packages/dev/core/src/Materials/Node/Blocks/PBR/sheenBlock.ts:84
...
packages/dev/core/src/Materials/Node/Blocks/PBR/sheenBlock.ts:77
...
packages/dev/core/src/Materials/Node/Blocks/PBR/sheenBlock.ts:91
...
packages/dev/core/src/Materials/Node/Blocks/PBR/sheenBlock.ts:98
...
▸ `Protected` **_buildBlock**(`state`): [`SheenBlock`](SheenBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/PBR/sheenBlock.ts:189
...
packages/dev/core/src/Materials/Node/Blocks/PBR/sheenBlock.ts:215
...
packages/dev/core/src/Materials/Node/Blocks/PBR/sheenBlock.ts:197
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`SheenBlock`](SheenBlock.md)
...
`undefined` \| [`SheenBlock`](SheenBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/PBR/sheenBlock.ts:70

___

### getCode

▸ **getCode**(`reflectionBlock`): `string`
...
packages/dev/core/src/Materials/Node/Blocks/PBR/sheenBlock.ts:117
...
packages/dev/core/src/Materials/Node/Blocks/PBR/sheenBlock.ts:59
...
packages/dev/core/src/Materials/Node/Blocks/PBR/sheenBlock.ts:102
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`SheenBlock`](SheenBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`SheenBlock`](SheenBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/PBR/sheenBlock.ts:206
