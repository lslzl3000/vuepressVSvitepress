[@dev/core](../README.md) / [Exports](../modules.md) / StereoscopicInterlacePostProcessI
...
- [constructor](StereoscopicInterlacePostProcessI.md#constructor)

### Properties

- [\_indexParameters](StereoscopicInterlacePostProcessI.md#_indexparameters)
- [\_passedProcess](StereoscopicInterlacePostProcessI.md#_passedprocess)
- [\_postProcessDefines](StereoscopicInterlacePostProcessI.md#_postprocessdefines)
- [\_scene](StereoscopicInterlacePostProcessI.md#_scene)
- [\_stepSize](StereoscopicInterlacePostProcessI.md#_stepsize)
- [adaptScaleToCurrentViewport](StereoscopicInterlacePostProcessI.md#adaptscaletocurrentviewport)
- [alphaConstants](StereoscopicInterlacePostProcessI.md#alphaconstants)
- [alphaMode](StereoscopicInterlacePostProcessI.md#alphamode)
- [alwaysForcePOT](StereoscopicInterlacePostProcessI.md#alwaysforcepot)
- [animations](StereoscopicInterlacePostProcessI.md#animations)
- [autoClear](StereoscopicInterlacePostProcessI.md#autoclear)
- [clearColor](StereoscopicInterlacePostProcessI.md#clearcolor)
- [enablePixelPerfectMode](StereoscopicInterlacePostProcessI.md#enablepixelperfectmode)
- [externalTextureSamplerBinding](StereoscopicInterlacePostProcessI.md#externaltexturesamplerbinding)
- [forceFullscreenViewport](StereoscopicInterlacePostProcessI.md#forcefullscreenviewport)
- [height](StereoscopicInterlacePostProcessI.md#height)
- [inspectableCustomProperties](StereoscopicInterlacePostProcessI.md#inspectablecustomproperties)
- [name](StereoscopicInterlacePostProcessI.md#name)
- [nodeMaterialSource](StereoscopicInterlacePostProcessI.md#nodematerialsource)
- [onActivateObservable](StereoscopicInterlacePostProcessI.md#onactivateobservable)
- [onAfterRenderObservable](StereoscopicInterlacePostProcessI.md#onafterrenderobservable)
- [onApplyObservable](StereoscopicInterlacePostProcessI.md#onapplyobservable)
- [onBeforeRenderObservable](StereoscopicInterlacePostProcessI.md#onbeforerenderobservable)
- [onSizeChangedObservable](StereoscopicInterlacePostProcessI.md#onsizechangedobservable)
- [renderTargetSamplingMode](StereoscopicInterlacePostProcessI.md#rendertargetsamplingmode)
- [scaleMode](StereoscopicInterlacePostProcessI.md#scalemode)
- [uniqueId](StereoscopicInterlacePostProcessI.md#uniqueid)
- [width](StereoscopicInterlacePostProcessI.md#width)

### Accessors

- [aspectRatio](StereoscopicInterlacePostProcessI.md#aspectratio)
- [inputTexture](StereoscopicInterlacePostProcessI.md#inputtexture)
- [isSupported](StereoscopicInterlacePostProcessI.md#issupported)
- [onActivate](StereoscopicInterlacePostProcessI.md#onactivate)
- [onAfterRender](StereoscopicInterlacePostProcessI.md#onafterrender)
- [onApply](StereoscopicInterlacePostProcessI.md#onapply)
- [onBeforeRender](StereoscopicInterlacePostProcessI.md#onbeforerender)
- [onSizeChanged](StereoscopicInterlacePostProcessI.md#onsizechanged)
- [samples](StereoscopicInterlacePostProcessI.md#samples)
- [texelSize](StereoscopicInterlacePostProcessI.md#texelsize)

### Methods

- [activate](StereoscopicInterlacePostProcessI.md#activate)
- [apply](StereoscopicInterlacePostProcessI.md#apply)
- [clone](StereoscopicInterlacePostProcessI.md#clone)
- [dispose](StereoscopicInterlacePostProcessI.md#dispose)
- [getCamera](StereoscopicInterlacePostProcessI.md#getcamera)
- [getClassName](StereoscopicInterlacePostProcessI.md#getclassname)
- [getEffect](StereoscopicInterlacePostProcessI.md#geteffect)
- [getEffectName](StereoscopicInterlacePostProcessI.md#geteffectname)
- [getEngine](StereoscopicInterlacePostProcessI.md#getengine)
- [isReady](StereoscopicInterlacePostProcessI.md#isready)
- [isReusable](StereoscopicInterlacePostProcessI.md#isreusable)
- [markTextureDirty](StereoscopicInterlacePostProcessI.md#marktexturedirty)
- [restoreDefaultInputTexture](StereoscopicInterlacePostProcessI.md#restoredefaultinputtexture)
- [serialize](StereoscopicInterlacePostProcessI.md#serialize)
- [setPrePassRenderer](StereoscopicInterlacePostProcessI.md#setprepassrenderer)
- [shareOutputWith](StereoscopicInterlacePostProcessI.md#shareoutputwith)
- [updateEffect](StereoscopicInterlacePostProcessI.md#updateeffect)
- [useOwnOutput](StereoscopicInterlacePostProcessI.md#useownoutput)
- [Parse](StereoscopicInterlacePostProcessI.md#parse)

## Constructors

### constructor

• **new StereoscopicInterlacePostProcessI**(`name`, `rigCameras`, `isStereoscopicHoriz`, `isStereoscopicInterlaced`, `samplingMode?`, `engine?`, `reusable?`)
...
| `isStereoscopicInterlaced` | `boolean` | If the rendered results are alternate line interlaced |
...
https://github.com/babylon.js/core/src/PostProcesses/stereoscopicInterlacePostProcess.ts:35
...
https://github.com/babylon.js/core/src/PostProcesses/stereoscopicInterlacePostProcess.ts:15
...
https://github.com/babylon.js/core/src/PostProcesses/stereoscopicInterlacePostProcess.ts:14
...
"StereoscopicInterlacePostProcessI" string
...
https://github.com/babylon.js/core/src/PostProcesses/stereoscopicInterlacePostProcess.ts:21
