[@dev/core](../README.md) / [Exports](../modules.md) / RefractionBlock
...
- [constructor](RefractionBlock.md#constructor)

### Properties

- [\_isUnique](RefractionBlock.md#_isunique)
- [\_scene](RefractionBlock.md#_scene)
- [\_target](RefractionBlock.md#_target)
- [comments](RefractionBlock.md#comments)
- [inputsAreExclusive](RefractionBlock.md#inputsareexclusive)
- [invertRefractionY](RefractionBlock.md#invertrefractiony)
- [linkRefractionWithTransparency](RefractionBlock.md#linkrefractionwithtransparency)
- [texture](RefractionBlock.md#texture)
- [uniqueId](RefractionBlock.md#uniqueid)
- [useThicknessAsDepth](RefractionBlock.md#usethicknessasdepth)
- [visibleInInspector](RefractionBlock.md#visibleininspector)
- [visibleOnFrame](RefractionBlock.md#visibleonframe)

### Accessors

- [buildId](RefractionBlock.md#buildid)
- [hasTexture](RefractionBlock.md#hastexture)
- [inputs](RefractionBlock.md#inputs)
- [intensity](RefractionBlock.md#intensity)
- [isFinalMerger](RefractionBlock.md#isfinalmerger)
- [isInput](RefractionBlock.md#isinput)
- [isUnique](RefractionBlock.md#isunique)
- [name](RefractionBlock.md#name)
- [outputs](RefractionBlock.md#outputs)
- [refraction](RefractionBlock.md#refraction)
- [target](RefractionBlock.md#target)
- [tintAtDistance](RefractionBlock.md#tintatdistance)
- [view](RefractionBlock.md#view)
- [volumeIndexOfRefraction](RefractionBlock.md#volumeindexofrefraction)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](RefractionBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](RefractionBlock.md#_buildblock)
- [\_declareOutput](RefractionBlock.md#_declareoutput)
- [\_deserialize](RefractionBlock.md#_deserialize)
- [\_dumpPropertiesCode](RefractionBlock.md#_dumppropertiescode)
- [\_getTexture](RefractionBlock.md#_gettexture)
- [\_inputRename](RefractionBlock.md#_inputrename)
- [\_linkConnectionTypes](RefractionBlock.md#_linkconnectiontypes)
- [\_outputRename](RefractionBlock.md#_outputrename)
- [\_writeFloat](RefractionBlock.md#_writefloat)
- [\_writeVariable](RefractionBlock.md#_writevariable)
- [autoConfigure](RefractionBlock.md#autoconfigure)
- [bind](RefractionBlock.md#bind)
- [build](RefractionBlock.md#build)
- [clone](RefractionBlock.md#clone)
- [connectTo](RefractionBlock.md#connectto)
- [dispose](RefractionBlock.md#dispose)
- [getClassName](RefractionBlock.md#getclassname)
- [getCode](RefractionBlock.md#getcode)
- [getFirstAvailableInput](RefractionBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](RefractionBlock.md#getfirstavailableoutput)
- [getInputByName](RefractionBlock.md#getinputbyname)
- [getOutputByName](RefractionBlock.md#getoutputbyname)
- [getSiblingOutput](RefractionBlock.md#getsiblingoutput)
- [initialize](RefractionBlock.md#initialize)
- [initializeDefines](RefractionBlock.md#initializedefines)
- [isAnAncestorOf](RefractionBlock.md#isanancestorof)
- [isReady](RefractionBlock.md#isready)
- [prepareDefines](RefractionBlock.md#preparedefines)
- [provideFallbacks](RefractionBlock.md#providefallbacks)
- [registerInput](RefractionBlock.md#registerinput)
- [registerOutput](RefractionBlock.md#registeroutput)
- [replaceRepeatableContent](RefractionBlock.md#replacerepeatablecontent)
- [serialize](RefractionBlock.md#serialize)
- [updateUniformsAndSamples](RefractionBlock.md#updateuniformsandsamples)
- [validateBlockName](RefractionBlock.md#validateblockname)

## Constructors

### constructor

• **new RefractionBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:90
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:48
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:73
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:67
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:84
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:79
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:162
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:127
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:155
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:134
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:148

___

### volumeIndexOfRefraction

• `get` **volumeIndexOfRefraction**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:141
...
▸ `Protected` **_buildBlock**(`state`): [`RefractionBlock`](RefractionBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:351
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:390
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:357
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:166
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:174
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:226
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`RefractionBlock`](RefractionBlock.md)
...
`undefined` \| [`RefractionBlock`](RefractionBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:120
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:278
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:111
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:216
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:192
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`RefractionBlock`](RefractionBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`RefractionBlock`](RefractionBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/PBR/refractionBlock.ts:376
