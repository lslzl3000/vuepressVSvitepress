[@dev/core](../README.md) / [Exports](../modules.md) / ConditionalBlock
...
- [constructor](ConditionalBlock.md#constructor)

### Properties

- [\_isUnique](ConditionalBlock.md#_isunique)
- [\_target](ConditionalBlock.md#_target)
- [comments](ConditionalBlock.md#comments)
- [condition](ConditionalBlock.md#condition)
- [inputsAreExclusive](ConditionalBlock.md#inputsareexclusive)
- [uniqueId](ConditionalBlock.md#uniqueid)
- [visibleInInspector](ConditionalBlock.md#visibleininspector)
- [visibleOnFrame](ConditionalBlock.md#visibleonframe)

### Accessors

- [a](ConditionalBlock.md#a)
- [b](ConditionalBlock.md#b)
- [buildId](ConditionalBlock.md#buildid)
- [false](ConditionalBlock.md#false)
- [inputs](ConditionalBlock.md#inputs)
- [isFinalMerger](ConditionalBlock.md#isfinalmerger)
- [isInput](ConditionalBlock.md#isinput)
- [isUnique](ConditionalBlock.md#isunique)
- [name](ConditionalBlock.md#name)
- [output](ConditionalBlock.md#output)
- [outputs](ConditionalBlock.md#outputs)
- [target](ConditionalBlock.md#target)
- [true](ConditionalBlock.md#true)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](ConditionalBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](ConditionalBlock.md#_buildblock)
- [\_declareOutput](ConditionalBlock.md#_declareoutput)
- [\_deserialize](ConditionalBlock.md#_deserialize)
- [\_dumpPropertiesCode](ConditionalBlock.md#_dumppropertiescode)
- [\_inputRename](ConditionalBlock.md#_inputrename)
- [\_linkConnectionTypes](ConditionalBlock.md#_linkconnectiontypes)
- [\_outputRename](ConditionalBlock.md#_outputrename)
- [\_writeFloat](ConditionalBlock.md#_writefloat)
- [\_writeVariable](ConditionalBlock.md#_writevariable)
- [autoConfigure](ConditionalBlock.md#autoconfigure)
- [bind](ConditionalBlock.md#bind)
- [build](ConditionalBlock.md#build)
- [clone](ConditionalBlock.md#clone)
- [connectTo](ConditionalBlock.md#connectto)
- [dispose](ConditionalBlock.md#dispose)
- [getClassName](ConditionalBlock.md#getclassname)
- [getFirstAvailableInput](ConditionalBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](ConditionalBlock.md#getfirstavailableoutput)
- [getInputByName](ConditionalBlock.md#getinputbyname)
- [getOutputByName](ConditionalBlock.md#getoutputbyname)
- [getSiblingOutput](ConditionalBlock.md#getsiblingoutput)
- [initialize](ConditionalBlock.md#initialize)
- [initializeDefines](ConditionalBlock.md#initializedefines)
- [isAnAncestorOf](ConditionalBlock.md#isanancestorof)
- [isReady](ConditionalBlock.md#isready)
- [prepareDefines](ConditionalBlock.md#preparedefines)
- [provideFallbacks](ConditionalBlock.md#providefallbacks)
- [registerInput](ConditionalBlock.md#registerinput)
- [registerOutput](ConditionalBlock.md#registeroutput)
- [replaceRepeatableContent](ConditionalBlock.md#replacerepeatablecontent)
- [serialize](ConditionalBlock.md#serialize)
- [updateUniformsAndSamples](ConditionalBlock.md#updateuniformsandsamples)
- [validateBlockName](ConditionalBlock.md#validateblockname)

## Constructors

### constructor

• **new ConditionalBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/conditionalBlock.ts:47
...
• **condition**: [`ConditionalBlockConditions`](../enums/ConditionalBlockConditions.md) = `ConditionalBlockConditions.LessThan`

Gets or sets the condition applied by the block

#### Defined in

https://github.com/babylon.js/core/src/Materials/Node/Blocks/conditionalBlock.ts:41
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/conditionalBlock.ts:72
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/conditionalBlock.ts:79
...
• `get` **false**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/conditionalBlock.ts:93
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/conditionalBlock.ts:100
...
• `get` **true**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/conditionalBlock.ts:86
...
▸ `Protected` **_buildBlock**(`state`): [`ConditionalBlock`](ConditionalBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/conditionalBlock.ts:104
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/conditionalBlock.ts:174
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/conditionalBlock.ts:180
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`ConditionalBlock`](ConditionalBlock.md)
...
`undefined` \| [`ConditionalBlock`](ConditionalBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/conditionalBlock.ts:65
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`ConditionalBlock`](ConditionalBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`ConditionalBlock`](ConditionalBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/conditionalBlock.ts:166
