[@dev/core](../README.md) / [Exports](../modules.md) / LightInformationBlock
...
- [constructor](LightInformationBlock.md#constructor)

### Properties

- [\_forcePrepareDefines](LightInformationBlock.md#_forcepreparedefines)
- [\_isUnique](LightInformationBlock.md#_isunique)
- [\_lightColorUniformName](LightInformationBlock.md#_lightcoloruniformname)
- [\_lightDataUniformName](LightInformationBlock.md#_lightdatauniformname)
- [\_lightTypeDefineName](LightInformationBlock.md#_lighttypedefinename)
- [\_target](LightInformationBlock.md#_target)
- [comments](LightInformationBlock.md#comments)
- [inputsAreExclusive](LightInformationBlock.md#inputsareexclusive)
- [light](LightInformationBlock.md#light)
- [uniqueId](LightInformationBlock.md#uniqueid)
- [visibleInInspector](LightInformationBlock.md#visibleininspector)
- [visibleOnFrame](LightInformationBlock.md#visibleonframe)

### Accessors

- [buildId](LightInformationBlock.md#buildid)
- [color](LightInformationBlock.md#color)
- [direction](LightInformationBlock.md#direction)
- [inputs](LightInformationBlock.md#inputs)
- [intensity](LightInformationBlock.md#intensity)
- [isFinalMerger](LightInformationBlock.md#isfinalmerger)
- [isInput](LightInformationBlock.md#isinput)
- [isUnique](LightInformationBlock.md#isunique)
- [name](LightInformationBlock.md#name)
- [outputs](LightInformationBlock.md#outputs)
- [target](LightInformationBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](LightInformationBlock.md#willbegeneratedintovertexshaderfromfragmentshader)
- [worldPosition](LightInformationBlock.md#worldposition)

### Methods

- [\_buildBlock](LightInformationBlock.md#_buildblock)
- [\_declareOutput](LightInformationBlock.md#_declareoutput)
- [\_deserialize](LightInformationBlock.md#_deserialize)
- [\_dumpPropertiesCode](LightInformationBlock.md#_dumppropertiescode)
- [\_inputRename](LightInformationBlock.md#_inputrename)
- [\_linkConnectionTypes](LightInformationBlock.md#_linkconnectiontypes)
- [\_outputRename](LightInformationBlock.md#_outputrename)
- [\_writeFloat](LightInformationBlock.md#_writefloat)
- [\_writeVariable](LightInformationBlock.md#_writevariable)
- [autoConfigure](LightInformationBlock.md#autoconfigure)
- [bind](LightInformationBlock.md#bind)
- [build](LightInformationBlock.md#build)
- [clone](LightInformationBlock.md#clone)
- [connectTo](LightInformationBlock.md#connectto)
- [dispose](LightInformationBlock.md#dispose)
- [getClassName](LightInformationBlock.md#getclassname)
- [getFirstAvailableInput](LightInformationBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](LightInformationBlock.md#getfirstavailableoutput)
- [getInputByName](LightInformationBlock.md#getinputbyname)
- [getOutputByName](LightInformationBlock.md#getoutputbyname)
- [getSiblingOutput](LightInformationBlock.md#getsiblingoutput)
- [initialize](LightInformationBlock.md#initialize)
- [initializeDefines](LightInformationBlock.md#initializedefines)
- [isAnAncestorOf](LightInformationBlock.md#isanancestorof)
- [isReady](LightInformationBlock.md#isready)
- [prepareDefines](LightInformationBlock.md#preparedefines)
- [provideFallbacks](LightInformationBlock.md#providefallbacks)
- [registerInput](LightInformationBlock.md#registerinput)
- [registerOutput](LightInformationBlock.md#registeroutput)
- [replaceRepeatableContent](LightInformationBlock.md#replacerepeatablecontent)
- [serialize](LightInformationBlock.md#serialize)
- [updateUniformsAndSamples](LightInformationBlock.md#updateuniformsandsamples)
- [validateBlockName](LightInformationBlock.md#validateblockname)

## Constructors

### constructor

• **new LightInformationBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/lightInformationBlock.ts:33

## Properties

### \_forcePrepareDefines

• `Private` **\_forcePrepareDefines**: `boolean`

#### Defined in

https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/lightInformationBlock.ts:22
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/lightInformationBlock.ts:20

___

### \_lightDataUniformName

• `Private` **\_lightDataUniformName**: `string`

#### Defined in

https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/lightInformationBlock.ts:19

___

### \_lightTypeDefineName

• `Private` **\_lightTypeDefineName**: `string`

#### Defined in

https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/lightInformationBlock.ts:21
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/lightInformationBlock.ts:27
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/lightInformationBlock.ts:67

___

### direction

• `get` **direction**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/lightInformationBlock.ts:60
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/lightInformationBlock.ts:74
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/lightInformationBlock.ts:53

## Methods

### \_buildBlock

▸ `Protected` **_buildBlock**(`state`): [`LightInformationBlock`](LightInformationBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/lightInformationBlock.ts:117
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/lightInformationBlock.ts:156
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/lightInformationBlock.ts:78
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`LightInformationBlock`](LightInformationBlock.md)
...
`undefined` \| [`LightInformationBlock`](LightInformationBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/lightInformationBlock.ts:46
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/lightInformationBlock.ts:106
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`LightInformationBlock`](LightInformationBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`LightInformationBlock`](LightInformationBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Vertex/lightInformationBlock.ts:146
