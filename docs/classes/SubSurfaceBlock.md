[@dev/core](../README.md) / [Exports](../modules.md) / SubSurfaceBlock
...
- [constructor](SubSurfaceBlock.md#constructor)

### Properties

- [\_isUnique](SubSurfaceBlock.md#_isunique)
- [\_target](SubSurfaceBlock.md#_target)
- [comments](SubSurfaceBlock.md#comments)
- [inputsAreExclusive](SubSurfaceBlock.md#inputsareexclusive)
- [uniqueId](SubSurfaceBlock.md#uniqueid)
- [visibleInInspector](SubSurfaceBlock.md#visibleininspector)
- [visibleOnFrame](SubSurfaceBlock.md#visibleonframe)

### Accessors

- [buildId](SubSurfaceBlock.md#buildid)
- [inputs](SubSurfaceBlock.md#inputs)
- [isFinalMerger](SubSurfaceBlock.md#isfinalmerger)
- [isInput](SubSurfaceBlock.md#isinput)
- [isUnique](SubSurfaceBlock.md#isunique)
- [name](SubSurfaceBlock.md#name)
- [outputs](SubSurfaceBlock.md#outputs)
- [refraction](SubSurfaceBlock.md#refraction)
- [subsurface](SubSurfaceBlock.md#subsurface)
- [target](SubSurfaceBlock.md#target)
- [thickness](SubSurfaceBlock.md#thickness)
- [tintColor](SubSurfaceBlock.md#tintcolor)
- [translucencyDiffusionDist](SubSurfaceBlock.md#translucencydiffusiondist)
- [translucencyIntensity](SubSurfaceBlock.md#translucencyintensity)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](SubSurfaceBlock.md#willbegeneratedintovertexshaderfromfragmentshader)

### Methods

- [\_buildBlock](SubSurfaceBlock.md#_buildblock)
- [\_declareOutput](SubSurfaceBlock.md#_declareoutput)
- [\_dumpPropertiesCode](SubSurfaceBlock.md#_dumppropertiescode)
- [\_inputRename](SubSurfaceBlock.md#_inputrename)
- [\_linkConnectionTypes](SubSurfaceBlock.md#_linkconnectiontypes)
- [\_outputRename](SubSurfaceBlock.md#_outputrename)
- [\_writeFloat](SubSurfaceBlock.md#_writefloat)
- [\_writeVariable](SubSurfaceBlock.md#_writevariable)
- [autoConfigure](SubSurfaceBlock.md#autoconfigure)
- [bind](SubSurfaceBlock.md#bind)
- [build](SubSurfaceBlock.md#build)
- [clone](SubSurfaceBlock.md#clone)
- [connectTo](SubSurfaceBlock.md#connectto)
- [dispose](SubSurfaceBlock.md#dispose)
- [getClassName](SubSurfaceBlock.md#getclassname)
- [getFirstAvailableInput](SubSurfaceBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](SubSurfaceBlock.md#getfirstavailableoutput)
- [getInputByName](SubSurfaceBlock.md#getinputbyname)
- [getOutputByName](SubSurfaceBlock.md#getoutputbyname)
- [getSiblingOutput](SubSurfaceBlock.md#getsiblingoutput)
- [initialize](SubSurfaceBlock.md#initialize)
- [initializeDefines](SubSurfaceBlock.md#initializedefines)
- [isAnAncestorOf](SubSurfaceBlock.md#isanancestorof)
- [isReady](SubSurfaceBlock.md#isready)
- [prepareDefines](SubSurfaceBlock.md#preparedefines)
- [provideFallbacks](SubSurfaceBlock.md#providefallbacks)
- [registerInput](SubSurfaceBlock.md#registerinput)
- [registerOutput](SubSurfaceBlock.md#registeroutput)
- [replaceRepeatableContent](SubSurfaceBlock.md#replacerepeatablecontent)
- [serialize](SubSurfaceBlock.md#serialize)
- [updateUniformsAndSamples](SubSurfaceBlock.md#updateuniformsandsamples)
- [validateBlockName](SubSurfaceBlock.md#validateblockname)
- [GetCode](SubSurfaceBlock.md#getcode)

## Constructors

### constructor

• **new SubSurfaceBlock**(`name`)
...
packages/dev/core/src/Materials/Node/Blocks/PBR/subSurfaceBlock.ts:24
...
packages/dev/core/src/Materials/Node/Blocks/PBR/subSurfaceBlock.ts:99
...
packages/dev/core/src/Materials/Node/Blocks/PBR/subSurfaceBlock.ts:106
...
• `get` **thickness**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/PBR/subSurfaceBlock.ts:71
...
packages/dev/core/src/Materials/Node/Blocks/PBR/subSurfaceBlock.ts:78

___

### translucencyDiffusionDist

• `get` **translucencyDiffusionDist**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/PBR/subSurfaceBlock.ts:92

___

### translucencyIntensity

• `get` **translucencyIntensity**(): [`NodeMaterialConnectionPoint`](NodeMaterialConnectionPoint.md)
...
packages/dev/core/src/Materials/Node/Blocks/PBR/subSurfaceBlock.ts:85
...
▸ `Protected` **_buildBlock**(`state`): [`SubSurfaceBlock`](SubSurfaceBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/PBR/subSurfaceBlock.ts:254
...
packages/dev/core/src/Materials/Node/Blocks/PBR/subSurfaceBlock.ts:110
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`SubSurfaceBlock`](SubSurfaceBlock.md)
...
`undefined` \| [`SubSurfaceBlock`](SubSurfaceBlock.md)
...
packages/dev/core/src/Materials/Node/Blocks/PBR/subSurfaceBlock.ts:64
...
packages/dev/core/src/Materials/Node/Blocks/PBR/subSurfaceBlock.ts:53
...
packages/dev/core/src/Materials/Node/Blocks/PBR/subSurfaceBlock.ts:118
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`SubSurfaceBlock`](SubSurfaceBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`SubSurfaceBlock`](SubSurfaceBlock.md)
...
▸ `Static` **GetCode**(`state`, `ssBlock`, `reflectionBlock`, `worldPosVarName`): `string`
...
| `ssBlock` | [`Nullable`](../modules.md#nullable)[`SubSurfaceBlock`](SubSurfaceBlock.md) | instance of a SubSurfaceBlock or null if the code must be generated without an active sub surface module |
...
packages/dev/core/src/Materials/Node/Blocks/PBR/subSurfaceBlock.ts:140
