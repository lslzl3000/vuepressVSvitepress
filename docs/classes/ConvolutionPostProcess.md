[@dev/core](../README.md) / [Exports](../modules.md) / ConvolutionPostProcess
...
- [constructor](ConvolutionPostProcess.md#constructor)

### Properties

- [\_indexParameters](ConvolutionPostProcess.md#_indexparameters)
- [\_postProcessDefines](ConvolutionPostProcess.md#_postprocessdefines)
- [\_scene](ConvolutionPostProcess.md#_scene)
- [adaptScaleToCurrentViewport](ConvolutionPostProcess.md#adaptscaletocurrentviewport)
- [alphaConstants](ConvolutionPostProcess.md#alphaconstants)
- [alphaMode](ConvolutionPostProcess.md#alphamode)
- [alwaysForcePOT](ConvolutionPostProcess.md#alwaysforcepot)
- [animations](ConvolutionPostProcess.md#animations)
- [autoClear](ConvolutionPostProcess.md#autoclear)
- [clearColor](ConvolutionPostProcess.md#clearcolor)
- [enablePixelPerfectMode](ConvolutionPostProcess.md#enablepixelperfectmode)
- [externalTextureSamplerBinding](ConvolutionPostProcess.md#externaltexturesamplerbinding)
- [forceFullscreenViewport](ConvolutionPostProcess.md#forcefullscreenviewport)
- [height](ConvolutionPostProcess.md#height)
- [inspectableCustomProperties](ConvolutionPostProcess.md#inspectablecustomproperties)
- [kernel](ConvolutionPostProcess.md#kernel)
- [name](ConvolutionPostProcess.md#name)
- [nodeMaterialSource](ConvolutionPostProcess.md#nodematerialsource)
- [onActivateObservable](ConvolutionPostProcess.md#onactivateobservable)
- [onAfterRenderObservable](ConvolutionPostProcess.md#onafterrenderobservable)
- [onApplyObservable](ConvolutionPostProcess.md#onapplyobservable)
- [onBeforeRenderObservable](ConvolutionPostProcess.md#onbeforerenderobservable)
- [onSizeChangedObservable](ConvolutionPostProcess.md#onsizechangedobservable)
- [renderTargetSamplingMode](ConvolutionPostProcess.md#rendertargetsamplingmode)
- [scaleMode](ConvolutionPostProcess.md#scalemode)
- [uniqueId](ConvolutionPostProcess.md#uniqueid)
- [width](ConvolutionPostProcess.md#width)
- [EdgeDetect0Kernel](ConvolutionPostProcess.md#edgedetect0kernel)
- [EdgeDetect1Kernel](ConvolutionPostProcess.md#edgedetect1kernel)
- [EdgeDetect2Kernel](ConvolutionPostProcess.md#edgedetect2kernel)
- [EmbossKernel](ConvolutionPostProcess.md#embosskernel)
- [GaussianKernel](ConvolutionPostProcess.md#gaussiankernel)
- [SharpenKernel](ConvolutionPostProcess.md#sharpenkernel)

### Accessors

- [aspectRatio](ConvolutionPostProcess.md#aspectratio)
- [inputTexture](ConvolutionPostProcess.md#inputtexture)
- [isSupported](ConvolutionPostProcess.md#issupported)
- [onActivate](ConvolutionPostProcess.md#onactivate)
- [onAfterRender](ConvolutionPostProcess.md#onafterrender)
- [onApply](ConvolutionPostProcess.md#onapply)
- [onBeforeRender](ConvolutionPostProcess.md#onbeforerender)
- [onSizeChanged](ConvolutionPostProcess.md#onsizechanged)
- [samples](ConvolutionPostProcess.md#samples)
- [texelSize](ConvolutionPostProcess.md#texelsize)

### Methods

- [activate](ConvolutionPostProcess.md#activate)
- [apply](ConvolutionPostProcess.md#apply)
- [clone](ConvolutionPostProcess.md#clone)
- [dispose](ConvolutionPostProcess.md#dispose)
- [getCamera](ConvolutionPostProcess.md#getcamera)
- [getClassName](ConvolutionPostProcess.md#getclassname)
- [getEffect](ConvolutionPostProcess.md#geteffect)
- [getEffectName](ConvolutionPostProcess.md#geteffectname)
- [getEngine](ConvolutionPostProcess.md#getengine)
- [isReady](ConvolutionPostProcess.md#isready)
- [isReusable](ConvolutionPostProcess.md#isreusable)
- [markTextureDirty](ConvolutionPostProcess.md#marktexturedirty)
- [restoreDefaultInputTexture](ConvolutionPostProcess.md#restoredefaultinputtexture)
- [serialize](ConvolutionPostProcess.md#serialize)
- [setPrePassRenderer](ConvolutionPostProcess.md#setprepassrenderer)
- [shareOutputWith](ConvolutionPostProcess.md#shareoutputwith)
- [updateEffect](ConvolutionPostProcess.md#updateeffect)
- [useOwnOutput](ConvolutionPostProcess.md#useownoutput)
- [Parse](ConvolutionPostProcess.md#parse)

## Constructors

### constructor

• **new ConvolutionPostProcess**(`name`, `kernel`, `options`, `camera`, `samplingMode?`, `engine?`, `reusable?`, `textureType?`)
...
| `kernel` | `number`[] | `undefined` | Array of 9 values corresponding to the 3x3 kernel to be applied |
...
packages/dev/core/src/PostProcesses/convolutionPostProcess.ts:44
...
packages/dev/core/src/PostProcesses/convolutionPostProcess.ts:23
...
packages/dev/core/src/PostProcesses/convolutionPostProcess.ts:93
...
packages/dev/core/src/PostProcesses/convolutionPostProcess.ts:97
...
packages/dev/core/src/PostProcesses/convolutionPostProcess.ts:101
...
packages/dev/core/src/PostProcesses/convolutionPostProcess.ts:109
...
packages/dev/core/src/PostProcesses/convolutionPostProcess.ts:113
...
packages/dev/core/src/PostProcesses/convolutionPostProcess.ts:105
...
packages/dev/core/src/PostProcesses/convolutionPostProcess.ts:29
