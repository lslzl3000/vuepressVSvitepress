[@dev/core](../README.md) / [Exports](../modules.md) / FragCoordBlock
...
- [constructor](FragCoordBlock.md#constructor)

### Properties

- [\_isUnique](FragCoordBlock.md#_isunique)
- [\_target](FragCoordBlock.md#_target)
- [comments](FragCoordBlock.md#comments)
- [inputsAreExclusive](FragCoordBlock.md#inputsareexclusive)
- [uniqueId](FragCoordBlock.md#uniqueid)
- [visibleInInspector](FragCoordBlock.md#visibleininspector)
- [visibleOnFrame](FragCoordBlock.md#visibleonframe)

### Accessors

- [buildId](FragCoordBlock.md#buildid)
- [inputs](FragCoordBlock.md#inputs)
- [isFinalMerger](FragCoordBlock.md#isfinalmerger)
- [isInput](FragCoordBlock.md#isinput)
- [isUnique](FragCoordBlock.md#isunique)
- [name](FragCoordBlock.md#name)
- [output](FragCoordBlock.md#output)
- [outputs](FragCoordBlock.md#outputs)
- [target](FragCoordBlock.md#target)
- [willBeGeneratedIntoVertexShaderFromFragmentShader](FragCoordBlock.md#willbegeneratedintovertexshaderfromfragmentshader)
- [x](FragCoordBlock.md#x)
- [xy](FragCoordBlock.md#xy)
- [xyz](FragCoordBlock.md#xyz)
- [xyzw](FragCoordBlock.md#xyzw)
- [y](FragCoordBlock.md#y)
- [z](FragCoordBlock.md#z)

### Methods

- [\_buildBlock](FragCoordBlock.md#_buildblock)
- [\_declareOutput](FragCoordBlock.md#_declareoutput)
- [\_dumpPropertiesCode](FragCoordBlock.md#_dumppropertiescode)
- [\_inputRename](FragCoordBlock.md#_inputrename)
- [\_linkConnectionTypes](FragCoordBlock.md#_linkconnectiontypes)
- [\_outputRename](FragCoordBlock.md#_outputrename)
- [\_writeFloat](FragCoordBlock.md#_writefloat)
- [\_writeVariable](FragCoordBlock.md#_writevariable)
- [autoConfigure](FragCoordBlock.md#autoconfigure)
- [bind](FragCoordBlock.md#bind)
- [build](FragCoordBlock.md#build)
- [clone](FragCoordBlock.md#clone)
- [connectTo](FragCoordBlock.md#connectto)
- [dispose](FragCoordBlock.md#dispose)
- [getClassName](FragCoordBlock.md#getclassname)
- [getFirstAvailableInput](FragCoordBlock.md#getfirstavailableinput)
- [getFirstAvailableOutput](FragCoordBlock.md#getfirstavailableoutput)
- [getInputByName](FragCoordBlock.md#getinputbyname)
- [getOutputByName](FragCoordBlock.md#getoutputbyname)
- [getSiblingOutput](FragCoordBlock.md#getsiblingoutput)
- [initialize](FragCoordBlock.md#initialize)
- [initializeDefines](FragCoordBlock.md#initializedefines)
- [isAnAncestorOf](FragCoordBlock.md#isanancestorof)
- [isReady](FragCoordBlock.md#isready)
- [prepareDefines](FragCoordBlock.md#preparedefines)
- [provideFallbacks](FragCoordBlock.md#providefallbacks)
- [registerInput](FragCoordBlock.md#registerinput)
- [registerOutput](FragCoordBlock.md#registeroutput)
- [replaceRepeatableContent](FragCoordBlock.md#replacerepeatablecontent)
- [serialize](FragCoordBlock.md#serialize)
- [updateUniformsAndSamples](FragCoordBlock.md#updateuniformsandsamples)
- [validateBlockName](FragCoordBlock.md#validateblockname)
- [writeOutputs](FragCoordBlock.md#writeoutputs)

## Constructors

### constructor

• **new FragCoordBlock**(`name`)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/fragCoordBlock.ts:16
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/fragCoordBlock.ts:81
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/fragCoordBlock.ts:60
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/fragCoordBlock.ts:39
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/fragCoordBlock.ts:46
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/fragCoordBlock.ts:53
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/fragCoordBlock.ts:67
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/fragCoordBlock.ts:74

## Methods

### \_buildBlock

▸ `Protected` **_buildBlock**(`state`): [`FragCoordBlock`](FragCoordBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/fragCoordBlock.ts:98
...
▸ **connectTo**(`other`, `options?`): `undefined` \| [`FragCoordBlock`](FragCoordBlock.md)
...
`undefined` \| [`FragCoordBlock`](FragCoordBlock.md)
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/fragCoordBlock.ts:32
...
▸ **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): [`FragCoordBlock`](FragCoordBlock.md)
...
▸ **registerOutput**(`name`, `type`, `target?`, `point?`): [`FragCoordBlock`](FragCoordBlock.md)
...
▸ `Protected` **writeOutputs**(`state`): `string`
...
https://github.com/babylon.js/core/src/Materials/Node/Blocks/Fragment/fragCoordBlock.ts:86
