[@dev/core](../README.md) / [Exports](../modules.md) / PassPostProcess
...
- [constructor](PassPostProcess.md#constructor)

### Properties

- [\_indexParameters](PassPostProcess.md#_indexparameters)
- [\_postProcessDefines](PassPostProcess.md#_postprocessdefines)
- [\_scene](PassPostProcess.md#_scene)
- [adaptScaleToCurrentViewport](PassPostProcess.md#adaptscaletocurrentviewport)
- [alphaConstants](PassPostProcess.md#alphaconstants)
- [alphaMode](PassPostProcess.md#alphamode)
- [alwaysForcePOT](PassPostProcess.md#alwaysforcepot)
- [animations](PassPostProcess.md#animations)
- [autoClear](PassPostProcess.md#autoclear)
- [clearColor](PassPostProcess.md#clearcolor)
- [enablePixelPerfectMode](PassPostProcess.md#enablepixelperfectmode)
- [externalTextureSamplerBinding](PassPostProcess.md#externaltexturesamplerbinding)
- [forceFullscreenViewport](PassPostProcess.md#forcefullscreenviewport)
- [height](PassPostProcess.md#height)
- [inspectableCustomProperties](PassPostProcess.md#inspectablecustomproperties)
- [name](PassPostProcess.md#name)
- [nodeMaterialSource](PassPostProcess.md#nodematerialsource)
- [onActivateObservable](PassPostProcess.md#onactivateobservable)
- [onAfterRenderObservable](PassPostProcess.md#onafterrenderobservable)
- [onApplyObservable](PassPostProcess.md#onapplyobservable)
- [onBeforeRenderObservable](PassPostProcess.md#onbeforerenderobservable)
- [onSizeChangedObservable](PassPostProcess.md#onsizechangedobservable)
- [renderTargetSamplingMode](PassPostProcess.md#rendertargetsamplingmode)
- [scaleMode](PassPostProcess.md#scalemode)
- [uniqueId](PassPostProcess.md#uniqueid)
- [width](PassPostProcess.md#width)

### Accessors

- [aspectRatio](PassPostProcess.md#aspectratio)
- [inputTexture](PassPostProcess.md#inputtexture)
- [isSupported](PassPostProcess.md#issupported)
- [onActivate](PassPostProcess.md#onactivate)
- [onAfterRender](PassPostProcess.md#onafterrender)
- [onApply](PassPostProcess.md#onapply)
- [onBeforeRender](PassPostProcess.md#onbeforerender)
- [onSizeChanged](PassPostProcess.md#onsizechanged)
- [samples](PassPostProcess.md#samples)
- [texelSize](PassPostProcess.md#texelsize)

### Methods

- [activate](PassPostProcess.md#activate)
- [apply](PassPostProcess.md#apply)
- [clone](PassPostProcess.md#clone)
- [dispose](PassPostProcess.md#dispose)
- [getCamera](PassPostProcess.md#getcamera)
- [getClassName](PassPostProcess.md#getclassname)
- [getEffect](PassPostProcess.md#geteffect)
- [getEffectName](PassPostProcess.md#geteffectname)
- [getEngine](PassPostProcess.md#getengine)
- [isReady](PassPostProcess.md#isready)
- [isReusable](PassPostProcess.md#isreusable)
- [markTextureDirty](PassPostProcess.md#marktexturedirty)
- [restoreDefaultInputTexture](PassPostProcess.md#restoredefaultinputtexture)
- [serialize](PassPostProcess.md#serialize)
- [setPrePassRenderer](PassPostProcess.md#setprepassrenderer)
- [shareOutputWith](PassPostProcess.md#shareoutputwith)
- [updateEffect](PassPostProcess.md#updateeffect)
- [useOwnOutput](PassPostProcess.md#useownoutput)
- [Parse](PassPostProcess.md#parse)

## Constructors

### constructor

• **new PassPostProcess**(`name`, `options`, `camera?`, `samplingMode?`, `engine?`, `reusable?`, `textureType?`, `blockCompilation?`)
...
https://github.com/babylon.js/core/src/PostProcesses/passPostProcess.ts:38
...
https://github.com/babylon.js/core/src/PostProcesses/passPostProcess.ts:23
